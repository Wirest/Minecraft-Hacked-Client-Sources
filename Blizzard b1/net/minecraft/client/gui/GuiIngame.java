...
public class GuiIngame extends Gui {
	...
	public void func_175180_a(float p_175180_1_) {
		...
		if (this.recordPlayingUpFor > 0) {
			...
			var7 = this.recordPlayingUpFor - p_175180_1_;
		...
		if (this.field_175195_w > 0) {
			...
			var7 = this.field_175195_w - p_175180_1_;
			var8 = 255;
			...
			if (var8 > 8) {
				...
				this.func_175179_f().func_175065_a(this.field_175201_x,
						-this.func_175179_f().getStringWidth(this.field_175201_x) / 2, -10.0F, 16777215 | var9, true);
				GlStateManager.popMatrix();
				GlStateManager.pushMatrix();
				GlStateManager.scale(2.0F, 2.0F, 2.0F);
				this.func_175179_f().func_175065_a(this.field_175200_y,
						-this.func_175179_f().getStringWidth(this.field_175200_y) / 2, 5.0F, 16777215 | var9, true);
				GlStateManager.popMatrix();
				GlStateManager.disableBlend();
				GlStateManager.popMatrix();
			}
		...
		final EventRender2D eventRender2D = new EventRender2D(scaledResolution.getScaledWidth(),
				scaledResolution.getScaledHeight());
		eventRender2D.call();
		GlStateManager.popMatrix();
		GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
		GlStateManager.disableLighting();
		GlStateManager.enableAlpha();// its lagging extreme
	}
	...
	private void func_180477_d(ScaledResolution p_180477_1_) {
		if (this.mc.func_175606_aa() instanceof EntityPlayer) {
			...
			boolean var4 = this.field_175191_F > this.updateCounter
					&& (this.field_175191_F - this.updateCounter) / 3L % 2L == 1L;
	...
	private void renderBossHealth() {
		if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
			...
			this.func_175179_f().func_175063_a(var8, var3 / 2 - this.func_175179_f().getStringWidth(var8) / 2,
					var7 - 10, 16777215);
			GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
			this.mc.getTextureManager().bindTexture(icons);
		}
	...
	private void func_180480_a(float p_180480_1_, ScaledResolution p_180480_2_) {
		...
		double var5 = Math.min(var3.func_177749_o() * var3.getWarningTime() * 1000.0D,
		...
		this.prevVignetteBrightness = (float) (this.prevVignetteBrightness
				+ (p_180480_1_ - this.prevVignetteBrightness) * 0.01D);
		GlStateManager.disableDepth();
		GlStateManager.depthMask(false);
