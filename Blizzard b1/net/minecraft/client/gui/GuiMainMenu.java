...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		this.field_175372_K = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2,
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		float var9 = 1.8f
				- MathHelper.abs(MathHelper.sin(Minecraft.getSystemTime() % 1000 / 1000.0f * 3.1415927f * 2.0f) * 0.1f);
		...
		if (this.field_92025_p != null && this.field_92025_p.length() > 0) {
			GuiMainMenu.drawRect(this.field_92022_t - 2, this.field_92021_u - 2, this.field_92020_v + 2,
