...
import Blizzard.Event.events.EventPostMotionUpdates;
import Blizzard.Event.events.EventPreMotionUpdates;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void func_175161_p()
    {
        ...
        if (this.func_175160_A()) {
            ...
            if (this.ridingEntity == null) {
                ...
                if (!sendLook && Blizzard.modManager.getModbyName("KillAura").isToggled()) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(this.rotationYaw, this.rotationPitch, this.onGround));
                }
            }
            else {
    ...
    {
        if (Blizzard.onSendChatMessage(p_71165_1_)) {
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding()){
            if (Blizzard.modManager.getModbyName("NoSlowDown").isToggled()) {
