...
import Blizzard.Event.events.EventMiddleClick;
import Blizzard.Event.events.EventTick;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
	...
	private void func_175609_am() throws LWJGLException {
		...
		Display.setTitle(String.valueOf("Blizzard") + " Is Loading...");
	...
	private void runGameLoop() throws IOException {
		...
		while (getSystemTime() >= this.debugUpdateTime + 1000L) {
			...
			this.debug = String.format("%d fps (%d chunk update%s) T: %s%s%s%s%s", new Object[] {
					...
					this.gameSettings.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax() ? "inf"
	...
	private void displayDebugInfo(long elapsedTicksTime) {
		if (this.mcProfiler.profilingEnabled) {
			...
			this.fontRendererObj.func_175063_a(var20 = var19.format(var4.field_76330_b) + "%",
					var8 + var7 - this.fontRendererObj.getStringWidth(var20), var9 - var7 / 2 - 16, var14);
			...
			for (int var21 = 0; var21 < var3.size(); ++var21) {
				...
				this.fontRendererObj.func_175063_a(var23, var8 - var7, var9 + var7 / 2 + var21 * 8 + 20,
						var22.func_76329_a());
				this.fontRendererObj.func_175063_a(var23 = var19.format(var22.field_76332_a) + "%",
						var8 + var7 - 50 - this.fontRendererObj.getStringWidth(var23), var9 + var7 / 2 + var21 * 8 + 20,
						var22.func_76329_a());
				this.fontRendererObj.func_175063_a(var23 = var19.format(var22.field_76330_b) + "%",
						var8 + var7 - this.fontRendererObj.getStringWidth(var23), var9 + var7 / 2 + var21 * 8 + 20,
						var22.func_76329_a());
			}
		}
	}
						...
						if (this.thePlayer.func_175149_v()) {
							...
							if (this.ingameGUI.func_175187_g().func_175262_a()) {
								...
								float var5 = MathHelper.clamp_float(
										this.thePlayer.capabilities.getFlySpeed() + var4 * 0.005F, 0.0F, 0.2F);
