...
import cn.kody.debug.utils.color.FlatColors;
...
public enum RenderUtil {
    ...
    public static void drawBlockBox(BlockPos blockPos, Color color) {
        ...
        RenderUtil.drawFilledBox(new AxisAlignedBB(x, y, z, x + 1.0, y + 1.0, z + 1.0));
        GL11.glEnable((int)3553);
        GL11.glEnable((int)2929);
        GL11.glDepthMask((boolean)true);
        GL11.glDisable((int)3042);
    ...
    public static void drawEntityBox(Entity entity, Color color) {
        ...
        GL11.glDisable((int)2929);
        GL11.glDepthMask((boolean)false);
        RenderUtil.glColor(new Color(color.getRed(), color.getGreen(), color.getBlue(), color == Color.BLACK ? 60 : 45));
        Minecraft.getMinecraft().getRenderManager();
        Minecraft.getMinecraft().getRenderManager();
        Minecraft.getMinecraft().getRenderManager();
        Minecraft.getMinecraft().getRenderManager();
        Minecraft.getMinecraft().getRenderManager();
        Minecraft.getMinecraft().getRenderManager();
        RenderUtil.drawFilledBox(new AxisAlignedBB(entity.boundingBox.minX - 0.05 - entity.posX + (entity.posX - RenderManager.renderPosX), entity.boundingBox.minY - entity.posY + (entity.posY - RenderManager.renderPosY), entity.boundingBox.minZ - 0.05 - entity.posZ + (entity.posZ - RenderManager.renderPosZ), entity.boundingBox.maxX + 0.05 - entity.posX + (entity.posX - RenderManager.renderPosX), entity.boundingBox.maxY + 0.1 - entity.posY + (entity.posY - RenderManager.renderPosY), entity.boundingBox.maxZ + 0.05 - entity.posZ + (entity.posZ - RenderManager.renderPosZ)));
        GL11.glEnable((int)3553);
        GL11.glEnable((int)2929);
        GL11.glDepthMask((boolean)true);
        GL11.glDisable((int)3042);
    ...
    public static void drawLoadingCircle() {
        ...
        Gui.drawCircle((float)res.getScaledWidth() / 2.0f, (float)res.getScaledHeight() / 2.0f, radius, new Color(FlatColors.DARK_GREY.c), 5.0f, 0.0f, 1.0f);
        Gui.drawCircle((float)res.getScaledWidth() / 2.0f, (float)res.getScaledHeight() / 2.0f, radius, new Color(FlatColors.BLUE.c), 7.0f, status, size);
    }
...
//    }
    ...
    public static void drawRoundedRectBottem(float x, float y, float x2, float y2, float round, int color) {
        ...
        Gui.drawRect(x - round / 2.0f, y, x2 + round / 2.0f, y2 - round / 2.0f + 0.0f, color);
        Gui.drawRect(x + round / 2.0f, y2 - round / 2.0f + 0.0f, x2 - round / 2.0f, y2 + round / 2.0f + 0.0f, color);
    }
    ...
    public static void drawImage(final ResourceLocation p_bindTexture_1_, final int p_drawModalRectWithCustomSizedTexture_0_, final int p_drawModalRectWithCustomSizedTexture_1_, final float p_drawModalRectWithCustomSizedTexture_6_, final float p_drawModalRectWithCustomSizedTexture_7_) {
        ...
        Minecraft.getMinecraft().getTextureManager().bindTexture(p_bindTexture_1_);
        Gui.drawModalRectWithCustomSizedTexture(p_drawModalRectWithCustomSizedTexture_0_, p_drawModalRectWithCustomSizedTexture_1_, 0.0f, 0.0f, (float)(int)p_drawModalRectWithCustomSizedTexture_6_, (float)(int)p_drawModalRectWithCustomSizedTexture_7_, p_drawModalRectWithCustomSizedTexture_6_, p_drawModalRectWithCustomSizedTexture_7_);
        GL11.glDepthMask(true);
        GL11.glDisable(3042);
        GL11.glEnable(2929);
    }
