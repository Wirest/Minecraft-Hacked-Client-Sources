...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            {
                EventManager.call(new EventStep(EventType.PRE, this.stepHeight));
                double d11 = x;
                double d7 = y;
                double d8 = z;
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z)
                {
                    ...
                    EventManager.call(new EventStep(EventType.POST, this.stepHeight));
                }
            }
    ...
    {
    	if(ModManager.getModByName("Hitbox").isEnabled()) {
		return Hitbox.size.getValueState().floatValue();
	}
    return 0.1F;
    }
