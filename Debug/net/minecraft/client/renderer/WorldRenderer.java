...
public class WorldRenderer
{
    ...
    public void sortVertexData(float p_181674_1_, float p_181674_2_, float p_181674_3_)
    {
        ...
        if (this.quadSprites != null)
        {
            ...
            int i2 = this.vertexFormat.getIntegerSize() / 4 * 4;
    ...
    public void putColorMultiplier(float red, float green, float blue, int p_178978_4_) {
        ...
        Xray xray = (Xray)ModManager.getMod(Xray.class);
        if (ModManager.getModByName("Xray").isEnabled()) {
            j = Colors.getColor(iR, iG, iB, xray.getOpacity());
        }
    ...
    public static void addVertexWithUV(final double p_addVertexWithUV_0_, final double p_addVertexWithUV_2_, final double p_addVertexWithUV_4_, final double p_addVertexWithUV_6_, final double p_addVertexWithUV_8_) {
        Tessellator.getInstance().getWorldRenderer().pos(p_addVertexWithUV_0_, p_addVertexWithUV_2_, p_addVertexWithUV_4_).tex(p_addVertexWithUV_6_, p_addVertexWithUV_8_).endVertex();
    }
}
