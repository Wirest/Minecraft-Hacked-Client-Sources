...
import cn.kody.debug.mod.mods.COMBAT.Reach;
import cn.kody.debug.mod.mods.RENDER.RealBobbing;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            double d0;
            if (ModManager.getModByName("Reach").isEnabled()) {
                d0 = Reach.reach.getValueState();
            }
            else {
...
//            double d0 = (double)this.mc.playerController.getBlockReachDistance();
    ...
    private void setupViewBobbing(float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            if (ModManager.getMod(RealBobbing.class).isEnabled()) {
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if (d7 < d3){
                    	if(!ModManager.getModByName("ViewClip").isEnabled()) {
                    		d3 = d7;
                    		}
                    	}
                    }
        ...
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (worldclient != null)
            {
                ...
                for (int i = 0; i < 256; ++i)
                {
                    ...
                    float f16 = ModManager.getModByName("Xray").isEnabled() ? 10000.0f : this.mc.gameSettings.gammaSetting;
                    float f17 = 1.0F - f8;
                    float f13 = 1.0F - f9;
                    float f14 = 1.0F - f10;
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof GUIMainScreen)
        {
            this.updateMainMenu((GUIMainScreen)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(GUIMainScreen p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
            ...
            Field[] afield = GUIMainScreen.class.getDeclaredFields();
