        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4://TODO Block
                   	 float var15;
                        if (!BlockAnimation.mode.isCurrentMode("Vanilla")) {
                            GL11.glTranslated((double)-0.1, (double)0.15, (double)0.0);
                        }
                        if (BlockAnimation.mode.isCurrentMode("Swaing")) {
                        ...
                        if (BlockAnimation.mode.isCurrentMode("Swing")) {
                            this.transformFirstPersonItem(f / 2.0f, f1);
                        }
                        if (BlockAnimation.mode.isCurrentMode("Swang")) {
                            this.transformFirstPersonItem(f / 2.0f, f1);
                        ...
                        if (BlockAnimation.mode.isCurrentMode("Swong")) {
                        ...
                        if (BlockAnimation.mode.isCurrentMode("Swank")) {
                            this.transformFirstPersonItem(f / 2.0f, f1);
                            var15 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927f);
