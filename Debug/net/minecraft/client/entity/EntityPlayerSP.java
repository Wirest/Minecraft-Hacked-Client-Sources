...
import cn.kody.debug.mod.mods.MOVEMENT.NoSlowDown;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer() {
        EventPreMotion pre = new EventPreMotion(this.posY, this.rotationYaw, this.rotationPitch, this.onGround, EventType.PRE);
