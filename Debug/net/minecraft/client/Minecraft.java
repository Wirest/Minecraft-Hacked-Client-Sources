...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new GUIMainScreen(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new GUIMainScreen());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        if (guiScreenIn instanceof GUIMainScreen)
        {
    ...
    private void runGameLoop() throws IOException
    {
        ...
        RenderUtil.delta = (currentTimeMillis - this.lastFrame) / 1000.0f;
