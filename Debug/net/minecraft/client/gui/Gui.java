...
public class Gui
{
    ...
    public static void drawRect(float oldX, float g, float h, float k, int color) {
        ...
        GlStateManager.color(f, f1, f2, f3);
        worldrenderer.begin(7, DefaultVertexFormats.POSITION);
        worldrenderer.pos(oldX, k, 0.0).endVertex();
        worldrenderer.pos(h, k, 0.0).endVertex();
        worldrenderer.pos(h, g, 0.0).endVertex();
        worldrenderer.pos(oldX, g, 0.0).endVertex();
        tessellator.draw();
        GlStateManager.enableTexture2D();
        GlStateManager.disableBlend();
    }
    ...
    public static void drawModalRectWithCustomSizedTexture(final float p_drawModalRectWithCustomSizedTexture_0_, final double p_drawModalRectWithCustomSizedTexture_1_, final float p_drawModalRectWithCustomSizedTexture_3_, final float p_drawModalRectWithCustomSizedTexture_4_, final double p_drawModalRectWithCustomSizedTexture_5_, final double p_drawModalRectWithCustomSizedTexture_7_, final double p_drawModalRectWithCustomSizedTexture_9_, final double p_drawModalRectWithCustomSizedTexture_11_) {
        final double n = 1.0 / p_drawModalRectWithCustomSizedTexture_9_;
        final double n2 = 1.0 / p_drawModalRectWithCustomSizedTexture_11_;
        final Tessellator instance = Tessellator.getInstance();
        instance.getWorldRenderer().begin(7, DefaultVertexFormats.POSITION_TEX);
        WorldRenderer.addVertexWithUV(p_drawModalRectWithCustomSizedTexture_0_, p_drawModalRectWithCustomSizedTexture_1_ + p_drawModalRectWithCustomSizedTexture_7_, 0.0, p_drawModalRectWithCustomSizedTexture_3_ * n, (p_drawModalRectWithCustomSizedTexture_4_ + (float)p_drawModalRectWithCustomSizedTexture_7_) * n2);
        WorldRenderer.addVertexWithUV(p_drawModalRectWithCustomSizedTexture_0_ + p_drawModalRectWithCustomSizedTexture_5_, p_drawModalRectWithCustomSizedTexture_1_ + p_drawModalRectWithCustomSizedTexture_7_, 0.0, (p_drawModalRectWithCustomSizedTexture_3_ + (float)p_drawModalRectWithCustomSizedTexture_5_) * n, (p_drawModalRectWithCustomSizedTexture_4_ + (float)p_drawModalRectWithCustomSizedTexture_7_) * n2);
        WorldRenderer.addVertexWithUV(p_drawModalRectWithCustomSizedTexture_0_ + p_drawModalRectWithCustomSizedTexture_5_, p_drawModalRectWithCustomSizedTexture_1_, 0.0, (p_drawModalRectWithCustomSizedTexture_3_ + (float)p_drawModalRectWithCustomSizedTexture_5_) * n, p_drawModalRectWithCustomSizedTexture_4_ * n2);
        WorldRenderer.addVertexWithUV(p_drawModalRectWithCustomSizedTexture_0_, p_drawModalRectWithCustomSizedTexture_1_, 0.0, p_drawModalRectWithCustomSizedTexture_3_ * n, p_drawModalRectWithCustomSizedTexture_4_ * n2);
        instance.draw();
    }
}
