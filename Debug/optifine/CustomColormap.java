...
public class CustomColormap implements CustomColors.IColorizer
{
    ...
    public CustomColormap(Properties p_i34_1_, String p_i34_2_, int p_i34_3_, int p_i34_4_, String p_i34_5_)
    {
        ConnectedParser connectedparser = new ConnectedParser("Colormap");
        this.name = connectedparser.parseName(p_i34_2_);
        this.basePath = connectedparser.parseBasePath(p_i34_2_);
        this.format = this.parseFormat(p_i34_1_.getProperty("format", p_i34_5_));
        this.matchBlocks = connectedparser.parseMatchBlocks(p_i34_1_.getProperty("blocks"));
        this.source = parseTexture(p_i34_1_.getProperty("source"), p_i34_2_, this.basePath);
        this.color = ConnectedParser.parseColor(p_i34_1_.getProperty("color"), -1);
        this.yVariance = connectedparser.parseInt(p_i34_1_.getProperty("yVariance"), 0);
        this.yOffset = connectedparser.parseInt(p_i34_1_.getProperty("yOffset"), 0);
        this.width = p_i34_3_;
        this.height = p_i34_4_;
    }
