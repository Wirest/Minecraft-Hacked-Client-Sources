...
public class CustomSkyLayer
{
    ...
    public CustomSkyLayer(Properties p_i40_1_, String p_i40_2_)
    {
        ...
        this.source = p_i40_1_.getProperty("source", p_i40_2_);
        this.startFadeIn = this.parseTime(p_i40_1_.getProperty("startFadeIn"));
        this.endFadeIn = this.parseTime(p_i40_1_.getProperty("endFadeIn"));
        this.startFadeOut = this.parseTime(p_i40_1_.getProperty("startFadeOut"));
        this.endFadeOut = this.parseTime(p_i40_1_.getProperty("endFadeOut"));
        this.blend = Blender.parseBlend(p_i40_1_.getProperty("blend"));
        this.rotate = this.parseBoolean(p_i40_1_.getProperty("rotate"), true);
        this.speed = this.parseFloat(p_i40_1_.getProperty("speed"), 1.0F);
        this.axis = this.parseAxis(p_i40_1_.getProperty("axis"), DEFAULT_AXIS);
        this.days = connectedparser.parseRangeListInt(p_i40_1_.getProperty("days"));
        this.daysLoop = connectedparser.parseInt(p_i40_1_.getProperty("daysLoop"), 8);
        List<String> list = this.parseWeatherList(p_i40_1_.getProperty("weather", "clear"));
        this.weatherClear = list.contains("clear");
        this.weatherRain = list.contains("rain");
        this.weatherThunder = list.contains("thunder");
        this.biomes = connectedparser.parseBiomes(p_i40_1_.getProperty("biomes"));
        this.heights = connectedparser.parseRangeListInt(p_i40_1_.getProperty("heights"));
        this.transition = this.parseFloat(p_i40_1_.getProperty("transition"), 1.0F);
    }
