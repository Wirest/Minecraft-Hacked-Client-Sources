...
public class ModelSprite
{
    ...
    public ModelSprite(ModelRenderer p_i75_1_, int p_i75_2_, int p_i75_3_, float p_i75_4_, float p_i75_5_, float p_i75_6_, int p_i75_7_, int p_i75_8_, int p_i75_9_, float p_i75_10_)
    {
        ...
        this.minU = (float)p_i75_2_ / p_i75_1_.textureWidth;
        this.minV = (float)p_i75_3_ / p_i75_1_.textureHeight;
        this.maxU = (float)(p_i75_2_ + p_i75_7_) / p_i75_1_.textureWidth;
        this.maxV = (float)(p_i75_3_ + p_i75_8_) / p_i75_1_.textureHeight;
    }
