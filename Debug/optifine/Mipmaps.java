...
public class Mipmaps
{
    ...
    public Mipmaps(String p_i74_1_, int p_i74_2_, int p_i74_3_, int[] p_i74_4_, boolean p_i74_5_)
    {
        this.iconName = p_i74_1_;
        this.width = p_i74_2_;
        this.height = p_i74_3_;
        this.data = p_i74_4_;
        this.direct = p_i74_5_;
        this.mipmapDimensions = makeMipmapDimensions(p_i74_2_, p_i74_3_, p_i74_1_);
        this.mipmapDatas = generateMipMapData(p_i74_4_, p_i74_2_, p_i74_3_, this.mipmapDimensions);
