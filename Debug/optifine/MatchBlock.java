...
public class MatchBlock
{
    ...
    public MatchBlock(int p_i71_1_)
    {
        this.blockId = p_i71_1_;
    }

    public MatchBlock(int p_i72_1_, int p_i72_2_)
    {
        this.blockId = p_i72_1_;

        if (p_i72_2_ >= 0 && p_i72_2_ <= 15)
        {
            this.metadatas = new int[] {p_i72_2_};
        }
    }
