...
public class ConnectedTextures
{
    ...
    public static void updateIcons(TextureMap p_updateIcons_0_, IResourcePack p_updateIcons_1_)
    {
        ...
        List<List> list = makePropertyList(tileProperties);
        List<List> list1 = makePropertyList(blockProperties);
    ...
    private static List<List> makePropertyList(ConnectedProperties[][] p_makePropertyList_0_)
    {
    ...
    private static boolean detectMultipass()
    {
        ...
        for (int i = 0; i < tileProperties.length; ++i)
        {
            ...
            if (aconnectedproperties != null)
            {
                list.addAll(Arrays.<ConnectedProperties>asList(aconnectedproperties));
            }
        }
        ...
        for (int k = 0; k < blockProperties.length; ++k)
        {
            ...
            {
                list.addAll(Arrays.<ConnectedProperties>asList(aconnectedproperties2));
            }
        }
        ...
        for (int j = 0; j < aconnectedproperties1.length; ++j)
        {
            ...
            {
                set1.addAll(Arrays.<TextureAtlasSprite>asList(connectedproperties.matchTileIcons));
            }

            if (connectedproperties.tileIcons != null)
            {
                set.addAll(Arrays.<TextureAtlasSprite>asList(connectedproperties.tileIcons));
            }
        }
    ...
    private static void addToTileList(ConnectedProperties p_addToTileList_0_, List<List> p_addToTileList_1_)
    {
    ...
    private static void addToBlockList(ConnectedProperties p_addToBlockList_0_, List<List> p_addToBlockList_1_)
    {
    ...
    private static void addToList(ConnectedProperties p_addToList_0_, List<List> p_addToList_1_, int p_addToList_2_)
    {
        ...
        List<ConnectedProperties> list = (List<ConnectedProperties>)p_addToList_1_.get(p_addToList_2_);
