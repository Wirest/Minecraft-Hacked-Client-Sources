...
public class FileUploadThread extends Thread
{
    ...
    public FileUploadThread(String p_i48_1_, Map p_i48_2_, byte[] p_i48_3_, IFileUploadListener p_i48_4_)
    {
        this.urlString = p_i48_1_;
        this.headers = p_i48_2_;
        this.content = p_i48_3_;
        this.listener = p_i48_4_;
    }
