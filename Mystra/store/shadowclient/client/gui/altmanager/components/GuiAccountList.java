package store.shadowclient.client.gui.altmanager.components;
...
public class GuiAccountList extends GuiSlot {
	...
	public int getSize() {
		return Shadow.instance.getAccountManager().getAccounts().size();
	}
	...
	public Account getAccount(int i) {
		return Shadow.instance.getAccountManager().getAccounts().get(i);
	}
	...
	public void removeSelected() {
		if (this.selected == -1)
			return;
		Shadow.instance.getAccountManager().getAccounts().remove(getAccount(this.selected));
