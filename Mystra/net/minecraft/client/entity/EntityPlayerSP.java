...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void moveEntity(double x, double y, double z) {
    	EventSpeed eventSpeed = new EventSpeed(x, y, z);
    	eventSpeed.call();
    	super.moveEntity(eventSpeed.getX(), eventSpeed.getY(), eventSpeed.getZ());
    }
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            if (this.ridingEntity == null)
            {
                if (flag2 && flag3)
                {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.posX, this.getEntityBoundingBox().minY, this.posZ, eventPreMotionUpdate.getYaw(), eventPreMotionUpdate.getPitch(), this.onGround));
                }
                else if (flag2)
                {
                ...
                {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(eventPreMotionUpdate.getYaw(), eventPreMotionUpdate.getPitch(), this.onGround));
                }
                else
                {
            ...
            {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0D, this.motionZ, eventPreMotionUpdate.getYaw(), eventPreMotionUpdate.getPitch(), this.onGround));
                flag2 = false;
            }
