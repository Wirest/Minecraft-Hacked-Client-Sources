...
public enum EnumFacing implements IStringSerializable
{
    ...
    private EnumFacing(String p_i18_3_, int p_i18_4_, int p_i18_5_, int p_i18_6_, int p_i18_7_, String p_i18_8_, EnumFacing.AxisDirection p_i18_9_, EnumFacing.Axis p_i18_10_, Vec3i p_i18_11_)
    {
        this.index = p_i18_5_;
    ...
    public static enum Axis implements Predicate, IStringSerializable {
        ...
        private Axis(String p_i15_3_, int p_i15_4_, String p_i15_5_, EnumFacing.Plane p_i15_6_)
        {
            this.name = p_i15_5_;
            this.plane = p_i15_6_;
        }
    ...
    public static enum AxisDirection {
        ...
        private AxisDirection(String p_i16_3_, int p_i16_4_, int p_i16_5_, String p_i16_6_)
        {
    ...
    public static enum Plane implements Predicate, Iterable {
        ...
        private Plane(String p_i17_3_, int p_i17_4_)
        {
        }
