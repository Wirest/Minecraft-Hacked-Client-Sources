...
public class CustomGuiProperties
{
    ...
    public CustomGuiProperties(Properties p_i38_1_, String p_i38_2_)
    {
        ...
        this.variants = (CustomGuiProperties.EnumVariant[])((CustomGuiProperties.EnumVariant[])connectedparser.parseEnums(p_i38_1_.getProperty("variants"), acustomguiproperties$enumvariant, "variants", VARIANTS_INVALID));
