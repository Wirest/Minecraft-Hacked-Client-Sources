package me.slowly.client.ui.textfield;
   ...
   public void drawTextBox() {
      if (this.getVisible()) {
         if (this.getEnableBackgroundDrawing()) {
            drawBorderedRect((float)this.xPosition, (float)this.yPosition, (float)(this.xPosition + this.width), (float)(this.yPosition + this.height), 0.7F, this.isFocused ? Colors.DARKGREY.c : Colors.GREY.c, 0);
         }
         ...
         if (k != j) {
            ...
            Gui.drawRect(k1, i1 - 1, l1 - 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, ClientUtil.reAlpha(Colors.DARKBLUE.c, 0.3F));
         }
      }
