package me.slowly.client.ui.clickgui.Komplexe;
...
public class UIKomplexe extends GuiScreen {
   ...
   public UIKomplexe() {
      ...
      for(int i = 0; i < length; ++i) {
         ...
         if (c != Mod.Category.NONE && c != Mod.Category.SETTINGS) {
            KomplPanel panel = new KomplPanel(xAxis, 10, c);
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      while(var5.hasNext()) {
         KomplPanel p = (KomplPanel)var5.next();
   ...
   public void onGuiClosed() {
      ...
      Client.getInstance().getFileUtil().saveKompl();
   }
