...
public class KomplPanel {
   ...
   public KomplPanel(int x, int y, Mod.Category cat) {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      GuiIngame.drawRect(this.x, this.y, this.x + this.width, this.y + this.height, -14207162);
