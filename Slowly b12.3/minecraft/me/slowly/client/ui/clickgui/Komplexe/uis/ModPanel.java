package me.slowly.client.ui.clickgui.Komplexe.uis;
...
public class ModPanel {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks, float delta) {
      ...
      while(true) {
         ...
         if (this.y + this.yAxis >= this.panelY) {
            Gui.drawRect(this.x + 1, this.y + this.yAxis, this.x + this.width - 1, this.y + this.yAxis + this.height, -12171690);
            this.drawOutlinedRect((float)this.x + 1.8F, (float)(this.y + this.yAxis) + 0.5F, (float)(this.x + this.width) - 1.8F, (float)(this.y + this.yAxis + this.height) - 0.5F, 0.5F, Color.BLACK, m.isEnabled() ? new Color(-14207162) : new Color(-15063502));
            int xOld = this.x;
            int yOld = this.y;
            ...
            if (this.isOpen) {
               if (this.isHovering(mouseX, mouseY, this.x + 1, this.y + this.yAxis, this.x + this.width - 1, this.y + this.yAxis + this.height)) {
                  UIKomplexe.currentMod = m;
                  hover = true;
               }

               if (UIKomplexe.currentMod == m && this.yAdd == 0.0F) {
            ...
            if (m.openValues) {
               ...
               while(true) {
                  ...
                  if (value.isValueMode) {
                     ...
                     for(int i = 0; i < value.listModes().size(); ++i) {
                        ...
                        if (value.getCurrentMode() == i) {
                           ...
                           Client.getInstance().getFontManager().simpleton16.drawStringWithShadow(name, var10002, var10003 - (float)stringHeightMode / 2.0F, -14207162);
                        } else {
                           var10002 = (float)this.x + (float)this.width / 2.0F - (float)stringWidthMode / 2.0F;
                           var10003 = (float)(this.y + this.yAxis) + (float)this.height / 2.0F;
                           Client.getInstance().getFontManager().simpleton16.drawStringWithShadow(name, var10002, var10003 - (float)stringHeightMode / 2.0F, -1);
                        }
                  ...
                  if (value.isValueDouble) {
                     ...
                     Gui.drawRect(this.x + 1, this.y + this.yAxis, this.x + this.width - 1, this.y + this.yAxis + this.height, -13218716);
                     Gui.drawRect(this.x + 1, this.y + this.yAxis + 1, this.x + this.width - 1, this.y + this.yAxis + this.height - 2, -13087644);
                     GuiIngame var41 = Minecraft.getMinecraft().ingameGUI;
                     GuiIngame.drawRect((float)(this.x + 1), (float)(this.y + this.yAxis + 1), (float)val, (float)(this.y + this.yAxis + this.height - 2), -14207162);
