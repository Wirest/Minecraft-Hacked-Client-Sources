package me.slowly.client.ui.clickgui.solstice;
...
public class UISolstice extends GuiScreen {
   ...
   public UISolstice() {
      ...
      for(int i = 0; i < length; ++i) {
         ...
         if (c != Mod.Category.NONE && c != Mod.Category.SETTINGS) {
            SolsticePanel panel = new SolsticePanel(xAxis, 10, c);
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      while(var5.hasNext()) {
         SolsticePanel p = (SolsticePanel)var5.next();
   ...
   public void onGuiClosed() {
      ...
      Client.getInstance().getFileUtil().saveSolstice();
   }
