package me.slowly.client.ui.clickgui.other;
...
import me.slowly.client.ui.clickgui.other.screens.Panel;
import net.minecraft.client.Minecraft;
import net.minecraft.client.gui.GuiScreen;
import net.minecraft.util.ResourceLocation;

public class UIOther extends GuiScreen {
   ...
   public void onGuiClosed() {
      ...
      Client.getInstance().getFileUtil().saveOther();
   }
