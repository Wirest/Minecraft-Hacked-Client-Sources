...
public final class Bitstream implements BitstreamErrors {
   ...
   void parse_frame() throws BitstreamException {
      ...
      for(int k = 0; k < bytesize; k += 4) {
         ...
         this.framebuffer[b++] = b01 << 24 & -16777216 | b1 << 16 & 16711680 | b2 << 8 & '\uff00' | b3 & 255;
      }
   ...
   public int get_bits(int number_of_bits) {
      ...
      int returnvalue1;
      if (sum <= 32) {
         returnvalue1 = this.framebuffer[this.wordpointer] >>> 32 - sum & this.bitmask[number_of_bits];
         ...
         returnvalue1 = Right << 16 & -65536 | Left >>> 16 & '\uffff';
         returnvalue1 >>>= 48 - sum;
         returnvalue1 &= this.bitmask[number_of_bits];
