...
public class ConnectedParser {
   ...
   public MatchBlock[] parseMatchBlock(String p_parseMatchBlock_1_) {
      if (p_parseMatchBlock_1_ == null) {
         ...
         if (p_parseMatchBlock_1_.length() <= 0) {
            ...
            String s1 = astring[i1];
            String[] astring1 = (String[])Arrays.copyOfRange(astring, i1 + 1, astring.length);
   ...
   public static Comparable getPropertyValue(String p_getPropertyValue_0_, Collection p_getPropertyValue_1_) {
      Iterator var3 = p_getPropertyValue_1_.iterator();

      while(var3.hasNext()) {
         Object comparable = var3.next();
   ...
   public static Comparable parseValue(String p_parseValue_0_, Class p_parseValue_1_) {
      return (Comparable)(p_parseValue_1_ == String.class ? p_parseValue_0_ : (p_parseValue_1_ == Boolean.class ? Boolean.valueOf(p_parseValue_0_) : p_parseValue_1_ == Float.class ? (double)Float.valueOf(p_parseValue_0_).floatValue() : (p_parseValue_1_ == Double.class ? Double.valueOf(p_parseValue_0_).doubleValue() : (double)(p_parseValue_1_ == Integer.class ? (long)Integer.valueOf(p_parseValue_0_).intValue() : (p_parseValue_1_ == Long.class ? Long.valueOf(p_parseValue_0_) : null).longValue()))));
   }

   public boolean matchState(IBlockState p_matchState_1_, Map p_matchState_2_) {
      Iterator var4 = p_matchState_2_.entrySet().iterator();
