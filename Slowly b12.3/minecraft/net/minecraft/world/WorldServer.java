...
public class WorldServer extends World implements IThreadListener
{
    ...
    protected void updateBlocks() {
        ...
        if (this.worldInfo.getTerrainType() == WorldType.DEBUG_WORLD) {
           ...
           while(var2.hasNext()) {
              ChunkCoordIntPair chunkcoordintpair1 = (ChunkCoordIntPair)var2.next();
           ...
           for(Iterator var4 = this.activeChunkSet.iterator(); var4.hasNext(); this.theProfiler.endSection()) {
              ChunkCoordIntPair chunkcoordintpair = (ChunkCoordIntPair)var4.next();
              ...
              if (l2 > 0) {
                 ...
                 int var11 = (var12 = chunk.getBlockStorageArray()).length;

                 for(int var23 = 0; var23 < var11; ++var23) {
                    ExtendedBlockStorage extendedblockstorage = var12[var23];
