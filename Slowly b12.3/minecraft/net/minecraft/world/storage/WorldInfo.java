...
public class WorldInfo {
   ...
   public WorldInfo(NBTTagCompound nbt) {
      ...
      if (nbt.hasKey("DayTime", 99)) {
         this.worldTime = ModManager.getModByName("Light").isEnabled() ? 14000L : nbt.getLong("DayTime");
      } else {
         this.worldTime = ModManager.getModByName("Light").isEnabled() ? 14000L : this.totalTime;
      }
