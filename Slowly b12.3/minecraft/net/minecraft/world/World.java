...
public abstract class World implements IBlockAccess {
         ...
         for(int l1 = i1; l1 < j1; ++l1) {
            if (this.isBlockLoaded(blockpos$mutableblockpos.func_181079_c(k1, 64, l1))) {
               for(int i2 = k - 1; i2 < l; ++i2) {
                  ...
                  BlockCollideEvent event = new BlockCollideEvent(iblockstate1, blockpos$mutableblockpos, list);
   ...
   public float getSunBrightness(float p_72971_1_) {
      ...
      float var10000 = (float)((double)f1 * (1.0D - (double)(this.getThunderStrength(p_72971_1_) * 5.0F) / 16.0D));
      return 0.6F;
   }
   ...
   public void addTileEntities(Collection tileEntityCollection) {
      if (this.processingLoadedTiles) {
         ...
         Iterator var3 = tileEntityCollection.iterator();
         ...
         if (l > k) {
            ...
            while(true) {
               ...
               for(int var22 = 0; var22 < var23; ++var22) {
                  EnumFacing enumfacing = var24[var22];
   ...
   public void loadEntities(Collection entityCollection) {
      ...
      Iterator var3 = entityCollection.iterator();
