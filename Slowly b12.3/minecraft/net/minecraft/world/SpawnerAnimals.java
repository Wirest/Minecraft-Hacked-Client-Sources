...
public final class SpawnerAnimals
{
    ...
    public int findChunksForSpawning(WorldServer p_77192_1_, boolean spawnHostileMobs, boolean spawnPeacefulMobs, boolean p_77192_4_) {
        if (!spawnHostileMobs && !spawnPeacefulMobs) {
           ...
           int i = 0;
           Iterator var7 = p_77192_1_.playerEntities.iterator();
           ...
           while(true) {
              ...
              do {
                 if (!var7.hasNext()) {
                    ...
                    label122:
                    for(k = 0; k < var39; ++k) {
                       EnumCreatureType enumcreaturetype = var40[k];
                       if ((!enumcreaturetype.getPeacefulCreature() || spawnPeacefulMobs) && (enumcreaturetype.getPeacefulCreature() || spawnHostileMobs) && (!enumcreaturetype.getAnimal() || p_77192_4_)) {
                          j1 = p_77192_1_.countEntities(enumcreaturetype.getCreatureClass());
                          ...
                          if (j1 <= k4) {
                             ...
                             while(true) {
                                ...
                                do {
                                   ...
                                   chunkcoordintpair = (ChunkCoordIntPair)var15.next();
                                   BlockPos blockpos = getRandomChunkPosition(p_77192_1_, chunkcoordintpair.chunkXPos, chunkcoordintpair.chunkZPos);
                                   k1 = blockpos.getX();
                                   l1 = blockpos.getY();
                                   i2 = blockpos.getZ();
              ...
              for(int i1 = -l; i1 <= l; ++i1) {
                 for(j1 = -l; j1 <= l; ++j1) {
                    ...
                    chunkcoordintpair = new ChunkCoordIntPair(i1 + j, j1 + k);
