...
public class TileEntityBeacon extends TileEntityLockable implements ITickable, IInventory
{
    ...
    private void updateSegmentColors() {
        ...
        if (!this.worldObj.isRemote && this.levels == 4 && i < this.levels) {
           Iterator var16 = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, (new AxisAlignedBB((double)j, (double)k, (double)l, (double)j, (double)(k - 4), (double)l)).expand(10.0D, 5.0D, 10.0D)).iterator();

           while(var16.hasNext()) {
              EntityPlayer entityplayer = (EntityPlayer)var16.next();
