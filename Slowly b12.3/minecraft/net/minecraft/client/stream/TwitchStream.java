...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream {
   ...
   public void func_152930_t() {
      ...
      if (gamesettings.streamPreferredServer != null && gamesettings.streamPreferredServer.length() > 0) {
         ...
         for(int var4 = 0; var4 < var5; ++var4) {
            IngestServer ingestserver = var6[var4];
   ...
   public void func_152892_c(ErrorCode p_152892_1_) {
      ChatComponentTranslation ichatcomponent;
      if (p_152892_1_ == ErrorCode.TTV_EC_SOUNDFLOWER_NOT_INSTALLED) {
         ichatcomponent = new ChatComponentTranslation("stream.unavailable.soundflower.chat.link", new Object[0]);
         ...
         ichatcomponent = new ChatComponentTranslation("stream.unavailable.unknown.chat", new Object[]{ErrorCode.getString(p_152892_1_)});
         ichatcomponent.getChatStyle().setColor(EnumChatFormatting.DARK_RED);
   ...
   public void func_180605_a(String p_180605_1_, ChatRawMessage[] p_180605_2_) {
      ChatRawMessage[] var6 = p_180605_2_;
      int var5 = p_180605_2_.length;

      for(int var4 = 0; var4 < var5; ++var4) {
         ChatRawMessage chatrawmessage = var6[var4];
         ...
         if (this.func_176028_a(chatrawmessage.modes, chatrawmessage.subscriptions, this.mc.gameSettings.streamChatUserFilter)) {
            ...
            Iterator var11 = GuiTwitchUserMode.func_152328_a(chatrawmessage.modes, chatrawmessage.subscriptions, (IStream)null).iterator();

            while(var11.hasNext()) {
               IChatComponent ichatcomponent3 = (IChatComponent)var11.next();
   ...
   public void func_176018_a(String p_176018_1_, ChatUserInfo[] p_176018_2_, ChatUserInfo[] p_176018_3_, ChatUserInfo[] p_176018_4_) {
      ChatUserInfo[] var8 = p_176018_3_;
      int var7 = p_176018_3_.length;

      ChatUserInfo chatuserinfo2;
      int var6;
      for(var6 = 0; var6 < var7; ++var6) {
         chatuserinfo2 = var8[var6];
         this.field_152955_g.remove(chatuserinfo2.displayName);
      }

      var8 = p_176018_4_;
      var7 = p_176018_4_.length;
