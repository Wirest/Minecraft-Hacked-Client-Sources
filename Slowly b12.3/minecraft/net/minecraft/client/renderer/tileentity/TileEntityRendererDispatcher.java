...
public class TileEntityRendererDispatcher {
   ...
   private TileEntityRendererDispatcher() {
      ...
      while(var2.hasNext()) {
         TileEntitySpecialRenderer tileentityspecialrenderer = (TileEntitySpecialRenderer)var2.next();
   ...
   public void renderTileEntity(TileEntity tileentityIn, float partialTicks, int destroyStage) {
      if (tileentityIn.getDistanceSq(this.entityX, this.entityY, this.entityZ) < tileentityIn.getMaxRenderDistanceSquared()) {
         ...
         EventRenderTileEntity event = new EventRenderTileEntity(this, tileentityIn, partialTicks, destroyStage, staticPlayerX, staticPlayerY, staticPlayerZ);
