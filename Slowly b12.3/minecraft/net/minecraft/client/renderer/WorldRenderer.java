...
public class WorldRenderer {
   ...
   public void func_181674_a(float p_181674_1_, float p_181674_2_, float p_181674_3_) {
      ...
      for(int l1 = 0; (l1 = bitset.nextClearBit(l1)) < ainteger.length; ++l1) {
         ...
         if (i1 != l1) {
            ...
            for(k1 = ainteger[i1].intValue(); j2 != l1; k1 = ainteger[k1].intValue()) {
      ...
      if (this.quadSprites != null) {
         ...
         i1 = this.vertexFormat.func_181719_f() / 4 * 4;

         for(j2 = 0; j2 < ainteger.length; ++j2) {
            k1 = ainteger[j2].intValue();
   ...
   public void addWithUv(double p_178985_1_, double p_178985_3_, double p_178985_5_, double p_178985_7_, double p_178985_9_) {
      this.pos(p_178985_1_, p_178985_3_, p_178985_5_).tex(p_178985_7_, p_178985_9_).endVertex();
   }
