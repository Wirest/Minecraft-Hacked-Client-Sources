...
public class RenderChunk {
   ...
   public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
      ...
      if (!regionrendercache.extendedLevelsInChunkCache()) {
         ...
         while(iterator.hasNext()) {
            ...
            boolean flag4;
            if (flag1) {
               flag4 = Reflector.callBoolean(iterator, Reflector.ForgeBlock_hasTileEntity, blockrendererdispatcher);
            } else {
            ...
            for(int i = 0; i < aenumworldblocklayer.length; ++i) {
               ...
               if (flag2) {
                  boolean flag5 = Reflector.callBoolean(block, Reflector.ForgeBlock_canRenderInLayer, enumworldblocklayer);
                  if (!flag5) {
                     continue;
                  }
               }
         ...
         int var37 = (var38 = EnumWorldBlockLayer.values()).length;

         for(int var36 = 0; var36 < var37; ++var36) {
            EnumWorldBlockLayer enumworldblocklayer1 = var38[var36];
   ...
   public ChunkCompileTaskGenerator makeCompileTaskTransparency() {
      ...
      try {
         ...
         var4 = chunkcompiletaskgenerator;
      } finally {
         this.lockCompileTask.unlock();
      }
