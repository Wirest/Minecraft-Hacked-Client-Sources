...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   public void getMouseOver(float partialTicks) {
      ...
      if (entity != null && this.mc.theWorld != null) {
         ...
         if (ModManager.getModByName("SuperHit").isEnabled()) {
            d0 = 256.0D;
            d1 = 256.0D;
      ...
      if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
         ...
         if (!this.mc.gameSettings.debugCamEnable) {
            ...
            if (Reflector.ForgeHooksClient_orientBedCamera.exists()) {
               ...
               int j = ((EnumFacing)iblockstate.getValue(BlockDirectional.FACING)).getHorizontalIndex();
   ...
   private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
      ...
      if (!this.debugView) {
         ...
         if (this.mc.objectMouseOver != null && entity.isInsideOfMaterial(Material.water) && flag) {
            ...
            flag1 = Reflector.ForgeHooksClient_onDrawBlockHighlight.exists();
            if ((!flag1 || !Reflector.callBoolean(Reflector.ForgeHooksClient_onDrawBlockHighlight, renderglobal, entityplayer, this.mc.objectMouseOver, Integer.valueOf(0), entityplayer.getHeldItem(), partialTicks)) && !this.mc.gameSettings.hideGUI) {
      ...
      boolean flag3 = Reflector.callBoolean(Reflector.ForgeHooksClient_renderFirstPersonHand, this.mc.renderGlobal, partialTicks, pass);
   ...
   private void setupFog(int p_78468_1_, float partialTicks) {
      ...
      GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
      Block block = ActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, entity, partialTicks);
      Object object = Reflector.newInstance(Reflector.EntityViewRenderEvent_FogDensity_Constructor, this, entity, block, partialTicks, 0.1F);
      float f;
      if (Reflector.postForgeBusEvent(object)) {
         f = Reflector.getFieldValueFloat(object, Reflector.EntityViewRenderEvent_FogDensity_density, 0.0F);
         GL11.glFogf(2914, f);
   ...
   private void frameInit() {
      ...
      if (world != null) {
         if (Config.getNewRelease() != null) {
            ...
            ChatComponentText chatcomponenttext = new ChatComponentText("A new ¡ìeOptiFine¡ìf version is available: ¡ìe" + s1 + "¡ìf");
         ...
         if (Config.isNotify64BitJava()) {
            ...
            ChatComponentText chatcomponenttext1 = new ChatComponentText("You can install ¡ìe64-bit Java¡ìf to increase performance");
      ...
      if (this.mc.theWorld != null) {
         ...
         if (i > this.lastErrorCheckTimeMs + 10000L) {
            ...
            if (j != 0) {
               ...
               ChatComponentText chatcomponenttext = new ChatComponentText("¡ìeOpenGL Error¡ìf: " + j + " (" + s + ")");
               this.mc.ingameGUI.getChatGUI().printChatMessage(chatcomponenttext);
            }
         }
      }
