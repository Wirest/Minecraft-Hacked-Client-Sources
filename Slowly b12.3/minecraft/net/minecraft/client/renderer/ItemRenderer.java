...
public class ItemRenderer {
   ...
   private void func_178105_d(float p_178105_1_) {
      ...
      float f1;
      float f2;
      if (!ModManager.getModByName("SwingAnimation").isEnabled()) {
         f = -0.4F * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * 3.1415927F);
         f1 = 0.2F * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * 3.1415927F * 2.0F);
         f2 = -0.2F * MathHelper.sin(p_178105_1_ * 3.1415927F);
         GlStateManager.translate(f, f1, f2);
      } else {
         f = -0.15F * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * 3.1415927F);
         f1 = -0.05F * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * 3.1415927F * 1.5F);
         f2 = -0.0F * MathHelper.sin(p_178105_1_ * 3.1415927F);
         GlStateManager.translate(f, f1, f2);
      }
           ...
           else if (var3.getItemInUseCount() > 0)
           {
...
)
               {
                   ...
                   case 3://DRINK
                   	...
                   	transformFirstPersonItem(var2 + 0.21F, var4);
                   ...
                   case 4://BLOCK
                        ...
                        GlStateManager.rotate(-var15 * ((float) 90D / 4.0F), -9.0F, -0.0F, 9.0F); //TODO: SWORD ANIMATIONS
