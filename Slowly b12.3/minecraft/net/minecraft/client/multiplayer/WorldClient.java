...
public class WorldClient extends World {
   ...
   public void tick() {
      ...
      if (ModManager.getModByName("Light").isEnabled()) {
         this.setWorldTime(14000L);
      } else if (this.getGameRules().getBoolean("doDaylightCycle")) {
         this.setWorldTime(this.getWorldTime());
      }
   ...
   public Block getBlock(int p_147439_1_, int p_147439_2_, int p_147439_3_) {
      if (p_147439_1_ >= -30000000 && p_147439_3_ >= -30000000 && p_147439_1_ < 30000000 && p_147439_3_ < 30000000 && p_147439_2_ >= 0 && p_147439_2_ < 256) {
         ...
         try {
            ...
            CrashReport var5 = CrashReport.makeCrashReport(var8, "Exception getting block type in world");
