...
public class Minecraft implements IThreadListener, IPlayerUsage {
   ...
   long lastFrame;
   boolean setSettings;
   TimeHelper sendPacketTimer = new TimeHelper();
   // $FF: synthetic field
   ...
   private void createDisplay() throws LWJGLException {
      ...
      Display.setTitle("§³§å§Ü§Ñ §Ò§Ý§ñ§Õ§î Client Loading......");
         ...
         while(true) {
            while(true) {
               ...
               do {
                  ...
                  while(var7.hasNext()) {
                     DisplayMode displaymode2 = (DisplayMode)var7.next();
   ...
   private void runGameLoop() throws IOException {
	      ...
	      if (this.theWorld != null && this.setSettings) {
	         this.setSettings = false;
	         boolean var10000 = this.gameSettings.ofFastRender;
	      }
      ...
      if (this.mcProfiler.profilingEnabled) {
         ...
         for(int l = 0; l < list.size(); ++l) {
            ...
            for(i3 = i1; i3 >= 0; --i3) {
               ...
               worldrenderer.pos((double)((float)j + f4), (double)((float)k - f5), 0.0D).color(k1, l1, i2, 255).endVertex();
            }
      ...
      if (this.objectMouseOver != null) {
         ...
         if (this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (this.objectMouseOver.entityHit instanceof EntityPainting) {
               ...
               switch($SWITCH_TABLE$net$minecraft$entity$item$EntityMinecart$EnumMinecartType()[entityminecart.getMinecartType().ordinal()]) {
               case 2:
