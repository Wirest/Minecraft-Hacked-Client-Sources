...
public class GuiControls extends GuiScreen {
   ...
   public void initGui() {
      ...
      int i = 0;
      GameSettings.Options[] var5 = optionsArr;
      int var4 = optionsArr.length;

      for(int var3 = 0; var3 < var4; ++var3) {
         GameSettings.Options gamesettings$options = var5[var3];
   ...
   protected void actionPerformed(GuiButton button) throws IOException {
      if (button.id == 200) {
         ...
         KeyBinding[] var5 = this.mc.gameSettings.keyBindings;
         int var4 = this.mc.gameSettings.keyBindings.length;
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      boolean flag = true;
      KeyBinding[] var8 = this.options.keyBindings;
      int var7 = this.options.keyBindings.length;

      for(int var6 = 0; var6 < var7; ++var6) {
         KeyBinding keybinding = var8[var6];
