...
public class MapItemRenderer {
   ...
   private MapItemRenderer.Instance getMapRendererInstance(MapData mapdataIn) {
      ...
      if (mapitemrenderer$instance == null) {
         mapitemrenderer$instance = new MapItemRenderer.Instance(mapdataIn, (MapItemRenderer.Instance)null);
   ...
   public void clearLoadedMaps() {
      ...
      while(var2.hasNext()) {
         MapItemRenderer.Instance mapitemrenderer$instance = (MapItemRenderer.Instance)var2.next();
   ...
   class Instance {
      ...
      // $FF: synthetic method
      Instance(MapData var2, MapItemRenderer.Instance var3) {
         this(var2);
      }
   }
}
