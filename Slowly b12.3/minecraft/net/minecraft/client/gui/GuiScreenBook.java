      ...
      if (this.bookGettingSigned) {
         ...
         if (this.bookIsUnsigned) {
            if (this.updateCount / 6 % 2 == 0) {
               s4 = s4 + EnumChatFormatting.BLACK + "_";
            } else {
               s4 = s4 + EnumChatFormatting.GRAY + "_";
            }
         }

         s5 = I18n.format("book.editTitle");
         j1 = this.fontRendererObj.getStringWidth(s5);
         this.fontRendererObj.drawString(s5, (float)(i + 36 + (116 - j1) / 2), (float)(j + 16 + 16), 0);
         k1 = this.fontRendererObj.getStringWidth(s4);
         this.fontRendererObj.drawString(s4, (float)(i + 36 + (116 - k1) / 2), (float)(j + 48), 0);
         String s2 = I18n.format("book.byAuthor", this.editingPlayer.getName());
         int i1 = this.fontRendererObj.getStringWidth(s2);
         this.fontRendererObj.drawString(EnumChatFormatting.DARK_GRAY + s2, (float)(i + 36 + (116 - i1) / 2), (float)(j + 48 + 10), 0);
         ...
         if (i >= 0 && j >= 0) {
            ...
            if (i <= 116 && j < this.mc.fontRendererObj.FONT_HEIGHT * k + k) {
               ...
               if (l >= 0 && l < this.field_175386_A.size()) {
                  ...
                  int i1 = 0;
                  Iterator var10 = ichatcomponent.iterator();

                  while(var10.hasNext()) {
                     IChatComponent ichatcomponent1 = (IChatComponent)var10.next();
