...
public class GuiPageButtonList extends GuiListExtended {
   ...
   private void func_178069_s() {
      GuiPageButtonList.GuiListEntry[][] var4 = this.field_178078_x;
      int var3 = this.field_178078_x.length;

      for(int var2 = 0; var2 < var3; ++var2) {
         GuiPageButtonList.GuiListEntry[] aguipagebuttonlist$guilistentry = var4[var2];
   ...
   private void func_178060_e(int p_178060_1_, int p_178060_2_) {
      ...
      int var5 = (var6 = this.field_178078_x[p_178060_1_]).length;

      GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry1;
      int var4;
      for(var4 = 0; var4 < var5; ++var4) {
         guipagebuttonlist$guilistentry1 = var6[var4];
      ...
      var5 = (var6 = this.field_178078_x[p_178060_2_]).length;
   ...
   public void func_181155_a(boolean p_181155_1_) {
      ...
      while(var3.hasNext()) {
         GuiPageButtonList.GuiEntry guipagebuttonlist$guientry = (GuiPageButtonList.GuiEntry)var3.next();
   ...
   public void func_178062_a(char p_178062_1_, int p_178062_2_) {
      if (this.field_178075_A instanceof GuiTextField) {
         ...
         if (!GuiScreen.isKeyComboCtrlV(p_178062_2_)) {
            ...
            int j = i1;
            String[] var11 = astring;
            int var10 = astring.length;

            for(int var9 = 0; var9 < var10; ++var9) {
               String s1 = var11[var9];
