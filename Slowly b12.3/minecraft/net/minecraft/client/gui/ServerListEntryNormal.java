...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
   ...
   public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
      ...
      this.mc.fontRendererObj.drawString(this.field_148301_e.serverName, (float)(x + 32 + 3), (float)(y + 1), 16777215);
      List list = this.mc.fontRendererObj.listFormattedStringToWidth(this.field_148301_e.serverMOTD, listWidth - 32 - 2);

      for(int i = 0; i < Math.min(list.size(), 2); ++i) {
         this.mc.fontRendererObj.drawString((String)list.get(i), (float)(x + 32 + 3), (float)(y + 12 + this.mc.fontRendererObj.FONT_HEIGHT * i), 8421504);
      }
