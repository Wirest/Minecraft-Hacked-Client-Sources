...
public class GuiChat extends GuiScreen {
   ...
   public void autocompletePlayerNames() {
      ...
      if (this.playerNamesFound) {
         ...
         this.autocompleteIndex = 0;
         s2 = this.inputField.getText().substring(i).toLowerCase();
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      drawRect(1, this.height - 14, this.width - 2, this.height - 1, ClientUtil.reAlpha(Colors.BLACK.c, 0.75F));
      drawRect(1.0F, (float)(this.height - 14), 2.5F, (float)(this.height - 1), ClientUtil.reAlpha(FlatColors.BLUE.c, 1.0F));
   ...
   public void onAutocompleteResponse(String[] p_146406_1_) {
      if (this.waitingOnAutocomplete) {
         this.playerNamesFound = false;
         this.foundPlayerNames.clear();
         String[] var5 = p_146406_1_;
         int var4 = p_146406_1_.length;
