...
public class GuiEditSign extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      ClientUtil.getClientfont().drawString(I18n.format("sign.edit"), ((float)this.width - ClientUtil.getClientfont().getStringWidth(I18n.format("sign.edit"))) / 2.0F, 40.0F, ClientFont.FontType.SHADOW_THICK, -1, Colors.GREY.c);
