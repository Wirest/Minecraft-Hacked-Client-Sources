...
public class GuiContainerCreative extends InventoryEffectRenderer {
   ...
   private void updateCreativeSearch() {
      ...
      int var4 = Enchantment.enchantmentsBookList.length;
      ...
      while(iterator.hasNext()) {
         ...
         boolean flag = false;
         Iterator var7 = itemstack.getTooltip(this.mc.thePlayer, this.mc.gameSettings.advancedItemTooltips).iterator();
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      int j;
      for(j = 0; j < k; ++j) {
         CreativeTabs creativetabs1 = var8[j];
