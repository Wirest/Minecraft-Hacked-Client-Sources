      ...
      if (button.enabled) {
         if (button.id == 2) {
            ...
            if (this.changed) {
               ...
               while(var14.hasNext()) {
                  ResourcePackListEntry resourcepacklistentry = (ResourcePackListEntry)var14.next();
               ...
               while(var14.hasNext()) {
                  ResourcePackRepository.Entry resourcepackrepository$entry = (ResourcePackRepository.Entry)var14.next();
