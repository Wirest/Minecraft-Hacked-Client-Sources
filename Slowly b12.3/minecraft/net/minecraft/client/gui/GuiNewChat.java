...
public class GuiNewChat extends Gui {
   ...
   public void drawChat(int p_146230_1_) {
      if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
         ...
         if (var5 > 0) {
            ...
            GlStateManager.translate(2.0D, 20.0D - ClientUtil.addY, 0.0D);
               ...
               if (var10 != null) {
                  ...
                  if (var11 < 200 || var3) {
                     ...
                     if (var14 > 3) {
                        ...
                        this.mc.fontRendererObj.drawStringWithShadow(ModManager.getModByName("StreamMode").isEnabled() ? "¡ì3Protected" : var17, (float)var15, (float)(var16 - 8), 16777215 + (var14 << 24));
   ...
   public IChatComponent getChatComponent(int p_146236_1_, int p_146236_2_) {
      p_146236_2_ = (int)((double)p_146236_2_ - ClientUtil.addY * 2.0D);
      if (!this.getChatOpen()) {
         return null;
      } else {
