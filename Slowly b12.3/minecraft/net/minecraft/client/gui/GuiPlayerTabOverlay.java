...
public class GuiPlayerTabOverlay extends Gui {
   private static final Ordering field_175252_a = Ordering.from(new GuiPlayerTabOverlay.PlayerComparator());
   ...
   public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
      ...
      if (this.header != null) {
         ...
         for(var20 = list1.iterator(); var20.hasNext(); l1 = Math.max(l1, this.mc.fontRendererObj.getStringWidth(s4))) {
            s4 = (String)var20.next();
         }
      }
      ...
      if (this.footer != null) {
         ...
         for(var20 = list2.iterator(); var20.hasNext(); l1 = Math.max(l1, this.mc.fontRendererObj.getStringWidth(s4))) {
            s4 = (String)var20.next();
         }
      }
      ...
      if (list1 != null) {
         ...
         for(var20 = list1.iterator(); var20.hasNext(); k1 += this.mc.fontRendererObj.FONT_HEIGHT) {
            s4 = (String)var20.next();
      ...
      for(int k4 = 0; k4 < l3; ++k4) {
         ...
         if (k4 < list.size()) {
            ...
            Client.getInstance().getModManager();
            if (ModManager.getModByName("NameProtect").isEnabled() && s1.contains(Minecraft.getMinecraft().thePlayer.getName()) && this.mc.theWorld != null) {
               s1 = s1.replace(Minecraft.getMinecraft().thePlayer.getName(), "¡ì3" + NameProtect.name + "¡ìf");
            }

            if (Client.getInstance().getIrcChat().isClientUser(s1)) {
               if (networkplayerinfo1.getGameType() == WorldSettings.GameType.SPECTATOR) {
                  s1 = EnumChatFormatting.ITALIC + s1;
                  this.mc.fontRendererObj.drawStringWithShadow("¡ì3[Slowly]" + s1, (float)j2, (float)k2, -1862270977);
               } else {
            	   this.mc.fontRendererObj.drawStringWithShadow("¡ì3[Slowly]" + s1, (float)j2, (float)k2, -1);
               }
            } else if (networkplayerinfo1.getGameType() == WorldSettings.GameType.SPECTATOR) {
               s1 = EnumChatFormatting.ITALIC + s1;
               this.mc.fontRendererObj.drawStringWithShadow(ModManager.getModByName("StreamMode").isEnabled() ? "¡ìcProtected" : s1, (float)j2, (float)k2, -1862270977);
            } else {
            	this.mc.fontRendererObj.drawStringWithShadow(ModManager.getModByName("StreamMode").isEnabled() ? "¡ìcProtected" : s1, (float)j2, (float)k2, -1);
            }
      ...
      if (list2 != null) {
         ...
         for(var20 = list2.iterator(); var20.hasNext(); k1 += this.mc.fontRendererObj.FONT_HEIGHT) {
            s4 = (String)var20.next();
            j5 = this.mc.fontRendererObj.getStringWidth(s4);
            this.mc.fontRendererObj.drawStringWithShadow(s4, (float)(width / 2 - j5 / 2), (float)k1, -1);
         }
