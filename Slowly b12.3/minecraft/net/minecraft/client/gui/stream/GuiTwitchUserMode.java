...
public class GuiTwitchUserMode extends GuiScreen {
   ...
   public static List func_152328_a(Set p_152328_0_, Set p_152328_1_, IStream p_152328_2_) {
      ...
      Iterator var7 = p_152328_0_.iterator();

      IChatComponent ichatcomponent2;
      ChatComponentText ichatcomponent3;
      while(var7.hasNext()) {
         ChatUserMode chatusermode = (ChatUserMode)var7.next();
      ...
      var7 = p_152328_1_.iterator();

      while(var7.hasNext()) {
         ChatUserSubscription chatusersubscription = (ChatUserSubscription)var7.next();
   ...
   public void initGui() {
      ...
      for(Iterator var5 = this.field_152332_r.iterator(); var5.hasNext(); k = Math.max(k, this.fontRendererObj.getStringWidth(ichatcomponent.getFormattedText()))) {
         ichatcomponent = (IChatComponent)var5.next();
      }
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      for(Iterator var6 = this.field_152332_r.iterator(); var6.hasNext(); i += this.fontRendererObj.FONT_HEIGHT) {
