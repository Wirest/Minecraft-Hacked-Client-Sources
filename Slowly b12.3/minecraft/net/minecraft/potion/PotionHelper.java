...
public class PotionHelper {
   ...
   public static int calcPotionLiquidColor(Collection p_77911_0_) {
      ...
      if (p_77911_0_ != null && !p_77911_0_.isEmpty()) {
         ...
         float f2 = 0.0F;
         float f3 = 0.0F;
         Iterator var7 = p_77911_0_.iterator();
         ...
         while(true) {
            ...
            do {
               ...
               potioneffect = (PotionEffect)var7.next();
   ...
   public static boolean getAreAmbient(Collection potionEffects) {
      Iterator var2 = potionEffects.iterator();
   ...
   public static List getPotionEffects(int p_77917_0_, boolean p_77917_1_) {
      List list = null;
      Potion[] var6 = Potion.potionTypes;
      int var5 = Potion.potionTypes.length;

      for(int var4 = 0; var4 < var5; ++var4) {
         Potion potion = var6[var4];
