        ...
        report.getCategory().addCrashSectionCallable("Is Modded", new Callable()
        {
            ...
            public String call() throws Exception
            {
                ...
                else
                {
                    ...
                    return !s.equals("Forge") ? "Definitely; Server brand changed to \'" + s + "\'" : (Minecraft.class.getSigners() == null ? "Very likely; Jar signature invalidated" : "Probably not. Jar signature remains and both client + server brands are untouched.");
                }
            }
        });
        return report;
