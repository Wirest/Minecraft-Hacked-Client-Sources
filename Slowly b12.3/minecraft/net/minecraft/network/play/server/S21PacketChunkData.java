...
public class S21PacketChunkData implements Packet<INetHandlerPlayClient> {
	   ...
	   public void writePacketData(PacketBuffer buf) throws IOException {
	      ...
	      buf.writeShort((short)(this.extractedData.dataSize & '\uffff'));
	   ...
	   public static S21PacketChunkData.Extracted func_179756_a(Chunk p_179756_0_, boolean p_179756_1_, boolean p_179756_2_, int p_179756_3_) {
	      ...
	      for(j = 0; j < aextendedblockstorage.length; ++j) {
	         extendedblockstorage3 = aextendedblockstorage[j];
	         if (extendedblockstorage3 != null && (!p_179756_1_ || !extendedblockstorage3.isEmpty()) && (p_179756_3_ & 1 << j) != 0) {
	            s21packetchunkdata$extracted.dataSize |= 1 << j;
	            list.add(extendedblockstorage3);
	         }
	      }
	      ...
	      while(var9.hasNext()) {
	         extendedblockstorage3 = (ExtendedBlockStorage)var9.next();
	         char[] achar = extendedblockstorage3.getData();
	         char[] var14 = achar;
	         int var13 = achar.length;
	      ...
	      for(var9 = list.iterator(); var9.hasNext(); j = func_179757_a(extendedblockstorage3.getBlocklightArray().getData(), s21packetchunkdata$extracted.data, j)) {
	         extendedblockstorage3 = (ExtendedBlockStorage)var9.next();
	      }

	      if (p_179756_2_) {
	         for(var9 = list.iterator(); var9.hasNext(); j = func_179757_a(extendedblockstorage3.getSkylightArray().getData(), s21packetchunkdata$extracted.data, j)) {
	            extendedblockstorage3 = (ExtendedBlockStorage)var9.next();
	         }
	      }
