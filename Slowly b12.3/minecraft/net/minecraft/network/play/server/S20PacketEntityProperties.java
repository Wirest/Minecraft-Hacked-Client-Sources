...
public class S20PacketEntityProperties implements Packet<INetHandlerPlayClient> {
	   ...
	   public S20PacketEntityProperties(int entityIdIn, Collection p_i45236_2_) {
	      ...
	      Iterator var4 = p_i45236_2_.iterator();

	      while(var4.hasNext()) {
	         IAttributeInstance iattributeinstance = (IAttributeInstance)var4.next();
	   ...
	   public void writePacketData(PacketBuffer buf) throws IOException {
	      ...
	      while(var3.hasNext()) {
	         S20PacketEntityProperties.Snapshot s20packetentityproperties$snapshot = (S20PacketEntityProperties.Snapshot)var3.next();
	         ...
	         Iterator var5 = s20packetentityproperties$snapshot.func_151408_c().iterator();
