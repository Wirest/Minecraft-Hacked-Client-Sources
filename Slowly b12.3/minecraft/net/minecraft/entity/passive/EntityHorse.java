...
public class EntityHorse extends EntityAnimal implements IInvBasic
{
    ...
    protected EntityHorse getClosestHorse(Entity entityIn, double distance) {
        ...
        Entity entity = null;
        Iterator var8 = this.worldObj.getEntitiesInAABBexcluding(entityIn, entityIn.getEntityBoundingBox().addCoord(distance, distance, distance), horseBreedingSelector).iterator();

        while(var8.hasNext()) {
           Entity entity1 = (Entity)var8.next();
