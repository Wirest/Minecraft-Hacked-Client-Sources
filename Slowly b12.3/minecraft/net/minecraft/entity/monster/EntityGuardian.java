    ...
    protected void updateAITasks()
    {
        ...
        if (this.isElder())
        {
            ...
            if ((this.ticksExisted + this.getEntityId()) % 1200 == 0) {
                ...
                Iterator var7 = this.worldObj.getPlayers(EntityPlayerMP.class, new Predicate<Entity>() {
		        ...
		        {
		            return p_apply_1_ instanceof EntityGuardian && ((EntityGuardian)p_apply_1_).isNotColliding();
		        }
                }).iterator();
