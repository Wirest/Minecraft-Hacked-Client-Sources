...
public class DataWatcher {
   ...
   public static void writeWatchedListToPacketBuffer(List objectsList, PacketBuffer buffer) throws IOException {
      if (objectsList != null) {
         Iterator var3 = objectsList.iterator();

         while(var3.hasNext()) {
            DataWatcher.WatchableObject datawatcher$watchableobject = (DataWatcher.WatchableObject)var3.next();
   ...
   public List getAllWatched() {
      ...
      DataWatcher.WatchableObject datawatcher$watchableobject;
      for(Iterator var3 = this.watchedObjects.values().iterator(); var3.hasNext(); list.add(datawatcher$watchableobject)) {
         datawatcher$watchableobject = (DataWatcher.WatchableObject)var3.next();
         if (list == null) {
            list = Lists.newArrayList();
         }
      }
   ...
   public void updateWatchedObjectsFromList(List p_75687_1_) {
      this.lock.writeLock().lock();
      Iterator var3 = p_75687_1_.iterator();
