...
public class LayerDeadmau5Head implements LayerRenderer<AbstractClientPlayer> {
	...
	public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_,
		...
		// TODO Jigsaw deadmau5 - Robin146!! :D
		if ((Jigsaw.getIsMouseHead(entitylivingbaseIn.getName()) && !Jigsaw.ghostMode) && entitylivingbaseIn.hasSkin()
				&& !entitylivingbaseIn
						.isInvisible()/*
										 * entitylivingbaseIn.getName().equals(
										 * "deadmau5") &&
										 * entitylivingbaseIn.hasSkin() &&
