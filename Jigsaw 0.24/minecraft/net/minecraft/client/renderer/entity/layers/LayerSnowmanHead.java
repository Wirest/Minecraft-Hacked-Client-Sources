...
public class LayerSnowmanHead implements LayerRenderer<EntitySnowman> {
	...
	public void doRenderLayer(EntitySnowman entitylivingbaseIn, float p_177141_2_, float p_177141_3_,
		...
		if (!entitylivingbaseIn.isInvisible()) {
			...
			Minecraft.getMinecraft().getItemRenderer().renderItem(entitylivingbaseIn, new ItemStack(Blocks.pumpkin, 1),
