...
public abstract class CommandBase implements ICommand {
	...
	/**
	 * Attempts to retrieve an entity's name, first assuming that the entity is
	 * a player, and then exhausting all other possibilities.
	 */
	 ...
	 * 1) {} --> "", 2) {"Steve"} --> "Steve", 3) {"Steve", "Phil"} --> "Steve
	 * and Phil", 4) {"Steve", "Phil", "Mark"} --> "Steve, Phil and Mark"
	 */
