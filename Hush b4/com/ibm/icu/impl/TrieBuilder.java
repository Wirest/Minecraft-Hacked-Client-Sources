...
public class TrieBuilder
{
    ...
    public boolean isInZeroBlock(final int ch) {
        return this.m_isCompacted_ || ch > 1114111 || ch < 0 || this.m_index_[ch >> 5] == 0;
    }
    ...
    protected TrieBuilder(final TrieBuilder table) {
        this.m_index_ = new int[34816];
    ...
    protected static final boolean equal_int(final int[] array, int start1, int start2, int length) {
    ...
    protected static final int findSameIndexBlock(final int[] index, final int indexLength, final int otherBlock) {
