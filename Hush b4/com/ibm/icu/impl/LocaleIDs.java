...
public class LocaleIDs
{
    ...
    public static String[] getISOCountries() {
        return LocaleIDs._countries.clone();
    }
    
    public static String[] getISOLanguages() {
        return LocaleIDs._languages.clone();
    }
    
    public static String getISO3Country(final String country) {
        int offset = findIndex(LocaleIDs._countries, country);
        if (offset >= 0) {
            return LocaleIDs._countries3[offset];
        }
        offset = findIndex(LocaleIDs._obsoleteCountries, country);
        if (offset >= 0) {
            return LocaleIDs._obsoleteCountries3[offset];
        }
        return "";
    }
    
    public static String getISO3Language(final String language) {
        int offset = findIndex(LocaleIDs._languages, language);
        if (offset >= 0) {
            return LocaleIDs._languages3[offset];
        }
        offset = findIndex(LocaleIDs._obsoleteLanguages, language);
        if (offset >= 0) {
            return LocaleIDs._obsoleteLanguages3[offset];
        }
        return "";
    }
    
    public static String threeToTwoLetterLanguage(final String lang) {
        int offset = findIndex(LocaleIDs._languages3, lang);
        if (offset >= 0) {
            return LocaleIDs._languages[offset];
        }
        offset = findIndex(LocaleIDs._obsoleteLanguages3, lang);
        if (offset >= 0) {
            return LocaleIDs._obsoleteLanguages[offset];
        }
        return null;
    }
    
    public static String threeToTwoLetterRegion(final String region) {
        int offset = findIndex(LocaleIDs._countries3, region);
        if (offset >= 0) {
            return LocaleIDs._countries[offset];
        }
        offset = findIndex(LocaleIDs._obsoleteCountries3, region);
        if (offset >= 0) {
            return LocaleIDs._obsoleteCountries[offset];
        }
        return null;
    }
    
    private static int findIndex(final String[] array, final String target) {
    ...
    public static String getCurrentCountryID(final String oldID) {
        final int offset = findIndex(LocaleIDs._deprecatedCountries, oldID);
        if (offset >= 0) {
            return LocaleIDs._replacementCountries[offset];
        }
        return oldID;
    }
    
    public static String getCurrentLanguageID(final String oldID) {
        final int offset = findIndex(LocaleIDs._obsoleteLanguages, oldID);
        if (offset >= 0) {
            return LocaleIDs._replacementLanguages[offset];
        }
        return oldID;
    }
    ...
    static {
        ...
        _replacementLanguages = new String[] { "id", "he", "yi", "jv", "sr", "nb" };
        _obsoleteLanguages = new String[] { "in", "iw", "ji", "jw", "sh", "no" };
        ...
        _obsoleteLanguages3 = new String[] { "ind", "heb", "yid", "jaw", "srp" };
        ...
        _deprecatedCountries = new String[] { "AN", "BU", "CS", "DD", "DY", "FX", "HV", "NH", "RH", "SU", "TP", "UK", "VD", "YD", "YU", "ZR" };
        _replacementCountries = new String[] { "CW", "MM", "RS", "DE", "BJ", "FR", "BF", "VU", "ZW", "RU", "TL", "GB", "VN", "YE", "RS", "CD" };
        _obsoleteCountries = new String[] { "AN", "BU", "CS", "FX", "RO", "SU", "TP", "YD", "YU", "ZR" };
        ...
        _obsoleteCountries3 = new String[] { "ANT", "BUR", "SCG", "FXX", "ROM", "SUN", "TMP", "YMD", "YUG", "ZAR" };
    }
}
