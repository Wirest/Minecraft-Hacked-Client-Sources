...
public class S01PacketJoinGame implements Packet<INetHandlerPlayClient>
{
    ...
    public S01PacketJoinGame(final int entityIdIn, final WorldSettings.GameType gameTypeIn, final boolean hardcoreModeIn, final int dimensionIn, final EnumDifficulty difficultyIn, final int maxPlayersIn, final WorldType worldTypeIn, final boolean reducedDebugInfoIn) {
