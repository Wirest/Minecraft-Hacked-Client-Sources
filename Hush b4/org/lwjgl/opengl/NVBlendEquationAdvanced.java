...
public final class NVBlendEquationAdvanced
{
    ...
    public static void glBlendParameteriNV(final int pname, final int value) {
        final ContextCapabilities caps = GLContext.getCapabilities();
        final long function_pointer = caps.glBlendParameteriNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        nglBlendParameteriNV(pname, value, function_pointer);
    }
    
    static native void nglBlendParameteriNV(final int p0, final int p1, final long p2);
    
    public static void glBlendBarrierNV() {
        final ContextCapabilities caps = GLContext.getCapabilities();
        final long function_pointer = caps.glBlendBarrierNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        nglBlendBarrierNV(function_pointer);
    }
    
    static native void nglBlendBarrierNV(final long p0);
}
