...
extends Module {
    ...
    public void onMotion(EventMotion eventMotion) {
        ...
        this.mc.thePlayer.addPotionEffect(new PotionEffect(Potion.digSpeed.id, 840, 6));
    }

    public void onDisable() {
        this.mc.thePlayer.removePotionEffectClient(Potion.digSpeed.id);
        super.onDisable();
    }

    public FastBreak() {
        super("FastBreak", Category.World);
        this.setDescription("Permet de casser les blocks plus vite (Peut rollback)");
    }
}
