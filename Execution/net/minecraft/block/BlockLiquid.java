...
public abstract class BlockLiquid extends Block
{
    ...
    {
        if(Execution.instance.moduleManager.getModuleByName("Jesus").isEnabled && !Minecraft.getMinecraft().gameSettings.keyBindSneak.pressed){
            return AxisAlignedBB.fromBounds(pos.getX() + this.minX, pos.getY() + this.minY, pos.getZ() + this.minZ, pos.getX() + maxX, pos.getY() + maxY, pos.getZ() + maxZ);
        }
        return null;
    }
