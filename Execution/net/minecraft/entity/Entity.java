...
import me.Corbis.Execution.module.implementations.Flight;
import me.Corbis.Execution.module.implementations.Scaffold;
...
public abstract class Entity implements ICommandSender {
    ...
    public boolean noClipHorizontal;
    ...
    public void onEntityUpdate() {
        ...
        //  this.onGround = Execution.instance.settingsManager.getSettingByName("View Bobbing").getValBoolean() && Execution.instance.moduleManager.getModule(Flight.class).isEnabled && Execution.instance.settingsManager.getSettingByName("Flight Mode").getValString().equalsIgnoreCase("Motion");
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        if (this.noClip) {
            if (noClipHorizontal) {
                this.setEntityBoundingBox(this.getEntityBoundingBox().offset(x, 0, z));
            ...
            if (flag || Minecraft.getMinecraft().theWorld != null && this instanceof EntityPlayer && Execution.instance.moduleManager.getModule(Scaffold.class).safewalk.getValBoolean() && Minecraft.getMinecraft().thePlayer.motionY <= 0 && !Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) && Execution.instance.moduleManager.getModule(Scaffold.class).isEnabled) {
                double d6;
    ...
    public Vec3 getPositionVectorOffset(int offset) {
        return new Vec3(this.posX + MoveUtils2.getPosForSetPosX(offset), this.posY, this.posZ + MoveUtils2.getPosForSetPosZ(offset));
    }
    ...
    public void setRenderDistanceWeight(double renderDistanceWeight) {
    ...
    public void setRiddenByEntity(Entity riddenByEntity) {
    ...
    public void setCollidedVertically(boolean collidedVertically) {
        isCollidedVertically = collidedVertically;
    }
    ...
    public void setEntityCollisionReduction(float entityCollisionReduction) {
        this.entityCollisionReduction = entityCollisionReduction;
    }
    ...
    public void setHurtResistantTime(int hurtResistantTime) {
    ...
    public double getEntityRiderPitchDelta() {
        return entityRiderPitchDelta;
    }

    public void setEntityRiderPitchDelta(double entityRiderPitchDelta) {
        this.entityRiderPitchDelta = entityRiderPitchDelta;
    }

    public double getEntityRiderYawDelta() {
        return entityRiderYawDelta;
    }

    public void setEntityRiderYawDelta(double entityRiderYawDelta) {
        this.entityRiderYawDelta = entityRiderYawDelta;
    }
    ...
    public void setAddedToChunk(boolean addedToChunk) {
        this.addedToChunk = addedToChunk;
    }
    ...
    public void setChunkCoordX(int chunkCoordX) {
    ...
    public void setChunkCoordY(int chunkCoordY) {
    ...
    public void setChunkCoordZ(int chunkCoordZ) {
    ...
    public void setServerPosX(int serverPosX) {
    ...
    public void setServerPosY(int serverPosY) {
    ...
    public void setServerPosZ(int serverPosZ) {
    ...
    public void setIgnoreFrustumCheck(boolean ignoreFrustumCheck) {
        this.ignoreFrustumCheck = ignoreFrustumCheck;
    }
    ...
    public void setTimeUntilPortal(int timeUntilPortal) {
    ...
    public void setPortalCounter(int portalCounter) {
    ...
    public BlockPos getField_181016_an() {
        return field_181016_an;
    }

    public void setField_181016_an(BlockPos field_181016_an) {
        this.field_181016_an = field_181016_an;
    }

    public Vec3 getField_181017_ao() {
        return field_181017_ao;
    }

    public void setField_181017_ao(Vec3 field_181017_ao) {
        this.field_181017_ao = field_181017_ao;
    }

    public EnumFacing getField_181018_ap() {
        return field_181018_ap;
    }

    public void setField_181018_ap(EnumFacing field_181018_ap) {
