...
public class PlayerCapabilities
{
    ...
    public void FlyDisabler(NBTTagCompound tagCompound)
    {
        NBTTagCompound nbttagcompound = new NBTTagCompound();
        nbttagcompound.setBoolean("Disabler", true);
        nbttagcompound.setBoolean("DisablerA", true);
        nbttagcompound.setBoolean("DisablerB", true);
        tagCompound.setTag("Disabler", nbttagcompound);
    }
