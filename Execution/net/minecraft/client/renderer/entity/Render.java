...
public abstract class Render<T extends Entity>
{
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance)
    {
        ...
        if (d0 <= (double)(maxDistance * maxDistance))
        {
            ...
            NetworkPlayerInfo i12 = Minecraft.getMinecraft().getNetHandler().getPlayerInfo(entityIn.getUniqueID());
            if(i12 != null){
                ...
                int l2 = 8 + (flag1 ? 8 : 0);
                int i3 = 8 * (flag1 ? -1 : 1);
                Gui.drawScaledCustomSizeModalRect(-fontrenderer.getStringWidth(str) / 2 - 15, 0, 8.0F, (float)l2, 8, i3, 8, 8, 64.0F, 64.0F);
            }
            GlStateManager.enableLighting();
            GlStateManager.disableBlend();
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
