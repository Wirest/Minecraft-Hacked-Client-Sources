...
import me.Corbis.Execution.module.implementations.Chams;
import me.Corbis.Execution.module.implementations.FPSBoost;
import me.Corbis.Execution.utils.Palette;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            try
            {
                ...
                float f5 = Execution.instance.moduleManager.getModuleByName("FPSBoost").isEnabled && FPSBoost.clear ? 0 : entity.prevLimbSwingAmount + (entity.limbSwingAmount - entity.prevLimbSwingAmount) * partialTicks;
                float f6 = Execution.instance.moduleManager.getModuleByName("FPSBoost").isEnabled && FPSBoost.clear ? 0 : entity.limbSwing - entity.limbSwingAmount * (1.0F - partialTicks);
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (flag || flag1)
        {
            ...
            boolean flag2 = Execution.instance.moduleManager.getModule(Chams.class).isEnabled && Execution.instance.moduleManager.getModule(Chams.class).colored.getValBoolean() && entitylivingbaseIn instanceof EntityPlayer;

            Color chamsColor;
            if (flag2) {

                chamsColor = Palette.fade(Palette.PURPLE.getColor());
                GL11.glPushMatrix();
                GL11.glEnable(10754);
            ...
            if (flag2) {
                ...
                chamsColor = Palette.PURPLE.getColor();
                GL11.glColor4f((float)chamsColor.getRed() / 255.0F, (float)chamsColor.getGreen() / 255.0F, (float)chamsColor.getBlue() / 255.0F, (float)chamsColor.getAlpha() / 255.0F);
            ...
            if (this.canRenderName(entity))
            {
                ...
                if (d0 < (double)(f * f))
                {
                    ...
                    if (entity.isSneaking())
                    {
                        ...
                        NetworkPlayerInfo i12 = Minecraft.getMinecraft().getNetHandler().getPlayerInfo(entity.getUniqueID());
                        if(i12 != null){
                            Minecraft.getMinecraft().getTextureManager().bindTexture(i12.getLocationSkin());
                            GlStateManager.color(1,1,1,1);
                            boolean flag1 = false;

                            int l2 = 8 + (flag1 ? 8 : 0);
                            int i3 = 8 * (flag1 ? -1 : 1);
                            Gui.drawScaledCustomSizeModalRect(-fontrenderer.getStringWidth(s) / 2 - 15, 0, 8.0F, (float)l2, 8, i3, 8, 8, 64.0F, 64.0F);
                        }
                        GlStateManager.enableLighting();
                        GlStateManager.disableBlend();
                        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    protected boolean canRenderName(T entity)
    {
        ...
        if(Execution.instance.getModuleManager().getModuleByName("NameTags").isEnabled)
            return false;
