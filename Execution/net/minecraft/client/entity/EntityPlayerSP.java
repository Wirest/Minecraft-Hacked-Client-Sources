...
import me.Corbis.Execution.event.events.LastDistanceEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public int getPositionUpdateTicks() {
        return positionUpdateTicks;
    }

    public void setPositionUpdateTicks(int positionUpdateTicks) {
    ...
    public boolean isHasValidHealth() {
        return hasValidHealth;
    }

    public void setHasValidHealth(boolean hasValidHealth) {
        this.hasValidHealth = hasValidHealth;
    }
    ...
    public void setRenderArmYaw(float renderArmYaw) {
        this.renderArmYaw = renderArmYaw;
    }
    ...
    public void setRenderArmPitch(float renderArmPitch) {
        this.renderArmPitch = renderArmPitch;
    }
    ...
    public void setPrevRenderArmYaw(float prevRenderArmYaw) {
        this.prevRenderArmYaw = prevRenderArmYaw;
    }
    ...
    public void setPrevRenderArmPitch(float prevRenderArmPitch) {
        this.prevRenderArmPitch = prevRenderArmPitch;
    }
    ...
    public void setHorseJumpPowerCounter(int horseJumpPowerCounter) {
        this.horseJumpPowerCounter = horseJumpPowerCounter;
    }

    public void setHorseJumpPower(float horseJumpPower) {
        this.horseJumpPower = horseJumpPower;
    }
    ...
    public void setTimeInPortal(float timeInPortal) {
    ...
    public void setPrevTimeInPortal(float prevTimeInPortal) {
        this.prevTimeInPortal = prevTimeInPortal;
    }
    ...
    public void sendChatMessage(String message) {
        if(!Execution.instance.destroyed) {
            if (message.startsWith(".")) {
                Execution.instance.commandManager.call(message.substring(1));
                return;
            }
        }
    ...
    public Position getPositionAsPosition() {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding() && !Execution.instance.moduleManager.getModuleByName("NoSlowDown").isEnabled) {
