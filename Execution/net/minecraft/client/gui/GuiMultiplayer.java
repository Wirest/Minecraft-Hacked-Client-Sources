...
import me.Corbis.Execution.ui.AltManager.Colors;
import me.Corbis.Execution.ui.Buttons.GuiAnimatedButton;
import me.Corbis.Execution.ui.Buttons.GuiBlackAnimatedButton;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
        this.buttonList.add(this.btnEditServer = new GuiBlackAnimatedButton(7, 50, 20, 70, 20, I18n.format("selectServer.edit", new Object[0])));
        this.buttonList.add(this.btnDeleteServer = new GuiBlackAnimatedButton(2, 50, 60, 70, 20, I18n.format("selectServer.delete", new Object[0])));
        this.buttonList.add(this.btnSelectServer = new GuiBlackAnimatedButton(1, 40, 100, 100, 20, I18n.format("selectServer.select", new Object[0])));
        this.buttonList.add(new GuiBlackAnimatedButton(4, 35, 140, 100, 20, I18n.format("selectServer.direct", new Object[0])));
        this.buttonList.add(new GuiBlackAnimatedButton(3, 40, 180, 100, 20, I18n.format("selectServer.add", new Object[0])));
        this.buttonList.add(new GuiBlackAnimatedButton(8, 50, 220, 70, 20, I18n.format("selectServer.refresh", new Object[0])));
        this.buttonList.add(new GuiBlackAnimatedButton(0, 45, 260, 75, 20, I18n.format("gui.cancel", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(ufr == null){
            ufr = UnicodeFontRenderer.getFontFromAssets("Roboto-Light", 20, 0, 20,10);
        }

        ScaledResolution res = new ScaledResolution(mc);
        this.hoveringText = null;
        GlStateManager.color(1,1,1,1);
        mc.getTextureManager().bindTexture(new ResourceLocation("Execution/Alt.png"));
        Gui.drawModalRectWithCustomSizedTexture(0, 0, 0, 0, this.width, this.height, this.width, this.height);
        this.serverListSelector.drawScreen(mouseX, mouseY, partialTicks);
     //   ufr.drawCenteredString(I18n.format("multiplayer.title", new Object[0]), this.width / 2, 20, 0xFF000000);
     //   ufr.drawCenteredString(I18n.format("multiplayer.title", new Object[0]), this.width / 2, 20, 0xFF000000);
        super.drawScreen(mouseX, mouseY, partialTicks);

        if (this.hoveringText != null)
        {
            this.drawHoveringText(ufr,Lists.newArrayList(Splitter.on("\n").split(this.hoveringText)), mouseX, mouseY);
        }
        Gui.drawRect(0, 0, res.getScaledWidth(), res.getScaledHeight(), new Color(0, 0, 0, 50).getRGB());
