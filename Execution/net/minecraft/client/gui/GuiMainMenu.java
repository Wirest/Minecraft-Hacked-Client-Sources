...
import me.Corbis.Execution.Replay.GuiReplay;
import me.Corbis.Execution.Security.GuiSecurity;
import me.Corbis.Execution.ui.Buttons.GuiAnimatedButton;
import me.Corbis.Execution.ui.ShaderBackground.GLSLSandboxShader;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
     ...
     * 0
     * if(button.id == 500){
     * mc.displayGuiScreen(Execution.instance.guiAltLogin);
     * }
     * if (button.id == 0)
     * {
     ...
     */
    public void initGui() {
        ufr = UnicodeFontRenderer.getFontFromAssets("Roboto-Thin", 50, 0, 2, 2);
        ...
        this.buttonList.add(new GuiAnimatedButton(0, this.width / 2 - 100, j + 72 + 12, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiAnimatedButton(99, this.width / 2 + 2, j + 72 + 12, 98, 20, "Ban Checker"));
        this.buttonList.add(new GuiAnimatedButton(525, 0, 0, 98, 20, "Relog"));
        this.buttonList.add(new GuiAnimatedButton(245, 0, height - 30, "Replay Manager"));

        this.buttonList.add(new GuiAnimatedButton(4, this.width / 2 - 52, j + 72 + 12 + 25, 98, 20, I18n.format("menu.quit", new Object[0])));
        this.buttonList.add(new GuiButtonLanguage(5, -30, j + 72 + 12));
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        this.buttonList.add(new GuiAnimatedButton(1, this.width / 2 - 100, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new GuiAnimatedButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer", new Object[0])));
        this.buttonList.add(new GuiAnimatedButton(500, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("Alt Manager", new Object[0])));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if(button.id == 525){
            mc.displayGuiScreen(new GuiSecurity());
        }
        if(button.id == 245){
            mc.displayGuiScreen(new GuiReplay());
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        ufr.drawCenteredString(Execution.instance.name, sr.getScaledWidth() / 2, sr.getScaledHeight() / 4, 0xFFFFFFFF);
