...
import me.Corbis.Execution.event.events.EventRenderHotbar;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        {
            EventRenderScoreboard event = new EventRenderScoreboard(Event.State.PRE);
            event.call();
            this.renderScoreboard(scoreobjective1, scaledresolution);
            EventRenderScoreboard event1 = new EventRenderScoreboard(Event.State.POST);
            event1.call();
        }
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        ...
        {
            EventRenderHotbar eventRenderHotbarPre = new EventRenderHotbar(Event.State.PRE);
            eventRenderHotbarPre.call();
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            float f = this.zLevel;
            this.zLevel = -90.0F;
            float diff = (entityplayer.inventory.currentItem * 20) - lastTick;
            lastTick += diff / 4;
            ...
            GlStateManager.disableBlend();
            EventRenderHotbar eventRenderHotbarPost = new EventRenderHotbar(Event.State.POST);
            eventRenderHotbarPost.call();
        }
    }
