...
import me.Corbis.Execution.module.implementations.ChestAura;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public String progress = "Initializing Game";
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        Execution.instance.startClient();
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Launching Execution");
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException {
        ...
        getTextureManager().bindTexture(new ResourceLocation("Execution/Splash.png"));
    ...
    public void loadWorld(WorldClient worldClientIn) {
        ...
        Execution.instance.moduleManager.getModule(ChestAura.class).clicked.clear();
      //  Execution.instance.checkAuth();
