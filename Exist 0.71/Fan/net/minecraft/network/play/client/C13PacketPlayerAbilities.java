...
public class C13PacketPlayerAbilities implements Packet<INetHandlerPlayServer>
{
    ...
    public C13PacketPlayerAbilities(float flySpeed, float walkSpeed, boolean allowFlying, boolean isFlying, boolean creative, boolean disableDamage)
    {
        this.setInvulnerable(disableDamage);
        this.setFlying(isFlying);
        this.setAllowFlying(allowFlying);
        this.setCreativeMode(creative);
