    ...
    protected void collideWithNearbyEntities()
    {
        ...
        if (list != null && !list.isEmpty())
        {
            for (Entity value : list) {
                ...
                if ((Entity) value instanceof EntityMinecart && ((EntityMinecart) (Entity) value).getMinecartType() == EntityMinecart.EnumMinecartType.RIDEABLE && this.getDistanceSqToEntity((Entity) value) <= 0.2D) {
                    ((Entity) value).applyEntityCollision(this);
                }
            }
        }
    }
