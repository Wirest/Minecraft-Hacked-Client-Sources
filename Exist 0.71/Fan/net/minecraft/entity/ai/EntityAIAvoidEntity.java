...
public class EntityAIAvoidEntity<T extends Entity> extends EntityAIBase
{
    ...
    {
        this.canBeSeenSelector = p_apply_1_ -> Objects.requireNonNull(p_apply_1_).isEntityAlive() && EntityAIAvoidEntity.this.theEntity.getEntitySenses().canSee(p_apply_1_);
