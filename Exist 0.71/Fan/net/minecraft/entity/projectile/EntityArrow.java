    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            for (Entity value : list) {
                ...
                if (((Entity) value).canBeCollidedWith() && ((Entity) value != this.shootingEntity || this.ticksInAir >= 5)) {
                    float f1 = 0.3F;
                    AxisAlignedBB axisalignedbb1 = ((Entity) value).getEntityBoundingBox().expand((double) f1, (double) f1, (double) f1);
