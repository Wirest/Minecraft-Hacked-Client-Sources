    ...
    protected static boolean biomesEqualOrMesaPlateau(int biomeIDA, int biomeIDB)
    {
        ...
        else if (biomeIDA != BiomeGenBase.mesaPlateau_F.biomeID && biomeIDA != BiomeGenBase.mesaPlateau.biomeID)
        {
            ...
            catch (Throwable throwable)
            {
                ...
                crashreportcategory.addCrashSectionCallable("Biome A", () -> String.valueOf((Object)biomegenbase));
                crashreportcategory.addCrashSectionCallable("Biome B", () -> String.valueOf((Object)biomegenbase1));
