    ...
    private void func_143027_a(World worldIn)
    {
        if (this.structureData == null)
        {
            if (Reflector.ForgeWorld_getPerWorldStorage.exists())
            {
                ...
                this.structureData = (MapGenStructureData) Objects.requireNonNull(mapstorage).loadData(MapGenStructureData.class, this.getStructureName());
            }
            else
            {
            ...
            if (this.structureData == null)
            {
                ...
                if (Reflector.ForgeWorld_getPerWorldStorage.exists())
                {
                    ...
                    Objects.requireNonNull(mapstorage1).setData(this.getStructureName(), this.structureData);
                }
                else
                {
