...
public class WorldInfo
{
    ...
    public void addToCrashReport(CrashReportCategory category)
    {
        ...
        category.addCrashSectionCallable("Level generator", () -> String.format("ID %02d - %s, ver %d. Features enabled: %b", new Object[] {WorldInfo.this.terrainType.getWorldTypeID(), WorldInfo.this.terrainType.getWorldTypeName(), WorldInfo.this.terrainType.getGeneratorVersion(), WorldInfo.this.mapFeaturesEnabled}));
        category.addCrashSectionCallable("Level generator options", () -> WorldInfo.this.generatorOptions);
        category.addCrashSectionCallable("Level spawn location", () -> CrashReportCategory.getCoordinateInfo((double)WorldInfo.this.spawnX, (double)WorldInfo.this.spawnY, (double)WorldInfo.this.spawnZ));
        category.addCrashSectionCallable("Level time", () -> String.format("%d game time, %d day time", new Object[] {WorldInfo.this.totalTime, WorldInfo.this.worldTime}));
        ...
        category.addCrashSectionCallable("Level weather", () -> String.format("Rain time: %d (now: %b), thunder time: %d (now: %b)", new Object[] {WorldInfo.this.rainTime, WorldInfo.this.raining, WorldInfo.this.thunderTime, WorldInfo.this.thundering}));
        category.addCrashSectionCallable("Level game mode", () -> String.format("Game mode: %s (ID %d). Hardcore: %b. Cheats: %b", new Object[] {WorldInfo.this.theGameType.getName(), WorldInfo.this.theGameType.getID(), WorldInfo.this.hardcore, WorldInfo.this.allowCommands}));
    }
}
