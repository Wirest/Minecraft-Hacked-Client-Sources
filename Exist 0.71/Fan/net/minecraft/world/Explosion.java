...
public class Explosion
{
    ...
    public void doExplosionA()
    {
        ...
        for (Entity value : list) {
            ...
            if (!((Entity) value).isImmuneToExplosions()) {
                ...
                if (d12 <= 1.0D) {
                    ...
                    if (d13 != 0.0D) {
                        ...
                        d7 = d7 / d13;
                        d9 = d9 / d13;
                        double d14 = (double) this.worldObj.getBlockDensity(vec3, ((Entity) value).getEntityBoundingBox());
                        double d10 = (1.0D - d12) * d14;
                        ((Entity) value).attackEntityFrom(DamageSource.setExplosionSource(this), (float) ((int) ((d10 * d10 + d10) / 2.0D * 8.0D * (double) f3 + 1.0D)));
                        double d11 = EnchantmentProtection.func_92092_a((Entity) value, d10);
                        ((Entity) value).motionX += d5 * d11;
                        ((Entity) value).motionY += d7 * d11;
                        ((Entity) value).motionZ += d9 * d11;

                        if ((Entity) value instanceof EntityPlayer && !((EntityPlayer) (Entity) value).capabilities.disableDamage) {
                            this.playerKnockbackMap.put((EntityPlayer) (Entity) value, new Vec3(d5 * d10, d7 * d10, d9 * d10));
                        }
                    }
                }
            }
