...
public class EntityRenderer implements IResourceManagerReloadListener
{
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                catch (Throwable throwable)
                {
                    ...
                    crashreportcategory.addCrashSectionCallable("Mouse location", new Callable()
                    {
                        ...
                        {
                            return String.format("Scaled: (%d, %d). Absolute: (%d, %d)", new Object[] {j1, k1, Mouse.getX(), Mouse.getY()});
                        }
                    });
    ...
    public void renderStreamIndicator(float partialTicks)
    {
       // this.setupOverlayRendering();
        //his.mc.ingameGUI.renderStreamIndicator(new ScaledResolution(this.mc));
    }
        ...
        if (this.mc.theWorld != null)
        {
            ...
            if (i > this.lastErrorCheckTimeMs + 10000L)
            {
                ...
                if (j != 0)
                {
                    ...
                    ChatComponentText chatcomponenttext = new ChatComponentText(I18n.format("of.message.openglError", new Object[] {j, s}));
                    this.mc.ingameGUI.getChatGUI().printChatMessage(chatcomponenttext);
                }
            }
        }
