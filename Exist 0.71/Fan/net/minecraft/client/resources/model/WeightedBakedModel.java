...
public class WeightedBakedModel implements IBakedModel
{
    ...
    {
        return ((WeightedBakedModel.MyWeighedRandomItem) Objects.requireNonNull(WeightedRandom.getRandomItem(this.models, Math.abs((int) p_177564_1_ >> 16) % this.totalWeight))).model;
    }
