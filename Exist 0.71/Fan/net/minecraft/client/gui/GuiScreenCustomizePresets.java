...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_175317_i = new GuiTextField(2, FontUtil.clean, 50, 40, this.width - 100, 20);
    ...
    class ListPreset extends GuiSlot
    {
        ...
        private void func_178051_a(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_)
        {
            ...
            worldrenderer.pos((double)(i), (double)(p_178051_2_ + 32), 0.0D).tex(0.0D, 1.0D).endVertex();
            worldrenderer.pos((double)(i + 32), (double)(p_178051_2_ + 32), 0.0D).tex(1.0D, 1.0D).endVertex();
            worldrenderer.pos((double)(i + 32), (double)(p_178051_2_), 0.0D).tex(1.0D, 0.0D).endVertex();
            worldrenderer.pos((double)(i), (double)(p_178051_2_), 0.0D).tex(0.0D, 0.0D).endVertex();
            tessellator.draw();
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            FontUtil.clean.drawString(guiscreencustomizepresets$info.field_178955_a, p_180791_2_ + 32 + 10, p_180791_3_ + 14, 16777215);
        }
    }
}
