...
public class GuiScreenBook extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.bookGettingSigned)
        {
            ...
            int k = (int) FontUtil.cleanmedium.getStringWidth(s1);
            FontUtil.cleanmedium.drawString(s1, i + 36 + (116 - k) / 2, j + 16 + 16, 0);
            int l = (int) FontUtil.cleanmedium.getStringWidth(s);
            FontUtil.cleanmedium.drawString(s, i + 36 + (116 - l) / 2, j + 48, 0);
            String s2 = I18n.format("book.byAuthor", new Object[] {this.editingPlayer.getName()});
            int i1 = (int) FontUtil.cleanmedium.getStringWidth(s2);
            FontUtil.cleanmedium.drawString(EnumChatFormatting.DARK_GRAY + s2, i + 36 + (116 - i1) / 2, j + 48 + 10, 0);
        ...
        else
        {
            ...
            int j1 = (int) FontUtil.cleanmedium.getStringWidth(s4);
            FontUtil.cleanmedium.drawString(s4, i - j1 + this.bookImageWidth - 44, j + 16, 0);
            ...
            {
                int k1 = Math.min(128 / FontUtil.cleanmedium.getHeight(), this.field_175386_A.size());

                for (int l1 = 0; l1 < k1; ++l1)
                {
                    IChatComponent ichatcomponent2 = (IChatComponent)this.field_175386_A.get(l1);
                    FontUtil.cleanmedium.drawString(ichatcomponent2.getUnformattedText(), i + 36, j + 16 + 16 + l1 * FontUtil.cleanmedium.getHeight(), 0);
                }
    ...
    public IChatComponent func_175385_b(int p_175385_1_, int p_175385_2_)
    {
        ...
        else
        {
            ...
            if (i >= 0 && j >= 0)
            {
                int k = Math.min(128 / FontUtil.cleanmedium.getHeight(), this.field_175386_A.size());

                if (i <= 116 && j < FontUtil.cleanmedium.getHeight() * k + k)
                {
                    int l = j / FontUtil.cleanmedium.getHeight();
