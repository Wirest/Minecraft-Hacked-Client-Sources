...
public class GuiEnchantment extends GuiContainer
{
    ...
    {
        FontUtil.cleanmedium.drawString(this.field_175380_I.getDisplayName().getUnformattedText(), 12, 5, 4210752);
        FontUtil.cleanmedium.drawString(this.playerInventory.getDisplayName().getUnformattedText(), 8, this.ySize - 96 + 2, 4210752);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int j = 0; j < 3; ++j)
        {
            ...
            if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0 && l >= 0)
            {
                ...
                {
                    String s = Objects.requireNonNull(Enchantment.getEnchantmentById(l & 255)).getTranslatedName((l & 65280) >> 8);
