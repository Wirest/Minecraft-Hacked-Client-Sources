...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawString(this.field_146391_r, i + 2 + 213 - (int) FontUtil.cleanmedium.getStringWidth(this.field_146391_r), 32, 16777215);
    ...
    class Details extends GuiSlot
    {
        ...
        private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_)
        {
            ...
            worldrenderer.pos((double)(p_148224_1_), (double)(p_148224_2_ + 18), (double)GuiCreateFlatWorld.this.zLevel).tex((double)((float)(p_148224_3_) * 0.0078125F), (double)((float)(p_148224_4_ + 18) * 0.0078125F)).endVertex();
            ...
            worldrenderer.pos((double)(p_148224_1_ + 18), (double)(p_148224_2_), (double)GuiCreateFlatWorld.this.zLevel).tex((double)((float)(p_148224_3_ + 18) * 0.0078125F), (double)((float)(p_148224_4_) * 0.0078125F)).endVertex();
            worldrenderer.pos((double)(p_148224_1_), (double)(p_148224_2_), (double)GuiCreateFlatWorld.this.zLevel).tex((double)((float)(p_148224_3_) * 0.0078125F), (double)((float)(p_148224_4_) * 0.0078125F)).endVertex();
            tessellator.draw();
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            FontUtil.cleanmedium.drawString(s, p_180791_2_ + 18 + 5, p_180791_3_ + 3, 16777215);
            String s1;
            ...
            FontUtil.cleanmedium.drawString(s1, p_180791_2_ + 2 + 213 - FontUtil.cleanmedium.getStringWidth(s1), p_180791_3_ + 3, 16777215);
        }
