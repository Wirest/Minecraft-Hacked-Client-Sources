...
public class PlayerControllerMP
{
        ...
        else
        {
            ...
            if (!flag && this.currentGameType != WorldSettings.GameType.SPECTATOR)
            {
                ...
                else
                {
                    ...
                    return !event.isCancelled() && heldStack.onItemUse(player, worldIn, hitPos, side, f, f1, f2);
                }
            }
            else
            {
    ...
    {
    	//mc.thePlayer.addChatMessage(new ChatComponentText(slotId+""));
    	//Logger.ingameInfo(slotId + " "+ mouseButtonClicked + " "+ mode);
        //Client Code:
