...
public class CommandSpreadPlayers extends CommandBase
{
    ...
    private double func_110671_a(List<Entity> p_110671_1_, World worldIn, CommandSpreadPlayers.Position[] p_110671_3_, boolean p_110671_4_)
    {
        ...
        for (Entity value : p_110671_1_) {
            ...
            if (p_110671_4_) {
                Team team = (Entity) value instanceof EntityPlayer ? ((EntityPlayer) (Entity) value).getTeam() : null;
            ...
            ((Entity) value).setPositionAndUpdate((double) ((float) MathHelper.floor_double(commandspreadplayers$position.field_111101_a) + 0.5F), (double) commandspreadplayers$position.func_111092_a(worldIn), (double) MathHelper.floor_double(commandspreadplayers$position.field_111100_b) + 0.5D);
