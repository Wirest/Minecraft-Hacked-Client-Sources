...
public class PlayerSelector
{
        ...
        if (map.size() > 0)
        {
            list.add(p_apply_1_ -> {
                ...
                for (Entry<String, Integer> entry : map.entrySet())
                {
                    ...
                    String s1 = p_apply_1_ instanceof EntityPlayerMP ? p_apply_1_.getName() : Objects.requireNonNull(p_apply_1_).getUniqueID().toString();
    ...
    private static List<Predicate<Entity>> func_179647_f(Map<String, String> p_179647_0_)
    {
        ...
        {
            final String s_f = s;
            list.add(p_apply_1_ -> Objects.requireNonNull(p_apply_1_).getName().equals(s_f) != flag);
        }
    ...
    private static List<Predicate<Entity>> func_180698_a(Map<String, String> p_180698_0_, final BlockPos p_180698_1_)
    {
        ...
        if (p_180698_1_ != null && (i >= 0 || j >= 0))
        {
            ...
            final int l = j * j;
            list.add(p_apply_1_ -> {
                int i1 = (int) Objects.requireNonNull(p_apply_1_).getDistanceSqToCenter(p_180698_1_);
    ...
    private static List<Predicate<Entity>> func_179662_g(Map<String, String> p_179662_0_)
    {
        ...
        if (p_179662_0_.containsKey("rym") || p_179662_0_.containsKey("ry"))
        {
            ...
            list.add(p_apply_1_ -> {
                int i1 = PlayerSelector.func_179650_a((int)Math.floor((double) Objects.requireNonNull(p_apply_1_).rotationYaw));
        ...
        if (p_179662_0_.containsKey("rxm") || p_179662_0_.containsKey("rx"))
        {
            ...
            list.add(p_apply_1_ -> {
                int i1 = PlayerSelector.func_179650_a((int)Math.floor((double) Objects.requireNonNull(p_apply_1_).rotationPitch));
    ...
    private static <T extends Entity> List<T> filterResults(Map<String, String> params, Class <? extends T > entityClass, List<Predicate<Entity>> inputList, String type, World worldIn, BlockPos position)
    {
        ...
        if (position != null)
        {
            ...
            else
            {
                ...
                if (flag && flag2 && !flag1)
                {
                    Predicate<Entity> predicate2 = p_apply_1_ -> Objects.requireNonNull(p_apply_1_).posX >= axisalignedbb.minX && p_apply_1_.posY >= axisalignedbb.minY && p_apply_1_.posZ >= axisalignedbb.minZ && p_apply_1_.posX < axisalignedbb.maxX && p_apply_1_.posY < axisalignedbb.maxY && p_apply_1_.posZ < axisalignedbb.maxZ;
    ...
    private static <T extends Entity> List func_179658_a(List<T> p_179658_0_, Map<String, String> p_179658_1_, ICommandSender p_179658_2_, Class <? extends T > p_179658_3_, String p_179658_4_, final BlockPos p_179658_5_)
    {
        ...
        {
            ((List<T>) p_179658_0_).sort((Comparator<Entity>) (p_compare_1_, p_compare_2_) -> ComparisonChain.start().compare(p_compare_1_.getDistanceSq(p_179658_5_), p_compare_2_.getDistanceSq(p_179658_5_)).result());
        }
