...
public class Fan {
    ...
    @Setter
    String name = "Fan Client", version = "v3.1";
    public static @Getter
    @Setter
    ...
    public static void onEvent(Event e) {
        ...
        if (Disabler.bypasses && ServerIntegrity.isGeniuneHypixel() && mc.thePlayer != null)
            disabler.onEvent(e);
    ...
    public static void startup() {
      ...
      /*  try {
            ...
            while (i < sha1hash.length) {
                ...
                do {
                    if (halfbyte >= 0 && halfbyte <= 9) {
                        buf += ((char) (48 + halfbyte));
                    } else {
                        buf += ((char) (97 + (halfbyte - 10)));
                    }
        ...
        SplashScreen.setProgress(1, 2, "Starting " + fullname);
