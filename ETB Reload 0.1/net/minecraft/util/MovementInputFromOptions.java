...
import com.etb.client.module.modules.player.InventoryPlus;
...
public class MovementInputFromOptions extends MovementInput
{
    ...
    {
        if ((Client.INSTANCE.getModuleManager().getModuleClass(InventoryPlus.class).isEnabled()) && (!(Minecraft.getMinecraft().currentScreen instanceof GuiChat)))
        {
