...
public class GuiChest extends GuiContainer
{
    ...
    public static IInventory lowerChestInventory;
    ...
    public GuiChest(IInventory p_i46315_1_, IInventory p_i46315_2_)
    {
        ...
        GuiChest.lowerChestInventory = p_i46315_2_;
    ...
    {
        this.fontRendererObj.drawString(GuiChest.lowerChestInventory.getDisplayName().getUnformattedText(), 8, 6, 4210752);
    ...
    public IInventory getLowerChestInventory() {
        return GuiChest.lowerChestInventory;
    }
