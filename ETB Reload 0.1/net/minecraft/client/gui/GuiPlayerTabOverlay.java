...
public class GuiPlayerTabOverlay extends Gui {
    ...
    public static List getPlayerList() {
        return GuiPlayerTabOverlay.field_175252_a.sortedCopy(Minecraft.getMinecraft().getNetHandler().getPlayerInfoMap());
    }
    ...
    private void drawScoreboardValues(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_,
        ...
        if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            ...
            int k = Math.max(MathHelper.ceiling_float_int(i / 2),
                    Math.max(MathHelper.ceiling_float_int(p_175247_6_.func_178860_m() / 2), 10));
            boolean flag = p_175247_6_.func_178858_o() > this.guiIngame.getUpdateCounter()
            ...
            if (j > 0) {
                ...
                if (f > 3.0F) {
                    for (int l = j; l < k; ++l) {
                        this.drawTexturedModalRect(p_175247_4_ + l * f, p_175247_2_,
                                flag ? 25 : 16, 0, 9, 9);
                    }

                    for (int j1 = 0; j1 < j; ++j1) {
                        this.drawTexturedModalRect(p_175247_4_ + j1 * f, p_175247_2_,
                                flag ? 25 : 16, 0, 9, 9);
                    ...
                    this.mc.fontRendererObj.drawStringWithShadow(s,
                            (p_175247_5_ + p_175247_4_) / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2,
                            p_175247_2_, i1);
                }
            }
        } else {
            ...
            this.mc.fontRendererObj.drawStringWithShadow(s1,
                    p_175247_5_ - this.mc.fontRendererObj.getStringWidth(s1), p_175247_2_, 16777215);
        }
    }
