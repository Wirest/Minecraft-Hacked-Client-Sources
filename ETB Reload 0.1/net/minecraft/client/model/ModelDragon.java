...
public class ModelDragon extends ModelBase
{
	...
	public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        for (int i = 0; i < 5; ++i)
        {
            ...
            this.spine.rotateAngleZ = -this.updateRotations(adouble1[0] - f7) * (float)Math.PI / 180.0F * f5;
        ...
        this.head.rotateAngleZ = -this.updateRotations(adouble2[0] - f7) * (float)Math.PI / 180.0F * 1.0F;
        ...
        for (int k = 0; k < 12; ++k)
        {
            ...
            this.spine.rotateAngleZ = this.updateRotations(adouble2[0] - f7) * (float)Math.PI / 180.0F * f5;
            this.spine.rotationPointY = f2;
            this.spine.rotationPointZ = f3;
            this.spine.rotationPointX = f4;
            f2 = (float)(f2 + Math.sin(this.spine.rotateAngleX) * 10.0D);
