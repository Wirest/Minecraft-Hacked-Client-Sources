...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    public void renderItemIntoGUIWithoutGlint(ItemStack p_175042_1_, float p_175042_2_, float p_175042_3_) {
        ...
        this.setupGuiTransform(p_175042_2_, p_175042_3_, var4.isAmbientOcclusion());
        this.func_175034_a(var4.getItemCameraTransforms().gui);
    ...
    public static void applyVanillaTransform(ItemTransformVec3f p_175034_1_) {
        if (p_175034_1_ != ItemTransformVec3f.DEFAULT) {
            GlStateManager.translate(p_175034_1_.translation.x + field_175055_b,
                    p_175034_1_.translation.y + field_175056_c, p_175034_1_.translation.z + field_175053_d);
            ...
            GlStateManager.scale(p_175034_1_.scale.x + field_175061_h,
                    p_175034_1_.scale.y + field_175062_i, p_175034_1_.scale.z + field_175060_j);
        }
    }
    ...
    public void renderItemAboveHead(final ItemStack stack, float xPosition, float yPosition) {
        if (stack != null) {
            try {
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, float xPosition, float yPosition, String text) {
        if (stack != null) {
            if (stack.stackSize != 1 || text != null) {
                ...
                GlStateManager.disableBlend();
                fr.drawStringWithShadow(s, xPosition + 19 - 2 - fr.getStringWidth(s),
                        yPosition + 6 + 3, 16777215);
                GlStateManager.enableLighting();
            ...
            if (stack.isItemDamaged()) {
                int j = (int) Math
                        .round(13.0D - stack.getItemDamage() * 13.0D / stack.getMaxDamage());
                int i = (int) Math
                        .round(255.0D - stack.getItemDamage() * 255.0D / stack.getMaxDamage());
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
    ...
    private void func_181565_a(WorldRenderer p_181565_1_, float p_181565_2_, float p_181565_3_, int p_181565_4_,
        ...
        p_181565_1_.pos(p_181565_2_ + 0, p_181565_3_ + 0, 0.0D)
                .color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        p_181565_1_.pos(p_181565_2_ + 0, p_181565_3_ + p_181565_5_, 0.0D)
                .color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        p_181565_1_.pos(p_181565_2_ + p_181565_4_, p_181565_3_ + p_181565_5_, 0.0D)
                .color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        p_181565_1_.pos(p_181565_2_ + p_181565_4_, p_181565_3_ + 0, 0.0D)
                .color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
