...
import com.etb.client.module.modules.render.Chams;
import com.etb.client.module.modules.render.OutlineESP;
...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float p_78440_1_) {
        ...
        if (this.itemToRender != null) {
            final boolean fakeautoblock =(Client.INSTANCE.getModuleManager().getModule("killaura")).isEnabled() && ((KillAura) Client.INSTANCE.getModuleManager().getModule("killaura")).isFakeAutoBlocking();
