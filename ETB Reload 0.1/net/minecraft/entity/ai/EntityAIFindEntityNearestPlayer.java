        ...
        this.field_179435_c = new Predicate<Entity>()
        {
			...
			public boolean apply(Entity p_apply_1_)
            {
                ...
                else
                {
                    ...
                    return p_apply_1_.getDistanceToEntity(EntityAIFindEntityNearestPlayer.this.field_179434_b) > d0 ? false : EntityAITarget.isSuitableTarget(EntityAIFindEntityNearestPlayer.this.field_179434_b, (EntityLivingBase)p_apply_1_, false, true);
                }
            }
        };
