...
public class EntityRabbit extends EntityAnimal
{
    ...
    static class AIRaidFarm extends EntityAIMoveToBlock
    {
        ...
        {
            super.updateTask();
            this.field_179500_c.getLookHelper().setLookPosition(this.destinationBlock.getX() + 0.5D, this.destinationBlock.getY() + 1, this.destinationBlock.getZ() + 0.5D, 10.0F, this.field_179500_c.getVerticalFaceSpeed());
            ...
            if (this.getIsAboveDestination())
            {
                ...
                if (this.field_179499_e && block instanceof BlockCarrot && iblockstate.getValue(BlockCrops.AGE).intValue() == 7)
                {
		...
		protected boolean shouldMoveTo(World worldIn, BlockPos pos)
        {
            ...
            if (block == Blocks.farmland)
            {
                ...
                if (block instanceof BlockCarrot && iblockstate.getValue(BlockCrops.AGE).intValue() == 7 && this.field_179498_d && !this.field_179499_e)
                {
