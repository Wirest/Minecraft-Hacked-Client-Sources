...
public class BlockRedstoneWire extends Block
{
    ...
    private boolean func_176339_d(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
        ...
        return !flag1 && flag && canConnectUpwardsTo(worldIn, blockpos.up()) ? true : (canConnectTo(iblockstate, side) ? true : (block == Blocks.powered_repeater && iblockstate.getValue(BlockDirectional.FACING) == side ? true : !flag && canConnectUpwardsTo(worldIn, blockpos.down())));
    }
