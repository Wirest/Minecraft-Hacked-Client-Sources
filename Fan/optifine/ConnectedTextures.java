...
public class ConnectedTextures
{
    ...
    public static void updateIcons(TextureMap p_updateIcons_0_, IResourcePack p_updateIcons_1_)
    {
        ...
        for (String s : astring) {
            ...
            if (count == 36) {
                Logger.consoleLogInfo("ConnectedTextures: loaded successfully!");
            }

            // Dont list out all of the connectedtexture json files
        ...
        if (count != 36) {
            Logger.consoleLogError("ConnectedTextures: failed to load!!!");
        }
    ...
    private static boolean detectMultipass()
    {
        ...
        ConnectedProperties[] aconnectedproperties1 = (ConnectedProperties[])((ConnectedProperties[])list.toArray(new ConnectedProperties[0]));
    ...
    private static void addToTileList(ConnectedProperties p_addToTileList_0_, List p_addToTileList_1_)
    {
        if (p_addToTileList_0_.matchTileIcons != null)
        {
            for (int i = 0; i < p_addToTileList_0_.matchTileIcons.length; ++i)
            {
                ...
                {
                    Config.warn("TextureAtlasSprite is not TextureAtlasSprite: " + null + ", name: " + Objects.requireNonNull(textureatlassprite).getIconName());
                }
                else
                {
