...
public class CustomColors
{
    ...
    private static CustomColormap[] readCustomColormaps(Properties p_readCustomColormaps_0_, String p_readCustomColormaps_1_)
    {
        ...
        String[] astring = (String[])((String[])map.keySet().toArray(new String[0]));
        ...
        {
            return (CustomColormap[])((CustomColormap[])list.toArray(new CustomColormap[0]));
        }
    }
    ...
    private static CustomColormap[][] blockListToArray(List p_blockListToArray_0_)
    {
        ...
        for (int i = 0; i < p_blockListToArray_0_.size(); ++i)
        {
            ...
            if (list != null)
            {
                CustomColormap[] acustomcolormap1 = (CustomColormap[])((CustomColormap[])list.toArray(new CustomColormap[0]));
    ...
    {
        for (String value : p_getCustomColors_1_) {
            String s = value;
