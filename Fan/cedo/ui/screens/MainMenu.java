...
public class MainMenu extends GuiScreen { //TODO: make Fan Client banner hover around
    ...
    public void initGui() {
        ...
        changelog.clear();
        changelog.add(new Change(ChangeType.UPDATE, "Added X and Y sliders for Sword Position"));
        changelog.add(new Change(ChangeType.UPDATE, "Added X and Y sliders for TargetHUD"));
        changelog.add(new Change(ChangeType.UPDATE, "Added ticks settings for Criticals"));
        changelog.add(new Change(ChangeType.UPDATE, "Added Scoreboard Setting"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        float longestString = (float) FontUtil.cleanSmall.getStringWidth("Developed by Cedo, JosephWorks, and Foggy") + 4;
        ...
        FontUtil.cleanSmall.drawString("Developed by Cedo, JosephWorks, and Foggy", 4, height - (18 + FontUtil.cleanSmall.getHeight()), Color.white.getRGB());
