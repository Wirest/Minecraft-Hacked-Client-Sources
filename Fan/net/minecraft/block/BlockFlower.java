...
public abstract class BlockFlower extends BlockBush
{
    ...
    public IProperty<BlockFlower.EnumFlowerType> getTypeProperty()
    {
        if (this.type == null)
        {
            this.type = PropertyEnum.<BlockFlower.EnumFlowerType>create("type", BlockFlower.EnumFlowerType.class, p_apply_1_ -> Objects.requireNonNull(p_apply_1_).getBlockType() == BlockFlower.this.getBlockType());
        }
    ...
    public enum EnumFlowerType implements IStringSerializable
    {
        ...
        static {
            ...
            {
                Collection<BlockFlower.EnumFlowerType> collection = Collections2.<BlockFlower.EnumFlowerType>filter(Lists.newArrayList(values()), p_apply_1_ -> Objects.requireNonNull(p_apply_1_).getBlockType() == blockflower$enumflowercolor);
                TYPES_FOR_BLOCK[blockflower$enumflowercolor.ordinal()] = (BlockFlower.EnumFlowerType[])collection.toArray(new EnumFlowerType[0]);
            }
        }
    }
}
