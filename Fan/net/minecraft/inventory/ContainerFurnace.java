    ...
    public void detectAndSendChanges()
    {
        ...
        for (ICrafting crafter : this.crafters) {
            ...
            if (this.field_178152_f != this.tileFurnace.getField(2)) {
                ((ICrafting) crafter).sendProgressBarUpdate(this, 2, this.tileFurnace.getField(2));
            }

            if (this.field_178154_h != this.tileFurnace.getField(0)) {
                ((ICrafting) crafter).sendProgressBarUpdate(this, 0, this.tileFurnace.getField(0));
            }

            if (this.field_178155_i != this.tileFurnace.getField(1)) {
                ((ICrafting) crafter).sendProgressBarUpdate(this, 1, this.tileFurnace.getField(1));
            }

            if (this.field_178153_g != this.tileFurnace.getField(3)) {
                ((ICrafting) crafter).sendProgressBarUpdate(this, 3, this.tileFurnace.getField(3));
            }
        }
