...
public class ContainerEnchantment extends Container
{
    ...
    public void detectAndSendChanges()
    {
        ...
        for (ICrafting crafter : this.crafters) {
            ((ICrafting) crafter).sendProgressBarUpdate(this, 0, this.enchantLevels[0]);
            ((ICrafting) crafter).sendProgressBarUpdate(this, 1, this.enchantLevels[1]);
            ((ICrafting) crafter).sendProgressBarUpdate(this, 2, this.enchantLevels[2]);
            ((ICrafting) crafter).sendProgressBarUpdate(this, 3, this.xpSeed & -16);
            ((ICrafting) crafter).sendProgressBarUpdate(this, 4, this.field_178151_h[0]);
            ((ICrafting) crafter).sendProgressBarUpdate(this, 5, this.field_178151_h[1]);
            ((ICrafting) crafter).sendProgressBarUpdate(this, 6, this.field_178151_h[2]);
        }
    }
            ...
            if (!this.worldPointer.isRemote)
            {
                ...
                if (list != null)
                {
                    ...
                    for (EnchantmentData enchantmentData : list) {
                        ...
                        if (flag) {
                            Items.enchanted_book.addEnchantment(itemstack, (EnchantmentData) enchantmentData);
                        } else {
                            itemstack.addEnchantment(((EnchantmentData) enchantmentData).enchantmentobj, ((EnchantmentData) enchantmentData).enchantmentLevel);
                        }
                    }

                    if (!playerIn.capabilities.isCreativeMode)
                    {
                        Objects.requireNonNull(itemstack1).stackSize -= i;
