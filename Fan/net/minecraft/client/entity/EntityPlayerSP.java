...
public class EntityPlayerSP extends AbstractClientPlayer
{
	...
	public boolean isEntityInsideOpaqueBlock() {
		EventRenderBlockInsides event = new EventRenderBlockInsides();
		Fan.onEvent(event);
		return event.isCancelled() ? false : super.isEntityInsideOpaqueBlock();
	}
    
    protected boolean pushOutOfBlocks(double x, double y, double z)
    {
    	EventBlockPush event = new EventBlockPush();
    	Fan.onEvent(event);
    ...
    {
        boolean flag = this.movementInput != null ? (!Fan.getModule(Scaffold.class).isToggled())  && this.movementInput.sneak : false;
