...
public class MapItemRenderer
{
    ...
    class Instance
    {
        ...
        private void render(boolean noOverlayRendering)
        {
            ...
            worldrenderer.pos((double)((float)(i) + f), (double)((float)(j + 128) - f), -0.009999999776482582D).tex(0.0D, 1.0D).endVertex();
            worldrenderer.pos((double)((float)(i + 128) - f), (double)((float)(j + 128) - f), -0.009999999776482582D).tex(1.0D, 1.0D).endVertex();
            worldrenderer.pos((double)((float)(i + 128) - f), (double)((float)(j) + f), -0.009999999776482582D).tex(1.0D, 0.0D).endVertex();
            worldrenderer.pos((double)((float)(i) + f), (double)((float)(j) + f), -0.009999999776482582D).tex(0.0D, 0.0D).endVertex();
            tessellator.draw();
