...
public class GuiTextField extends Gui
{
    ...
    public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_)
    {
        ...
        if (this.isFocused && flag && p_146192_3_ == 0)
        {
            ...
            String s = FontUtil.cleanmedium.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
            this.setCursorPosition(FontUtil.cleanmedium.trimStringToWidth(s, i).length() + this.lineScrollOffset);
        }
    }
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            int i1 = ((this.enableBackgroundDrawing ? this.yPosition + (this.height - 8) / 4 : this.yPosition) + 3) - 3;
            int j1 = l;
            ...
            if (s.length() > 0)
            {
                ...
                j1 = FontUtil.cleanmedium.drawStringWithShadow(s1, (float)l, (float)i1, i);
            }
            ...
            {
                j1 = FontUtil.cleanmedium.drawStringWithShadow(s.substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (flag1)
            {
                if (flag2)
                {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + FontUtil.cleanmedium.getHeight(), -3092272);
                }
                else
                {
                    FontUtil.cleanmedium.drawStringWithShadow("_", (float)k1, (float)i1, i);
                }
            }

            if (k != j)
            {
                int l1 = (int) (l + FontUtil.cleanmedium.getStringWidth(s.substring(0, k)));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + FontUtil.cleanmedium.getHeight());
            }
        }
    }
    ...
    public void setSelectionPos(int p_146199_1_)
    {
        ...
        if (FontUtil.cleanmedium != null)
        {
            ...
            int j = this.getWidth();
            String s = FontUtil.cleanmedium.trimStringToWidth(this.text.substring(this.lineScrollOffset), j);
            int k = s.length() + this.lineScrollOffset;

            if (p_146199_1_ == this.lineScrollOffset)
            {
                this.lineScrollOffset -= FontUtil.cleanmedium.trimStringToWidth(this.text, j, true).length();
            }
