...
public class GuiScreenHorseInventory extends GuiContainer
{
    ...
    {
        FontUtil.clean.drawString(this.horseInventory.getDisplayName().getUnformattedText(), 8, 6, 4210752);
        FontUtil.clean.drawString(this.playerInventory.getDisplayName().getUnformattedText(), 8, this.ySize - 96 + 2, 4210752);
    }
