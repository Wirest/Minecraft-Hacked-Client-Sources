...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    public void initGui()
    {
        if (this.mc.playerController.isInCreativeMode())
        {
            ...
            this.searchField = new GuiTextField(0, FontUtil.cleanmedium, this.guiLeft + 82, this.guiTop + 6, 89, FontUtil.cleanmedium.getHeight());
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        if (creativetabs.drawInForegroundOfTab())
        {
            ...
            FontUtil.cleanmedium.drawString(I18n.format(creativetabs.getTranslatedTabLabel(), new Object[0]), 8, 6, 4210752);
        }
    }
        ...
        if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex())
        {
            ...
            if (creativetabs == null && stack.getItem() == Items.enchanted_book)
            {
                ...
                if (map.size() == 1)
                {
                    ...
                    {
                        if (creativetabs1.hasRelevantEnchantmentType(Objects.requireNonNull(enchantment).type))
                        {
