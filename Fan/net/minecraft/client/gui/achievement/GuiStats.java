...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        if (this.doesGuiPauseGame)
        {
            ...
            this.drawCenteredString(I18n.format("multiplayer.downloadingStats", new Object[0]), this.width / 2, this.height / 2, 16777215);
            this.drawCenteredString(lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % (long)lanSearchStates.length)], this.width / 2, this.height / 2 + FontUtil.clean.getHeight() * 2, 16777215);
        }
        else
        {
    ...
    abstract class Stats extends GuiSlot
    {
        ...
        protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_)
        {
            if (p_148209_1_ != null)
            {
                ...
                GuiStats.this.drawString(s, (int) (p_148209_2_ - FontUtil.clean.getStringWidth(s)), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
            }
            else
            {
                String s1 = "-";
                GuiStats.this.drawString(s1, (int) (p_148209_2_ - FontUtil.clean.getStringWidth(s1)), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
            }
        }
            ...
            if (p_148142_2_ >= this.top && p_148142_2_ <= this.bottom)
            {
                ...
                else
                {
                    ...
                    if (s.length() > 0)
                    {
                        ...
                        int i1 = (int) FontUtil.clean.getStringWidth(s);
                        GuiStats.this.drawGradientRect(k - 3, l - 3, k + i1 + 3, l + 8 + 3, -1073741824, -1073741824);
                        FontUtil.clean.drawStringWithShadow(s, (float)k, (float)l, -1);
                    }
                }
            }
        }
        ...
        protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_)
        {
            if (p_148213_1_ != null)
            {
                ...
                if (s1.length() > 0)
                {
                    ...
                    int k = (int) FontUtil.clean.getStringWidth(s1);
                    GuiStats.this.drawGradientRect(i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
                    FontUtil.clean.drawStringWithShadow(s1, (float)i, (float)j, -1);
                }
            }
        }
    ...
    class StatsGeneral extends GuiSlot
    {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            GuiStats.this.drawString(s, (int) (p_180791_2_ + 2 + 213 - FontUtil.clean.getStringWidth(s)), p_180791_3_ + 1, entryID % 2 == 0 ? 16777215 : 9474192);
        }
    }
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        {
            super(mcIn, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, FontUtil.clean.getHeight() * 4);
            this.setShowSelectionBox(false);
        ...
        protected int getContentHeight()
        {
            return this.getSize() * FontUtil.clean.getHeight() * 4;
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            GuiStats.this.drawString(s1, p_180791_2_ + 2, p_180791_3_ + 1 + FontUtil.clean.getHeight(), i == 0 ? 6316128 : 9474192);
            GuiStats.this.drawString(s2, p_180791_2_ + 2, p_180791_3_ + 1 + FontUtil.clean.getHeight() * 2, j == 0 ? 6316128 : 9474192);
        }
    }
}
