...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        {
            this.field_92023_s = (int) FontUtil.cleanmedium.getStringWidth(this.openGLWarning1);
            this.field_92024_r = (int) FontUtil.cleanmedium.getStringWidth(this.openGLWarning2);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        f = f * 100.0F / (float)((int) FontUtil.cleanmedium.getStringWidth(this.splashText) + 32);
        ...
        this.drawString(s1, this.width - (int) FontUtil.cleanmedium.getStringWidth(s1) - 2, this.height - 10, -1);

        if (this.openGLWarning1 != null && this.openGLWarning1.length() > 0)
        {
            drawRect(this.field_92022_t - 2, this.field_92021_u - 2, this.field_92020_v + 2, this.field_92019_w - 1, 1428160512);
            this.drawString(this.openGLWarning1, this.field_92022_t, this.field_92021_u, -1);
            this.drawString(this.openGLWarning2, (this.width - this.field_92024_r) / 2, ((GuiButton)this.buttonList.get(0)).yPosition - 12, -1);
        }
