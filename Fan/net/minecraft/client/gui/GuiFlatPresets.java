...
public class GuiFlatPresets extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_146433_u = new GuiTextField(2, FontUtil.clean, 50, 40, this.width - 100, 20);
    ...
    class ListSlot extends GuiSlot
    {
        ...
        private void func_148171_c(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_)
        {
            ...
            worldrenderer.pos((double)(p_148171_1_), (double)(p_148171_2_ + 18), (double)GuiFlatPresets.this.zLevel).tex((double)((float)(p_148171_3_) * 0.0078125F), (double)((float)(p_148171_4_ + 18) * 0.0078125F)).endVertex();
            ...
            worldrenderer.pos((double)(p_148171_1_ + 18), (double)(p_148171_2_), (double)GuiFlatPresets.this.zLevel).tex((double)((float)(p_148171_3_ + 18) * 0.0078125F), (double)((float)(p_148171_4_) * 0.0078125F)).endVertex();
            worldrenderer.pos((double)(p_148171_1_), (double)(p_148171_2_), (double)GuiFlatPresets.this.zLevel).tex((double)((float)(p_148171_3_) * 0.0078125F), (double)((float)(p_148171_4_) * 0.0078125F)).endVertex();
            tessellator.draw();
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            FontUtil.cleanmedium.drawString(guiflatpresets$layeritem.field_148232_b, p_180791_2_ + 18 + 5, p_180791_3_ + 6, 16777215);
        }
    }
}
