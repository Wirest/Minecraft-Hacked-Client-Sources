...
public class GuiIngame extends Gui
{
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        int j1 = arraylist1.size() * FontUtil.cleanmedium.getHeight();
        ...
        for (Object score1 : arraylist1)
        {
            ...
            int l = k1 - k * FontUtil.cleanmedium.getHeight();
            int i1 = p_180475_2_.getScaledWidth() - b0 + 2;
            drawRect(j - 2, l, i1, l + FontUtil.cleanmedium.getHeight(), 1342177280);
            ...
            if (k == arraylist1.size())
            {
                ...
                drawRect(j - 2, l - FontUtil.cleanmedium.getHeight() - 1, i1, l - 1, 1610612736);
                drawRect(j - 2, l - 1, i1, l, 1342177280);
                this.getFontRenderer().drawString(s3, j + i / 2 - this.getFontRenderer().getStringWidth(s3) / 2, l - FontUtil.cleanmedium.getHeight(), 553648127);
            }
        }
    }
