...
public class GuiMerchant extends GuiContainer
{
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        FontUtil.cleanmedium.drawString(s, this.xSize / 2 - (int) FontUtil.cleanmedium.getStringWidth(s) / 2, 6, 4210752);
        FontUtil.cleanmedium.drawString(I18n.format("container.inventory", new Object[0]), 8, this.ySize - 96 + 2, 4210752);
    }
