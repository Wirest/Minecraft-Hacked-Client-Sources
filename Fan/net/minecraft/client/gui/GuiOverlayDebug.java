...
public class GuiOverlayDebug extends Gui
{
    ...
    protected void renderDebugInfoLeft()
    {
        ...
        for (int i = 0; i < list.size(); ++i)
        {
            ...
            {
                int j = FontUtil.cleanmedium.getHeight();
                int k = (int) (int) FontUtil.cleanmedium.getStringWidth(s);
                boolean flag = true;
                int l = 2 + j * i;
                drawRect(1, l - 1, 2 + k + 1, l + j - 1, -1873784752);
                FontUtil.cleanmedium.drawString(s, 2, l, 14737632);
            }
        }
    }
    ...
    protected void renderDebugInfoRight(ScaledResolution p_175239_1_)
    {
        ...
        for (int i = 0; i < list.size(); ++i)
        {
            ...
            if (!Strings.isNullOrEmpty(s))
            {
                ...
                FontUtil.cleanmedium.drawString(s, l, i1, 14737632);
            }
        }
    }
    ...
    protected List call()
    {
        ...
        {
            return Lists.newArrayList(new String[] {"Minecraft 1.8.8 (" + this.mc.getVersion() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities(), this.mc.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", new Object[]{blockpos.getX() & 15, blockpos.getY() & 15, blockpos.getZ() & 15})});
        }
        else
        {
            ...
            if (this.mc.theWorld != null && this.mc.theWorld.isBlockLoaded(blockpos))
            {
                ...
                arraylist.add(String.format("Local Difficulty: %.2f (Day %d)", new Object[] {difficultyinstance.getAdditionalDifficulty(), this.mc.theWorld.getWorldTime() / 24000L}));
            }
            ...
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null)
            {
                ...
                arraylist.add(String.format("Looking at: %d %d %d", new Object[] {blockpos1.getX(), blockpos1.getY(), blockpos1.getZ()}));
            }
    ...
    protected List getDebugInfoRight()
    {
        ...
        long l = j - k;
        ArrayList arraylist = Lists.newArrayList(new String[] {String.format("Java: %s %dbit", new Object[]{System.getProperty("java.version"), this.mc.isJava64bit() ? 64 : 32}), String.format("Mem: % 2d%% %03d/%03dMB", new Object[]{l * 100L / i, bytesToMb(l), bytesToMb(i)}), String.format("Allocated: % 2d%% %03dMB", new Object[]{j * 100L / i, bytesToMb(j)}), "", String.format("CPU: %s", new Object[]{OpenGlHelper.func_183029_j()}), "", String.format("Display: %dx%d (%s)", new Object[]{Display.getWidth(), Display.getHeight(), GL11.glGetString(GL11.GL_VENDOR)}), GL11.glGetString(GL11.GL_RENDERER), GL11.glGetString(GL11.GL_VERSION)});
    ...
    private void func_181554_e()
    {
        ...
        FontUtil.cleanmedium.drawString("60", 2, scaledresolution.getScaledHeight() - 30 + 2, 14737632);
        ...
        FontUtil.cleanmedium.drawString("30", 2, scaledresolution.getScaledHeight() - 60 + 2, 14737632);
