...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public @Getter TextureManager ctm;
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Fan.startup();
        //this.ctm.bindTexture(new ResourceLocation("Fan/Background.jpg"));
        SplashScreen.setProgress(3, "Finishing");
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading " + Fan.name);
    ...
    private void displayDebugInfo(long elapsedTicksTime)
    {
        if (this.mcProfiler.profilingEnabled)
        {
            ...
            for (Profiler.Result result : list) {
                int i1 = MathHelper.floor_double(((Profiler.Result) result).field_76332_a / 4.0D) + 1;
                worldrenderer.begin(6, DefaultVertexFormats.POSITION_COLOR);
                int j1 = ((Profiler.Result) result).func_76329_a();
                int k1 = j1 >> 16 & 255;
                int l1 = j1 >> 8 & 255;
                int i2 = j1 & 255;
                ...
                for (int j2 = i1; j2 >= 0; --j2) {
                    float f = (float) ((d0 + ((Profiler.Result) result).field_76332_a * (double) j2 / (double) i1) * Math.PI * 2.0D / 100.0D);
