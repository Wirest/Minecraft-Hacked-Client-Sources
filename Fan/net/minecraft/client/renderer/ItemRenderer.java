...
public class ItemRenderer
{
    ...
    {
        float xValue = (float) (((float) Fan.effects.swordXValue.getValue()) * .01);
        float yValue = (float) (((float) Fan.effects.swordYValue.getValue()) * .01);
    ...
    public void updateEquippedItem()
    {
        ...
        if (this.itemToRender != null && itemstack != null)
        {
            if (!this.itemToRender.getIsItemStackEqual(itemstack))
            {
                ...
                {
                    boolean flag1 = Reflector.callBoolean(this.itemToRender.getItem(), Reflector.ForgeItem_shouldCauseReequipAnimation, new Object[] {this.itemToRender, itemstack, this.equippedItemSlot != entityplayersp.inventory.currentItem});
