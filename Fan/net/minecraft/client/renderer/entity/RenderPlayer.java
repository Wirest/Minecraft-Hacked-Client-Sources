...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    private void setModelVisibilities(AbstractClientPlayer clientPlayer)
    {
        ...
        else
        {
            ...
            boolean isViewingModelInAltManager = Minecraft.getMinecraft().currentScreen instanceof BetterAltManager;
            modelplayer.bipedHeadwear.showModel = isViewingModelInAltManager ? true : clientPlayer.isWearing(EnumPlayerModelParts.HAT);
            modelplayer.bipedBodyWear.showModel = isViewingModelInAltManager ? true : clientPlayer.isWearing(EnumPlayerModelParts.JACKET);
            modelplayer.bipedLeftLegwear.showModel = isViewingModelInAltManager ? true : clientPlayer.isWearing(EnumPlayerModelParts.LEFT_PANTS_LEG);
            modelplayer.bipedRightLegwear.showModel = isViewingModelInAltManager ? true : clientPlayer.isWearing(EnumPlayerModelParts.RIGHT_PANTS_LEG);
            modelplayer.bipedLeftArmwear.showModel = isViewingModelInAltManager ? true : clientPlayer.isWearing(EnumPlayerModelParts.LEFT_SLEEVE);
            modelplayer.bipedRightArmwear.showModel = isViewingModelInAltManager ? true : clientPlayer.isWearing(EnumPlayerModelParts.RIGHT_SLEEVE);
            modelplayer.heldItemLeft = 0;
            modelplayer.aimedBow = false;
            modelplayer.isSneak = isViewingModelInAltManager ? false : clientPlayer.isSneaking();
