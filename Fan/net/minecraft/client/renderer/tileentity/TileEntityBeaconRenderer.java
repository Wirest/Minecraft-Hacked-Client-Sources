    ...
    public void renderTileEntityAt(TileEntityBeacon te, double x, double y, double z, float partialTicks, int destroyStage)
    {
        ...
        if (f > 0.0F)
        {
            ...
            for (TileEntityBeacon.BeamSegment beamSegment : list) {
                int k = i + ((TileEntityBeacon.BeamSegment) beamSegment).getHeight();
                ...
                float f1 = ((TileEntityBeacon.BeamSegment) beamSegment).getColors()[0];
                float f2 = ((TileEntityBeacon.BeamSegment) beamSegment).getColors()[1];
                float f3 = ((TileEntityBeacon.BeamSegment) beamSegment).getColors()[2];
                ...
                double d13 = 1.0D;
                double d14 = -1.0D + d1;
                double d15 = (double) ((float) ((TileEntityBeacon.BeamSegment) beamSegment).getHeight() * f) * 2.5D + d14;
                ...
                d11 = 1.0D;
                d12 = -1.0D + d1;
                d13 = (double) ((float) ((TileEntityBeacon.BeamSegment) beamSegment).getHeight() * f) + d12;
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
