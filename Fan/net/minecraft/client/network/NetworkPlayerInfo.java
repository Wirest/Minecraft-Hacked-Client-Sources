...
public class NetworkPlayerInfo
{
    ...
    {
        return this.skinType == null ? gameProfile == null ? "default" : DefaultPlayerSkin.getSkinType(this.gameProfile.getId()) : this.skinType;
    }
    ...
    public ResourceLocation getLocationSkin()
    {
        ...
        return (ResourceLocation) MoreObjects.firstNonNull(this.locationSkin, gameProfile == null ? DefaultPlayerSkin.getDefaultSkin(UUID.randomUUID()) : DefaultPlayerSkin.getDefaultSkin(this.gameProfile.getId()));
    }
