...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
    ...
    private void attackEntitiesInList(List<Entity> p_70971_1_)
    {
        for (Entity value : p_70971_1_) {
            ...
            if ((Entity) value instanceof EntityLivingBase) {
                ((Entity) value).attackEntityFrom(DamageSource.causeMobDamage(this), 10.0F);
                this.applyEnchantments(this, (Entity) value);
            }
        }
    }
    ...
    private void setNewTarget()
    {
        ...
        list.removeIf(entityPlayer -> ((EntityPlayer) entityPlayer).isSpectator());
