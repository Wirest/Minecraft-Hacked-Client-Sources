    ...
    public void onUpdate()
    {
        if (this.worldObj.isRemote || (this.shootingEntity == null || !this.shootingEntity.isDead) && this.worldObj.isBlockLoaded(new BlockPos(this)))
        {
            ...
            for (Entity value : list) {
                ...
                if (((Entity) value).canBeCollidedWith() && (!((Entity) value).isEntityEqual(this.shootingEntity) || this.ticksInAir >= 25)) {
                    float f = 0.3F;
                    AxisAlignedBB axisalignedbb = ((Entity) value).getEntityBoundingBox().expand((double) f, (double) f, (double) f);
