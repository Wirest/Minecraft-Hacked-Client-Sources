...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        Double speed = Fan.effects.handspeed.getValue();
    ...
    {
        List<Entity> list = this.worldObj.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().expand(0.20000000298023224D, 0.0D, 0.20000000298023224D), Predicates.<Entity> and (EntitySelectors.NOT_SPECTATING, Entity::canBePushed));

        if (!list.isEmpty())
        {
            for (Entity value : list) {
                this.collideWithEntity((Entity) value);
            }
        }
    }
