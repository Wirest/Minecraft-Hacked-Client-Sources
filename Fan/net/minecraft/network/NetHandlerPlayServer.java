...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable
{
    ...
    public void kickPlayerFromServer(String reason)
    {
        ...
        this.netManager.sendPacket(new S40PacketDisconnect(chatcomponenttext), p_operationComplete_1_ -> NetHandlerPlayServer.this.netManager.closeChannel(chatcomponenttext), new GenericFutureListener[0]);
    ...
    public void processTabComplete(C14PacketTabComplete packetIn)
    {
        ...
        this.playerEntity.playerNetServerHandler.sendPacket(new S3APacketTabComplete((String[])list.toArray(new String[0])));
    }
