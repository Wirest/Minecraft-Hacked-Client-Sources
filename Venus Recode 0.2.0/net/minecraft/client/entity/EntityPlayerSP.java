...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            else
            {
                ...
                EventMotionUpdate event = new EventMotionUpdate(this.mc.thePlayer.posX, (getEntityBoundingBox()).minY, this.mc.thePlayer.posZ, this.mc.thePlayer.rotationYaw, this.mc.thePlayer.rotationPitch, this.mc.thePlayer.onGround, EventMotionUpdate.Type.POST);
                event.call();
            }
        }
    }
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        EventMotionUpdate event = new EventMotionUpdate(this.mc.thePlayer.posX, (getEntityBoundingBox()).minY, this.mc.thePlayer.posZ, this.mc.thePlayer.rotationYaw, this.mc.thePlayer.rotationPitch, this.mc.thePlayer.onGround, EventMotionUpdate.Type.PRE);
        event.call();
        ...
        if (this.isCurrentViewEntity()) {
            if (isCurrentViewEntity()) {
                ...
                if (!event.isCancelled())
                    if (flag2 && flag3) {
                        sendQueue.addToSendQueue((Packet) new C03PacketPlayer.C06PacketPlayerPosLook(x, y, z, yaw, pitch, ground));
                    } else if (flag2) {
                        sendQueue.addToSendQueue((Packet) new C03PacketPlayer.C04PacketPlayerPosition(x, y, z, ground));
                    } else if (flag3) {
                        sendQueue.addToSendQueue((Packet) new C03PacketPlayer.C05PacketPlayerLook(yaw, pitch, ground));
                    } else {
                        sendQueue.addToSendQueue((Packet) new C03PacketPlayer(ground));
                    }
