...
public class NahrFont {
   ...
   public void drawString(String text, float x, float y, NahrFont.FontType fontType, int color, int color2) {
   ...
   private void drawTexturedModalRect(float x, float y, float u, float v, float width, float height) {
      ...
      worldRenderer.addVertexWithUV((double)(x + 0.0F), (double)(y + height), 0.0D, (double)((u + 0.0F) * 0.0039063F), (double)((v + height) * 0.0039063F));
      worldRenderer.addVertexWithUV((double)(x + width), (double)(y + height), 0.0D, (double)((u + width) * 0.0039063F), (double)((v + height) * 0.0039063F));
      worldRenderer.addVertexWithUV((double)(x + width), (double)(y + 0.0F), 0.0D, (double)((u + width) * 0.0039063F), (double)((v + 0.0F) * 0.0039063F));
      worldRenderer.addVertexWithUV((double)(x + 0.0F), (double)(y + 0.0F), 0.0D, (double)((u + 0.0F) * 0.0039063F), (double)((v + 0.0F) * 0.0039063F));
      tesselator.draw();
   }
