...
final class LayerIIIDecoder implements FrameDecoder {
   ...
   public LayerIIIDecoder(SoundStream stream0, Frame header0, SynthesisFilter filtera, SynthesisFilter filterb, Obuffer buffer0, int which_ch0) {
               ...
               if (gr_info.mixed_block_flag != 0) {
                  ...
                  while(true) {
                     ...
                     for(sfb = 12; sfb >= 3; --sfb) {
                        ...
                        for(i = (i << 2) - i + (j + 1) * lines - 1; lines > 0; --i) {
