...
import saint.eventstuff.events.WorldLoad;
import saint.insurance.Insurance;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
   ...
   private void rightClickMouse() {
      ...
      RightClicked rc = new RightClicked(this.rightClickDelayTimer);
      Saint.getEventManager().hook(rc);
      this.rightClickDelayTimer = rc.getDelay();
      boolean var1 = true;
   ...
   public void runTick() throws IOException {
      Saint.getEventManager().hook(new EveryTick());
      ...
      if (this.currentScreen != null) {
         try {
            ...
            var2 = CrashReport.makeCrashReport(var9, "Updating screen events");
         ...
         if (this.currentScreen != null) {
            try {
               ...
               var2 = CrashReport.makeCrashReport(var8, "Ticking screen");
               var3 = var2.makeCategory("Affected screen");
               var3.addCrashSectionCallable("Screen name", new Callable() {
            ...
            if (var10 <= 200L) {
               ...
               if (this.currentScreen == null) {
                  if (Mouse.getEventButtonState()) {
                     ...
                     Saint.getEventManager().hook(clicked);
                     if (!this.inGameHasFocus) {
                        this.setIngameFocus();
                     }
                  }
            ...
            do {
               do {
                  ...
                  if (this.currentScreen != null) {
                     ...
                     PressedKey event = new PressedKey(Keyboard.getEventKey());
      ...
      if (this.theWorld != null) {
         if (!this.isGamePaused) {
            ...
            try {
               ...
               var2 = CrashReport.makeCrashReport(var10, "Exception in world tick");
               if (this.theWorld == null) {
   ...
   public void loadWorld(WorldClient worldClientIn) {
      WorldLoad event = new WorldLoad(worldClientIn);
      Saint.getEventManager().hook(event);
   ...
   public void dispatchKeypresses() {
      if (!(this.currentScreen instanceof GuiSaintLogin)) {
