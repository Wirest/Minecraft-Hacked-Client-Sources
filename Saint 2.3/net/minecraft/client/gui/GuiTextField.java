...
public class GuiTextField extends Gui {
   ...
   public void drawTextBox() {
      if (this.getVisible()) {
         ...
         if (var6) {
            if (var13) {
               Gui.drawRect(var11 - 1, var8 - 1, var11, var8 + 1 + (Saint.getModuleManager().getModuleUsingName("saintchat").isEnabled() ? 8 : this.fontRendererInstance.FONT_HEIGHT), -3092272);
            } else if (Saint.getModuleManager().getModuleUsingName("saintchat").isEnabled()) {
               Gui.drawRect(var11 - 1, var8 - 1, var11, var8 + 9, -3092272);
            } else {
