   ...
   public void func_175249_a(int p_175249_1_, Scoreboard p_175249_2_, ScoreObjective p_175249_3_) {
      ...
      if (var17 != null) {
         ...
         for(var19 = var17.iterator(); var19.hasNext(); var15 += this.field_175250_f.fontRendererObj.FONT_HEIGHT) {
            ...
            this.field_175250_f.fontRendererObj.func_175063_a(Saint.getFriendManager().replaceNames(var20, true), (float)(p_175249_1_ / 2 - var21 / 2), (float)var15, -1);
            this.playerName = var20;
         }
      ...
      for(int var30 = 0; var30 < var28; ++var30) {
         ...
         if (var30 < var5.size()) {
            ...
            if (var24.getGameType() == WorldSettings.GameType.SPECTATOR) {
               ...
               this.field_175250_f.fontRendererObj.func_175063_a(Saint.getFriendManager().replaceNames(var25, true), (float)var22, (float)var23, -1862270977);
            } else {
               this.field_175250_f.fontRendererObj.func_175063_a(Saint.getFriendManager().replaceNames(var25, true), (float)var22, (float)var23, -1);
            }
      ...
      if (p_175247_1_.func_178766_e() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
         ...
         if (var8 > 0) {
            ...
            if (var11 > 3.0F) {
               ...
               this.field_175250_f.fontRendererObj.func_175063_a(Saint.getFriendManager().replaceNames(var14, true), (float)((p_175247_5_ + p_175247_4_) / 2 - this.field_175250_f.fontRendererObj.getStringWidth(var14) / 2), (float)p_175247_2_, var13);
            }
         }
      } else {
         String var15 = "" + EnumChatFormatting.YELLOW + var7;
         this.field_175250_f.fontRendererObj.func_175063_a(Saint.getFriendManager().replaceNames(var15, true), (float)(p_175247_5_ - this.field_175250_f.fontRendererObj.getStringWidth(var15)), (float)p_175247_2_, 16777215);
      }
