...
import saint.eventstuff.events.Reach;
...
public class PlayerControllerMP {
   ...
   public static List entities = new CopyOnWriteArrayList();
   ...
   public boolean func_178888_a(BlockPos p_178888_1_, EnumFacing p_178888_2_) {
      BlockBreaking event = new BlockBreaking(BlockBreaking.EnumBlock.DESTROY, p_178888_1_, p_178888_2_);
   ...
   public boolean func_180511_b(BlockPos p_180511_1_, EnumFacing p_180511_2_) {
      BlockBreaking event = new BlockBreaking(BlockBreaking.EnumBlock.CLICK, p_180511_1_, p_180511_2_);
      Saint.getEventManager().hook(event);
      Block var3;
      if (this.currentGameType.isAdventure()) {
         if (this.currentGameType == WorldSettings.GameType.SPECTATOR) {
   ...
   public boolean func_180512_c(BlockPos p_180512_1_, EnumFacing p_180512_2_) {
      BlockBreaking event = new BlockBreaking(BlockBreaking.EnumBlock.DAMAGE, p_180512_1_, p_180512_2_);
      Saint.getEventManager().hook(event);
      ...
      if (this.blockHitDelay > 0) {
         ...
         this.blockHitDelay = Saint.getModuleManager().getModuleUsingName("speedmine").isEnabled() ? 0 : 5;
         ...
         if (var3.getMaterial() == Material.air) {
            ...
            this.curBlockDamageMP = (float)((double)this.curBlockDamageMP + (double)var3.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj, p_180512_1_) * (Saint.getModuleManager().getModuleUsingName("speedmine").isEnabled() ? 1.337D : 1.0D));
   ...
   public float getBlockReachDistance() {
      Reach event = new Reach(this.currentGameType.isCreative() ? 5.0F : 4.5F);
      Saint.getEventManager().hook(event);
   ...
   public EntityPlayerSP func_178892_a(World worldIn, StatFileWriter p_178892_2_) {
      EntityPlayerSP entity = new EntityPlayerSP(this.mc, worldIn, this.netClientHandler, p_178892_2_);
   ...
   public void attackEntity(EntityPlayer playerIn, Entity targetEntity) {
      if (!Saint.getFriendManager().isFriend(targetEntity.getName())) {
         Saint.getEventManager().hook(new Attack(targetEntity));
         this.syncCurrentPlayItem();
