...
import saint.eventstuff.events.WorldBob;
...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   public void setupCameraTransform(float partialTicks, int pass) {
      ...
      if (this.mc.gameSettings.viewBobbing) {
         WorldBob bob = new WorldBob(partialTicks);
         Saint.getEventManager().hook(bob);
         if (!bob.isCancelled()) {
            this.setupViewBobbing(bob.getPartialTicks());
         }
      }
   ...
   private void func_175068_a(int pass, float partialTicks, long finishTimeNano) {
      ...
      RenderIn3D event = new RenderIn3D(partialTicks);
      Saint.getEventManager().hook(event);
      boolean viewBobbing = this.mc.gameSettings.viewBobbing;
      this.mc.gameSettings.viewBobbing = false;
      this.mc.entityRenderer.setupCameraTransform(partialTicks, pass);
      RenderTracers event2 = new RenderTracers(partialTicks);
      Saint.getEventManager().hook(event2);
