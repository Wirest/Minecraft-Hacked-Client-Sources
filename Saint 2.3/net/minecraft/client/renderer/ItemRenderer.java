...
import saint.Saint;
import saint.modstuff.modules.FastUse;
   ...
   public void renderItemInFirstPerson(float p_78440_1_) {
      ...
      if (this.itemToRender != null) {
         if (this.itemToRender.getItem() == Items.filled_map) {
            ...
            FastUse fastUse = (FastUse)Saint.getModuleManager().getModuleUsingName("instantuse");
            boolean shouldSwingItem = fastUse == null || !fastUse.isEnabled() || !fastUse.isUsable(this.mc.thePlayer.getCurrentEquippedItem());
            switch(var7) {
            case NONE:
            ...
            case DRINK:
               ...
               break;
            case BLOCK:
               this.func_178096_b(var2 + 0.2F, var4);
               this.func_178103_d();
