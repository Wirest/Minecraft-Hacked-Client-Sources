...
public class BlockModelRenderer {
   ...
   public boolean renderBlockModel(IBlockAccess blockAccessIn, IBakedModel modelIn, IBlockState blockStateIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, boolean checkSides) {
      Xray ray = new Xray();
      Saint.getEventManager().hook(ray);
      ...
      try {
         ...
         CrashReport var9 = CrashReport.makeCrashReport(var12, "Tesselating block model");
   ...
   public boolean renderModelAmbientOcclusion(IBlockAccess blockAccessIn, IBakedModel modelIn, Block blockIn, IBlockState blockStateIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, boolean checkSides) {
      ...
      for(int var17 = 0; var17 < var12; ++var17) {
         ...
         if (!stateSnow.isEmpty()) {
            ...
            try {
               if (!checkSides || blockIn.shouldSideBeRendered(blockAccessIn, var16, modelSnow) || ray.shouldRay() && wh.getBlocks().contains(blockIn)) {
                  if (renderEnv == null) {
   ...
   private void renderModelAmbientOcclusionQuads(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, List listQuadsIn, RenderEnv renderEnv) {
      Xray ray = new Xray();
      Saint.getEventManager().hook(ray);
      boolean renderSolid = true;
      Wallhack wh = (Wallhack)Saint.getModuleManager().getModuleUsingName("wallhack");

      try {
         renderSolid = ray.shouldRay() && !wh.getBlocks().contains(blockIn);
      ...
      for(Iterator var221 = listQuadsIn.iterator(); var221.hasNext(); worldRendererIn.func_178987_a(var9, var11, var13)) {
         ...
         if (!var17.func_178212_b() && colorMultiplier < 0) {
            if (renderSolid) {
               worldRendererIn.color(aoFaceIn.field_178206_b[0], aoFaceIn.field_178206_b[0], aoFaceIn.field_178206_b[0], 4);
               worldRendererIn.color(aoFaceIn.field_178206_b[1], aoFaceIn.field_178206_b[1], aoFaceIn.field_178206_b[1], 3);
               worldRendererIn.color(aoFaceIn.field_178206_b[2], aoFaceIn.field_178206_b[2], aoFaceIn.field_178206_b[2], 2);
               worldRendererIn.color(aoFaceIn.field_178206_b[3], aoFaceIn.field_178206_b[3], aoFaceIn.field_178206_b[3], 1);
            } else {
               worldRendererIn.color(aoFaceIn.field_178206_b[0], aoFaceIn.field_178206_b[0], aoFaceIn.field_178206_b[0], 4);
               worldRendererIn.color(aoFaceIn.field_178206_b[1], aoFaceIn.field_178206_b[1], aoFaceIn.field_178206_b[1], 3);
               worldRendererIn.color(aoFaceIn.field_178206_b[2], aoFaceIn.field_178206_b[2], aoFaceIn.field_178206_b[2], 2);
