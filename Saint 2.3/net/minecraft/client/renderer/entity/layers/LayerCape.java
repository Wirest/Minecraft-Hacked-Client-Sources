...
public class LayerCape implements LayerRenderer {
   ...
   public void doRenderLayer(AbstractClientPlayer p_177166_1_, float p_177166_2_, float p_177166_3_, float p_177166_4_, float p_177166_5_, float p_177166_6_, float p_177166_7_, float p_177166_8_) {
      if ((p_177166_1_.hasCape() || Saint.getFriendManager().isFriend(p_177166_1_.getName())) && !p_177166_1_.isInvisible() && (p_177166_1_.func_175148_a(EnumPlayerModelParts.CAPE) || Saint.getFriendManager().isFriend(p_177166_1_.getName())) && (p_177166_1_.getLocationCape() != null || Saint.getFriendManager().isFriend(p_177166_1_.getName()))) {
         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
         this.playerRenderer.bindTexture(Saint.getFriendManager().isFriend(StringUtils.stripControlCodes(p_177166_1_.getName())) ? new ResourceLocation("textures/saintcape.png") : p_177166_1_.getLocationCape());
