      ...
      if (args.length < 1) {
         ...
         if (args[0].equals("set")) {
            ...
            if (var8 > 0L) {
               ...
               if (var4 > var6) {
                  notifyOperators(sender, this, "commands.worldborder.setSlowly.shrink.success", new Object[]{String.format("%.1f", var6), String.format("%.1f", var4), Long.toString(var8 / 1000L)});
               } else {
                  notifyOperators(sender, this, "commands.worldborder.setSlowly.grow.success", new Object[]{String.format("%.1f", var6), String.format("%.1f", var4), Long.toString(var8 / 1000L)});
               }
            } else {
               var3.setTransition(var6);
               notifyOperators(sender, this, "commands.worldborder.set.success", new Object[]{String.format("%.1f", var6), String.format("%.1f", var4)});
            }
            ...
            notifyOperators(sender, this, "commands.worldborder.center.success", new Object[]{var5, var7});
            ...
            if (args[1].equals("buffer")) {
               ...
               notifyOperators(sender, this, "commands.worldborder.damage.buffer.success", new Object[]{String.format("%.1f", var4), String.format("%.1f", var6)});
               ...
               notifyOperators(sender, this, "commands.worldborder.damage.amount.success", new Object[]{String.format("%.2f", var4), String.format("%.2f", var6)});
            }
            ...
            if (args[1].equals("time")) {
               ...
               notifyOperators(sender, this, "commands.worldborder.warning.time.success", new Object[]{var11, var12});
               ...
               notifyOperators(sender, this, "commands.worldborder.warning.distance.success", new Object[]{var11, var12});
            }
