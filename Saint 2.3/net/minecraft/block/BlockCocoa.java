...
public class BlockCocoa extends BlockDirectional implements IGrowable {
   ...
   public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
      if (!this.canBlockStay(worldIn, pos, state)) {
         ...
         int var5 = (Integer)state.getValue(field_176501_a);
         if (var5 < 2) {
   ...
   public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
      ...
      return this.getDefaultState().withProperty(AGE, facing.getOpposite()).withProperty(field_176501_a, 0);
   }
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(AGE, EnumFacing.getHorizontal(meta)).withProperty(field_176501_a, (meta & 15) >> 2);
   }
