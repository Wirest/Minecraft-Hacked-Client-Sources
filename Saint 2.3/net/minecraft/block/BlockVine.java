      ...
      while(true) {
         ...
         do {
            ...
            do {
               ...
               } while(!(Boolean)p_176269_3_.getValue(var7));
         ...
         if (var17 == EnumFacing.UP && pos.getY() < 255 && worldIn.isAirBlock(pos.offsetUp())) {
            if (!var7) {
               ...
               while(true) {
                  do {
                     if (!var22.hasNext()) {
                        if ((Boolean)var19.getValue(field_176273_b) || (Boolean)var19.getValue(field_176278_M) || (Boolean)var19.getValue(field_176279_N) || (Boolean)var19.getValue(field_176280_O)) {
            ...
            BlockPos var18;
            if (var17.getAxis().isHorizontal() && !(Boolean)state.getValue(func_176267_a(var17))) {
               if (!var7) {
                  ...
                  if (var21.blockMaterial == Material.air) {
                     ...
                     boolean var25 = (Boolean)state.getValue(func_176267_a(var23));
                     boolean var26 = (Boolean)state.getValue(func_176267_a(var24));
               ...
               if (var11.blockMaterial == Material.air) {
                  ...
                  if ((Boolean)var12.getValue(field_176273_b) || (Boolean)var12.getValue(field_176278_M) || (Boolean)var12.getValue(field_176279_N) || (Boolean)var12.getValue(field_176280_O)) {
                  ...
                  while(true) {
                     ...
                     } while(!rand.nextBoolean() && (Boolean)state.getValue(var15));
