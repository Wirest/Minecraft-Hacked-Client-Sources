...
public abstract class EntityPlayer extends EntityLivingBase {
   ...
   public void attackTargetEntityWithCurrentItem(Entity targetEntity) {
      if (targetEntity.canAttackWithItem() && !targetEntity.hitByEntity(this)) {
         ...
         if (var2 > 0.0F || var4 > 0.0F) {
            ...
            if (Saint.getModuleManager().getModuleUsingName("criticals").isEnabled()) {
               var5 = true;
            }
            ...
            if (var14) {
               if (var18 > 0) {
                  targetEntity.addVelocity((double)(-MathHelper.sin(this.rotationYaw * 3.1415927F / 180.0F) * (float)var18 * 0.5F), 0.1D, (double)(MathHelper.cos(this.rotationYaw * 3.1415927F / 180.0F) * (float)var18 * 0.5F));
                  this.motionX *= 0.6D;
                  this.motionZ *= 0.6D;
   ...
   public boolean isEntityInsideOpaqueBlock() {
      ...
      return !this.sleeping && super.isEntityInsideOpaqueBlock() && !event.isCancelled();
   }
