...
public class PlayerItemParser {
    ...
    public static String ITEM_TEXTURE_SIZE = "textureSize";
    public static String ITEM_USE_PLAYER_TEXTURE = "usePlayerTexture";
    public static String ITEM_MODELS = "models";
    public static String MODEL_ID = "id";
    public static String MODEL_BASE_ID = "baseId";
    public static String MODEL_TYPE = "type";
    public static String MODEL_ATTACH_TO = "attachTo";
    public static String MODEL_INVERT_AXIS = "invertAxis";
    public static String MODEL_MIRROR_TEXTURE = "mirrorTexture";
    public static String MODEL_TRANSLATE = "translate";
    public static String MODEL_ROTATE = "rotate";
    public static String MODEL_SCALE = "scale";
    public static String MODEL_BOXES = "boxes";
    public static String MODEL_SPRITES = "sprites";
    public static String MODEL_SUBMODEL = "submodel";
    public static String MODEL_SUBMODELS = "submodels";
    public static String BOX_TEXTURE_OFFSET = "textureOffset";
    public static String BOX_COORDINATES = "coordinates";
    public static String BOX_SIZE_ADD = "sizeAdd";
    public static String ITEM_TYPE_MODEL = "PlayerItem";
    public static String MODEL_TYPE_BOX = "ModelBox";
