...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float p_78440_1_) {
        ...
        float swingprogress = var3.getSwingProgress(p_78440_1_);
        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() == Items.filled_map) {
                this.func_178097_a(var3, var5, var2, swingprogress);
                ...
                switch (ItemRenderer.SwitchEnumAction.field_178094_a[var7.ordinal()]) {
                    case 1:
                        ...
                        this.func_178096_b(var2, swingprogress);
                        break;
                    case 2:
                    case 3:
                    ...
                    case 4: //RIGHTCLICK
                        ...
                        //TODO
                        if(Client.getModuleManager().isEnabled(Animations.class)){
                        	switch(Animations.block){
                        	case"Sigma":
                        		...
                        		break;
                        	case"Slide":
                        	  	this.sigma2(var2*0.3f, swingprogress);
                        		this.func_178103_d();
                        		break;                       		
                        	case"Vanilla":   	
                        		this.func_178096_b(0, swingprogress);
                        		this.func_178103_d();
                        		break;                    		                   		
                        	case"Avatar":
                        		this.avatar(var2, swingprogress);
                                this.func_178103_d();
                        		break;
                        	case"Tap":
                        		this.tap(var2, swingprogress);
                        		this.func_178103_d();
                        		break;
                        	case"Tap2":
                        		this.tap2(var2, swingprogress);
                        		this.func_178103_d();
                        	}
                        }else{ 
                        	this.func_178096_b(0, swingprogress);
            	...
            	//HIT
            	if("Smooth".equalsIgnoreCase(Animations.hit) && Client.getModuleManager().isEnabled(Animations.class)){
                    this.func_178096_b(var2*0.5F, swingprogress);
            	}else{
            		this.func_178105_d(swingprogress);
                    this.func_178096_b(var2*1F, swingprogress);
            	}
            ...
            this.func_178095_a(var3, var2, swingprogress);
        }
