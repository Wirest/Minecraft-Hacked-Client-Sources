...
public class GuiChat extends GuiScreen {
    ...
    public void initGui() {
        ...
        if(Client.getModuleManager().isEnabled(AgoraModule.class)){
        	this.buttonList.add(new AgoraInGameButton(1, 2, this.height - 27, 70, 12, "Chat : Minecraft"));
        }
        
        if(mode.equalsIgnoreCase("Agora")){
