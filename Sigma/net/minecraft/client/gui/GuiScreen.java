...
import info.sigmaclient.event.impl.EventRenderInventoryBackground;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
    ...
    public void drawWorldBackground(int tint) {
        ...
        if (this.mc.theWorld != null) {
        	EventRenderInventoryBackground er = ((EventRenderInventoryBackground) EventSystem.getInstance(EventRenderInventoryBackground.class));
        	er.fire(this, true);
            if (!er.isCancelled()) {
