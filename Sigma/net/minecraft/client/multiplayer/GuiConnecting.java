...
import info.sigmaclient.management.StatManager;
...
public class GuiConnecting extends GuiScreen {
    ...
    private void connect(final String ip, final int port) {
        ...
        StatManager.getInstance().onConnection();
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
            ...
            public void run() {
                ...
                try {
                    ...
                    GuiDisconnected gui =new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", var3));
                    gui.setIp(ip);
                    GuiConnecting.this.mc.displayGuiScreen(gui);
                }
            }
        }).start();
    }
