...
public class NetHandlerLoginClient implements INetHandlerLoginClient {
    ...
    public void onDisconnect(IChatComponent reason) {
    	GuiDisconnected gui = new GuiDisconnected(this.field_147395_c, "connect.failed", reason);
    	gui.setIp(Minecraft.getMinecraft().getCurrentServerData().serverIP);
        this.field_147394_b.displayGuiScreen(gui);
    }
