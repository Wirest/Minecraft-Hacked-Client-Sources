...
import me.memewaredevs.client.module.movement.Fly;
import me.memewaredevs.client.module.movement.HighJump;
import me.memewaredevs.client.module.player.Scaffold;
...
public abstract class Entity implements ICommandSender {
	...
	public void moveEntity(double x, double y, double z) {
		if (this.noClip) {
			...
			double var15 = y;
			double var17 = z;
			boolean var19 = Memeware.INSTANCE.getModuleManager().get(Scaffold.class).isToggled()
					&& this.onGround
					|| this.onGround && (Memeware.INSTANCE.getModuleManager().get(HighJump.class).isToggled()
