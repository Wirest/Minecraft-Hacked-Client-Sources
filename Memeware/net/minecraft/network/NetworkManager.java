...
import me.memewaredevs.proxymanager.ProxyAdapter;
...
import me.memewaredevs.client.event.events.PostPacketInEvent;
...
//		Queues.newPriorityQueue();
    ...
    public static NetworkManager provideLanClient(InetAddress p_150726_0_, int p_150726_1_) {
        if (Memeware.INSTANCE.proxy != Proxy.NO_PROXY) {
            ...
            })).channelFactory(new ProxyAdapter(Memeware.INSTANCE.proxy))).connect(p_150726_0_, p_150726_1_).syncUninterruptibly();
            return var2;
        }
        final NetworkManager var2 = new NetworkManager(EnumPacketDirection.CLIENTBOUND);
        ((Bootstrap) ((Bootstrap) ((Bootstrap) (new Bootstrap())
