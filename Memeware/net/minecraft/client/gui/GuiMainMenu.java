...
import me.memewaredevs.altmanager.GuiAltManager;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		this.buttonList.add(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Alts"));
	}
...
//            this.switchToRealms();
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		GlStateManager.enableAlpha();
		this.mc.getTextureManager().bindTexture(new ResourceLocation("dort/bg.png"));
		Gui.drawScaledCustomSizeModalRect(0, 0, 0, 0, width, height, width, height, width, height);
		GameHud.mainFont.drawStringWithShadow(String.format("\247e%s (%s) \247rv%s",
				Memeware.INSTANCE.getClientName(), Memeware.INSTANCE.getEdition(), Memeware.INSTANCE.getVersion()),
				5.0f, 5.0f, -1);
