...
public class Ghost extends CustomFile{
    public Ghost(String name, boolean Module, boolean loadOnStart) {
        ...
        while ((line = variable9.readLine()) != null){
            ...
            if (i >= 0){
                ...
                for(Property p : PropertyManager.properties) {
                    ...
                    if(p.getModule().getCategory().equals(Category.GHOST)){
    ...
    public void saveFile() throws IOException {
        ...
        for (Property p : Pandora.getPropertyManager().properties) {
            if(p.getModule() == null)
                continue;
            if (p.getModule().getCategory() == Category.GHOST) {
