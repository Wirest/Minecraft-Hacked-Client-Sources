...
public class Movement extends CustomFile{
    public Movement(String name, boolean Module, boolean loadOnStart) {
        ...
        while ((line = variable9.readLine()) != null){
            ...
            if (i >= 0){
                ...
                for(Property p : PropertyManager.properties) {
                    ...
                    if(p.getModule().getCategory().equals(Category.MOVEMENT)){
    ...
    public void saveFile() throws IOException {
        ...
        for (Property p : Pandora.getPropertyManager().properties) {
            if(p.getModule() == null)
                continue;
            if (p.getModule().getCategory() == Category.MOVEMENT) {
