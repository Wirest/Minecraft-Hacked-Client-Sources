...
public class ChunkLoader
{
    ...
    public static void convertToAnvilFormat(ChunkLoader.AnvilConverterData p_76690_0_, NBTTagCompound p_76690_1_, WorldChunkManager p_76690_2_)
    {
            ...
            for (var7 = 0; var7 < 16 && var6; ++var7)
            {
                ...
                while (var8 < 16 && var6)
                {
                    ...
                    while (true)
                    {
                        if (var9 < 16)
                        {
                            int var10 = var7 << 11 | var9 << 7 | var8 + (var5 << 1);
            ...
            if (!var6)
            {
                ...
                for (int var23 = 0; var23 < 16; ++var23)
                {
                    for (int var12 = 0; var12 < 16; ++var12)
                    {
                        ...
                        {
                            int var14 = var23 << 11 | var13 << 7 | var12 + (var5 << 1);
                            byte var15 = p_76690_0_.blocks[var14];
                            var19[var12 << 8 | var13 << 4 | var23] = (byte)(var15 & 255);
                            var20.set(var23, var12, var13, p_76690_0_.data.get(var23, var12 + (var5 << 1), var13));
                            var21.set(var23, var12, var13, p_76690_0_.skyLight.get(var23, var12 + (var5 << 1), var13));
                            var22.set(var23, var12, var13, p_76690_0_.blockLight.get(var23, var12 + (var5 << 1), var13));
                        }
                    }
                }
        ...
        for (int var18 = 0; var18 < 16; ++var18)
        {
            ...
            {
                var17[var7 << 1 | var18] = (byte)(p_76690_2_.func_180300_a(new BlockPos(p_76690_0_.x << 1 | var18, 0, p_76690_0_.z << 1 | var7), BiomeGenBase.field_180279_ad).biomeID & 255);
            }
        }
