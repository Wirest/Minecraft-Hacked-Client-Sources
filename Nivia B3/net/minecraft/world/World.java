...
public abstract class World implements IBlockAccess
{
    ...
    public List getCollidingBlockBoundingBoxes(final Entity p_72945_1_, final AxisAlignedBB p_72945_2_) {
        ArrayList var = Lists.newArrayList();
        final int var2 = MathHelper.floor_double(p_72945_2_.minX);
        final int var3 = MathHelper.floor_double(p_72945_2_.maxX + 1.0);
        final int var4 = MathHelper.floor_double(p_72945_2_.minY);
        final int var5 = MathHelper.floor_double(p_72945_2_.maxY + 1.0);
        final int var6 = MathHelper.floor_double(p_72945_2_.minZ);
        final int var7 = MathHelper.floor_double(p_72945_2_.maxZ + 1.0);
        for (int var8 = var2; var8 < var3; ++var8) {
            for (int var9 = var6; var9 < var7; ++var9) {
                if (this.isBlockLoaded(new BlockPos(var8, 64, var9))) {
                    for (int var10 = var4 - 1; var10 < var5; ++var10) {
                        final BlockPos var11 = new BlockPos(var8, var10, var9);
                        final boolean var12 = p_72945_1_.isOutsideBorder();
                        final boolean var13 = this.isInsideBorder(this.getWorldBorder(), p_72945_1_);
                        if (var12 && var13) {
                            p_72945_1_.setOutsideBorder(false);
                        }
                        else if (!var12 && !var13) {
                        ...
                        IBlockState var14;
                        if (!this.getWorldBorder().contains(var11) && var13) {
                            var14 = Blocks.stone.getDefaultState();
                        }
                        else {
                            var14 = this.getBlockState(var11);
                        }
                        var14.getBlock().addCollisionBoxesToList(this, var11, var14, p_72945_2_, var, p_72945_1_);
                    }
                }
            }
        }
    ...
    public boolean handleMaterialAcceleration(AxisAlignedBB p_72918_1_, Material p_72918_2_, Entity p_72918_3_)
    {
        ...
        else
        {
            ...
            if (var11.lengthVector() > 0.0D && p_72918_3_.isPushedByWater())
            {
                ...
                double var20 = 0.014D;
                //TODO: Client - No water push
                boolean waterPush = p_72918_3_ == Minecraft.getMinecraft().thePlayer &&
                        (Pandora.getModManager().getModState("NoVelocity") || Pandora.getModManager().getModState("NoSlow"));
                if(!waterPush || !(p_72918_3_ instanceof EntityPlayerSP)) {
