...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public float func_180471_a(Block p_180471_1_)
    {
        ...
        if(Pandora.getModManager().getModState("SpeedMine") || Pandora.getModManager().getModState("NoSlow"))
            return var2;
    ...
    public void attackTargetEntityWithCurrentItem(Entity targetEntity)
    {
        if (targetEntity.canAttackWithItem())
        {
            ...
            {
                float var2 = (float)this.getEntityAttribute(SharedMonsterAttributes.attackDamage).getAttributeValue() * 1.05f;
                byte var3 = 0;
                float var4 = 0.0F;
                ...
                if (var2 > 0.0F || var4 > 0.0F)
                {
                    ...
                    if (var14)
                    {
                        if (var18 > 0 && !Pandora.getModManager().getModState("NoSlow"))
                        {
