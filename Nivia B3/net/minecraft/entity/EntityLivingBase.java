...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void updatePotionEffects()
    {
    	...
    	for (Object o : this.activePotionsMap.keySet()) {
    		Integer var2 = (Integer) o;
            ...
            else/* if (var3.getDuration() % 2 == 0)*/
            {
            	PotionEffect effect = var3;
    ...
    protected void onChangedPotionEffect(PotionEffect p_70695_1_, boolean p_70695_2_)
    {
        ...
        //Logger.logChat(this.getName() + " recieved a new potion effect: " + p_70695_1_.getEffectName() + " d");
        if (p_70695_2_ && !this.worldObj.isRemote)
        {
            //Logger.logChat(this.getName() + " recieved a new potion effect: " + p_70695_1_.getEffectName() + " e");
    ...
    {
    	if(Pandora.getModManager().getModState("NoVelocity") || Pandora.getModManager().getModState("NoSlow"))
    		return;
    ...
    public void dismountEntity(Entity p_110145_1_)
    {
        ...
        double var5 = p_110145_1_.getEntityBoundingBox().minY + (double)p_110145_1_.height - 5.8;
