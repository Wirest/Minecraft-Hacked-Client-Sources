...
public abstract class Entity implements ICommandSender
{
    ...
    public static double stepModule;
    ...
    {
        Pandora.getEventManager().call(new EventEntityBoundingBox());
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            //This method is used for all entities
            if (this == Minecraft.getMinecraft().thePlayer) {
                Scaffold s = (Scaffold) Pandora.getModManager().getModule(Scaffold.class);

                boolean scaffold = this instanceof EntityPlayerSP && Pandora.getModManager().getModState("Scaffold") && (s.Switch.value ? true : (Helper.player().getCurrentEquippedItem() != null && Helper.player().getCurrentEquippedItem().getItem() instanceof ItemBlock));

                var19 = this.onGround && (this.isSneaking() || scaffold) && this instanceof EntityPlayer;;
            }
            ...
            boolean canStep = (this.stepHeight > 0.0F) && (var54) && ((var13 != x) || (var17 != z)) &&
                    (this != Minecraft.getMinecraft().thePlayer || !Pandora.getModManager().getModState("Phase"));
            if (canStep) {
                double var56 = x;
                double var25 = y;
                double var27 = z;
                ...
                var31 = var31.offset(0.0D, var33, 0.0D); //TODO: HERE
                double var67 = var13;
                AxisAlignedBB var38;
                ...
                if (var56 * var56 + var27 * var27 >= x * x + z * z || (this == Minecraft.getMinecraft().thePlayer && Pandora.getModManager().getModState("Step")))
                {
                    x = var56;
                    y = var25;
                    z = var27;
                    ...
                    if(this == Minecraft.getMinecraft().thePlayer && Pandora.getModManager().getModState("Step")){
                        if ((stepHeight > 0.0F) && (var54) && ((var13 != x) || (var17 != z))){
                            ...
                            this.func_174826_a(var21);
                            y = stepHeight;
                            List var301 = worldObj.getCollidingBoundingBoxes(this, getEntityBoundingBox().addCoord(var13, y, var17));
                            ...
                            this.func_174826_a(getEntityBoundingBox().offset(0.0D, y, 0.0D));
                            ...
                            double distanceToStep = this.getEntityBoundingBox().minY - var291.minY;
                            if(distanceToStep >= 0.6){
                                Timer.timerSpeed = 0.000005F;
                                if(distanceToStep == 1.5) {
                                    Helper.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(Helper.mc().thePlayer.posX, Helper.mc().thePlayer.posY + 0.42D, Helper.mc().thePlayer.posZ, Helper.mc().thePlayer.onGround));
                                    Helper.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(Helper.mc().thePlayer.posX, Helper.mc().thePlayer.posY + 0.75D, Helper.mc().thePlayer.posZ, Helper.mc().thePlayer.onGround));
                                    Helper.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(Helper.mc().thePlayer.posX, Helper.mc().thePlayer.posY + 1.0D, Helper.mc().thePlayer.posZ, Helper.mc().thePlayer.onGround));
                                    Helper.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(Helper.mc().thePlayer.posX, Helper.mc().thePlayer.posY + 1.16D, Helper.mc().thePlayer.posZ, Helper.mc().thePlayer.onGround));
                                    Helper.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(Helper.mc().thePlayer.posX, Helper.mc().thePlayer.posY + 1.25D, Helper.mc().thePlayer.posZ, Helper.mc().thePlayer.onGround));
                                    Helper.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(Helper.mc().thePlayer.posX, Helper.mc().thePlayer.posY + 1.2D, Helper.mc().thePlayer.posZ, Helper.mc().thePlayer.onGround));
                                    Helper.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(Helper.mc().thePlayer.posX, Helper.mc().thePlayer.posY + 1.4D, Helper.mc().thePlayer.posZ, Helper.mc().thePlayer.onGround));
                                } else {
                                    boolean steppingChests = distanceToStep == 0.87500 || distanceToStep == 0.81250;
                                    Helper.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(Helper.mc().thePlayer.posX, Helper.mc().thePlayer.posY + 0.42, Helper.mc().thePlayer.posZ, true));
                                    Helper.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(Helper.mc().thePlayer.posX, Helper.mc().thePlayer.posY + 0.7541999805212, Helper.mc().thePlayer.posZ, true));
                                    Step.Delay = 0;
                                }
                                Timer.timerSpeed = 1F;
                            }
                            if(distanceToStep >= 0.6 && (this == Minecraft.getMinecraft().thePlayer && ((Step) Pandora.getModManager().getModule(Step.class)).stepMode.value == StepMode.OLD))
                                this.func_174826_a(this.getEntityBoundingBox().offset(0.0D, stepModule, 0.0D));
                        }
                    }
                }
            }
    ...
    {
        if(this == Minecraft.getMinecraft().thePlayer && NoSlow.waterNoSlow()) return false;
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        boolean speed = false && Pandora.getModManager().getModState("Speed") && Helper.player() != null && this.equals(Helper.player());
        float var41 = strafe * strafe + forward * forward;
        if (var41 >= 1.0E-4F) {
            var41 = MathHelper.sqrt_float(var41);
            if (var41 < 1.0F) {
                var41 = 1.0F;
            }

            var41 = friction / var41;
            strafe *= var41;
            forward *= var41;
            float var51 = MathHelper.sin(this.rotationYaw * 3.1415927F / 180.0F);
            float var6 = MathHelper.cos(this.rotationYaw * 3.1415927F / 180.0F);
            this.motionX += (double) (strafe * var6 - forward * var51);
            this.motionZ += (double) (forward * var6 + strafe * var51);
        }
    }
