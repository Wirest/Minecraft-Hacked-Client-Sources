...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void func_175068_a(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        if (!handRendered && this.field_175074_C && !Shaders.isShadowPass)
        {
          ...
          //TODO: Client Event - Render3D
            Pandora.getEventManager().call(new Event3D(partialTicks));
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof PandoraMainMenu)
        {
            this.updateMainMenu((PandoraMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(PandoraMainMenu mainGui)
    {
        try
        {
            String e = null;
            ...
            Field[] fs = PandoraMainMenu.class.getDeclaredFields();
