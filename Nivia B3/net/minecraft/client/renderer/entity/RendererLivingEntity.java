...
import nivia.modules.render.Chams;
...
public abstract class RendererLivingEntity extends Render
{
    ...
    {
        Chams esp = (Chams) Pandora.getModManager().getModule(Chams.class);
        boolean renderChams = esp.isValidTarget(p_76986_1_) && esp.getState();
        if(renderChams) {
            GL11.glEnable(32823);
    ...
    {
    	if(Pandora.getModManager().getModState("Nametags") && p_77033_1_ instanceof EntityPlayer)
    		return;
