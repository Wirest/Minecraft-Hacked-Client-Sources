...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new PandoraMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new PandoraMainMenu());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new PandoraMainMenu();
        }
        ...
        if (guiScreenIn instanceof PandoraMainMenu)
        {
    ...
    private void runGameLoop() throws IOException
    {
        ...
        while (getSystemTime() >= this.debugUpdateTime + 1000L)
        {
            ...
            this.debug = Math.round(debugFPS) + " fps (" + RenderChunk.field_178592_a + " chunk updates) " + String.valueOf(this.gameSettings.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax() ? "inf" : Integer.valueOf(this.gameSettings.limitFramerate)) + (this.gameSettings.fancyGraphics ? "" : " fast") + (this.gameSettings.clouds ? " clouds" : "") + (OpenGlHelper.func_176075_f() ? " vbo" : "");
    ...
    public void runTick() throws IOException
    {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        //TODO: Client Event - KeyPress
                        Pandora.getEventManager().call(new EventKeyPress(var1));
        ...
        //TODO: Client Event - Tick
        Pandora.getEventManager().call(new EventTick());
        this.mcProfiler.endSection();
    ...
    public void setEntityMain(EntityPlayer e) {
        this.field_175622_Z = e;
    }
