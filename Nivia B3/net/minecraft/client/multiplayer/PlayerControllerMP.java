...
import nivia.events.events.EventAttack;
...
public class PlayerControllerMP
{
    ...
    public boolean func_180512_c(BlockPos p_180512_1_, EnumFacing p_180512_2_)
    {
        ...
        else if ((this.currentGameType.isCreative() || (Pandora.getModManager().getModState("Freecam"))) && this.mc.theWorld.getWorldBorder().contains(p_180512_1_))
        {
            this.blockHitDelay = 5;
    ...
    {
        return this.currentGameType.isCreative() ? 5.0F : (Pandora.getModManager().getModState("Teleport") ? 100 : 4.5F);
    }
    ...
    public boolean sendUseItem(EntityPlayer playerIn, World worldIn, ItemStack itemStackIn)
    {
        ...
        else
        {
            ...
            int var4 = itemStackIn.stackSize - 1;
    ...
    {
        this.syncCurrentPlayItem();
        //TODO: Client Event - Attack
        Pandora.getEventManager().call(new EventAttack(targetEntity));
