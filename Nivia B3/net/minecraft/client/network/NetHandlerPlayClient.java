...
if(var2 instanceof EntityPlayerSP )return;
        if (var2 != null)
        {
    ...
    public void onDisconnect(IChatComponent reason)
    {
        ...
        {
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new PandoraMainMenu()), "disconnect.lost", reason));
        }
    }
        ...
        if (var2 != null)
        {
            ...
            else
            {
                ...
                while (var4.hasNext())
                {
                    ...
                    var6.setBaseValue(var5.func_151410_b() * 1.025);
