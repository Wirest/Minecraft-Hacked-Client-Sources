...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void moveEntity(final double x, final double y, final double z) {
        ...
        Pandora.getEventManager().call(event);
    ...
    public void func_175161_p()
    {
    	...
    	EventPreMotionUpdates e = new EventPreMotionUpdates(rotationYaw, rotationPitch, posX, posY, posZ, mc.thePlayer.onGround);
    	EventPostMotionUpdates post = new EventPostMotionUpdates(rotationYaw, rotationPitch);
    	Pandora.getEventManager().call(e);
    	if(e.isCancelled()){
    		Pandora.getEventManager().call(post);
    		return;
    	}
        ...
        if(this.func_175160_A()) {
            ...
            if(this.ridingEntity == null) {
                if(var13 && var14) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.posX, e.getY(), this.posZ, this.rotationYaw, this.rotationPitch, e.isGround()));
                } else if(var13) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(this.posX, e.getY(), this.posZ, e.isGround()));
                } else if(var14) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(this.rotationYaw, this.rotationPitch, e.isGround()));
                } else {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer(e.isGround()));
                }
            } else {
...
//        this.pushOutOfBlocks(this.posX + (double)this.width * 0.35D, this.getEntityBoundingBox().minY + 0.5D, this.posZ + (double)this.width * 0.35D);
        ...
        if (this.onGround && !var2 && !var4 && this.movementInput.moveForward >= var3 && !this.isSprinting() && var5  && !this.isPotionActive(Potion.blindness))
        {
        ...
        if (!this.isSprinting() && this.movementInput.moveForward >= var3 && var5  && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSprint.getIsKeyPressed())
        {
            this.setSprinting(true);
        }
