...
import nivia.modules.miscellanous.InventoryCleaner;
...
import nivia.modules.miscellanous.InventoryMove;
import nivia.modules.miscellanous.Scaffold;
 
public abstract class GuiContainer extends GuiScreen
{
    /** The location of the inventory background texture */
    protected static ResourceLocation inventoryBackground = new ResourceLocation("textures/gui/container/inventory.png");
    ...
    protected Set dragSplittingSlots = Sets.newHashSet();
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(1337, (scaledResolution.getScaledWidth()/3) +10, scaledResolution.getScaledHeight() - 21, 300, 20, "Disable Aura & ChestStealer & Inventory Cleaner"));
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        for (Object object : this.buttonList) {
            ...
            if (guiButton.mousePressed(this.mc, mouseX, mouseY)) {
                Pandora.getModManager().getModule(KillAura.class).setState(false);
                Pandora.getModManager().getModule(Scaffold.class).setState(false);
                Pandora.getModManager().getModule(InventoryMove.class).setState(true);
                Pandora.getModManager().getModule(InventoryCleaner.class).setState(false);
                Pandora.getModManager().getModule(ChestStealer.class).setState(false);
            }
        }
