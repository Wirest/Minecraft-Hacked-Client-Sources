...
public class ItemRenderer {
	...
	// If the custom sword block animation module is turned on
	public static boolean customSwordBlockAnimation = false;
		...
		if (this.itemToRender != null) {
			if (this.itemToRender.getItem() instanceof ItemMap) {
				...
				case 4:
					...
					if (customSwordBlockAnimation) {

						EventSwordBlockAnimation e = new EventSwordBlockAnimation();
