...
public class Gui
{
    ...
    public static void drawRect(double left, double d, double right, double e, int color)
    {
        ...
        worldrenderer.pos((double)left, (double)e, 0.0D).endVertex();
        worldrenderer.pos((double)right, (double)e, 0.0D).endVertex();
     ...
     */
    public void drawCenteredString(FontRenderer fontRendererIn, String text, float f, float y, int color)
    {
