...
public class GuiChest extends GuiContainer
{
    ...
    public void initGui() {
    	...
    	EventOpenChest event = new EventOpenChest(this);
    ...
    public void spicyHandleMouseInput(Slot slotIn, int slotId, int clickedButton, int clickType) {
    	this.handleMouseClick(slotIn, slotId, clickedButton, clickType);
    }
