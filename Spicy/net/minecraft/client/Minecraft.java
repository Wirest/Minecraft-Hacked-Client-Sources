...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException
    {
		...
		SpicyClient.config = new Config("Default");
		SpicyClient.loadConfig(SpicyClient.config);
		
        Display.setTitle("Starting " + SpicyClient.config.clientName + SpicyClient.config.clientVersion + "...");
