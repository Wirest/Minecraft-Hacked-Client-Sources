...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
    	...
    	this.motionX = event.motionX;
    	this.motionY = event.motionY;
    	this.motionZ = event.motionZ;
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(event.motionX, -999.0D, event.motionZ, event.getYaw(), event.getPitch(), event.isOnGround()));
                flag2 = false;
            }
    ...
    {
    	EventChatmessage chat = new EventChatmessage();
    	chat.setType(EventType.PRE);
    	chat.setMessage(message);
    	SpicyClient.onEvent(chat);
