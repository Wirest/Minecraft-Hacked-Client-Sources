...
public abstract class EntityLivingBase extends Entity
{
    ...
    public boolean isOnLadder()
    {
        ...
        EventOnLadder e = new EventOnLadder();
        e.onLadder = (block == Blocks.ladder || block == Blocks.vine) && (!(this instanceof EntityPlayer) || !((EntityPlayer)this).isSpectator());
        e.setType(EventType.POST);
        SpicyClient.onEvent(e);
        if (e.canceled) {
        	
        }else {
        	if (e.onLadder == (block == Blocks.ladder || block == Blocks.vine) && (!(this instanceof EntityPlayer) || !((EntityPlayer)this).isSpectator())) {
