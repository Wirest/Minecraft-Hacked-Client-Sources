...
public class ElementSlider extends Element {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		 ...
		 */
		Gui.drawRect(x, y, x + width, y + height, 0xff909090);
		...
		Gui.drawRect(x, y + 12, x + (percentBar * width), y + 13.5, 0xff000000);
		
		if(percentBar > 0 && percentBar < 1)
		Gui.drawRect(x + (percentBar * width)-1, y + 12, x + Math.min((percentBar * width), width), y + 13.5, 0xffffffff);
