...
public class PlayerControllerMP
{
    ...
    public void onPlayerRightClick2(EntityPlayerSP player, WorldClient worldIn, ItemStack heldStack, BlockPos hitPos, EnumFacing side, Vec3d hitVec) {
    	this.onPlayerRightClick(player, worldIn, heldStack, hitPos, side, new Vec3(hitVec.xCoord, hitVec.yCoord, hitVec.zCoord));
    }
