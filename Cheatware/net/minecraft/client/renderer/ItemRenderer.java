        ...
        if (this.itemToRender != null)
        {
            ...
            else if (abstractclientplayer.getItemInUseCount() > 0)
            {
                ...
                switch (enumaction)
                {
                    ...
                    case BLOCK:
                    	final float f6 = MathHelper.sin((float)(MathHelper.sqrt_float(f1) * 3.1));
                   	 String mode = Cheatware.instance.settingsManager.getSettingByName("Animation Mode").getValString();
                     	 Cheatware.instance.moduleManager.getModuleByName("Animations").setDisplayName("Animations §7" + mode);
                   	  ...
                   	  if(mode.equalsIgnoreCase("Sigma")) {
                   		  this.transformFirstPersonItem(f * 0.5f, -2.0f);
                             GlStateManager.rotate(-f6 * 55.0f / 2.0f, -8.0f, -0.0f, 9.0f);
                             GlStateManager.rotate(-f6 * 45.0f, 1.0f, f6 / 2.0f, -0.0f);
                             this.func_178103_d();
                   	  ...
                   	  if(mode.equalsIgnoreCase("Tap")) {
                   		  this.transformFirstPersonItem(-0.2f, f1 - 1.0f);
                   	  ...
                   	  if(mode.equalsIgnoreCase("Slide")) {
               			this.transformFirstPersonItem(f, 0.0F);
                           this.func_178103_d();
                           final float var19 = MathHelper.sin((float) (Math.sqrt(f1) * 3.1415927f));
                           GlStateManager.translate(0, 0, 0.5F);
                           GlStateManager.rotate(-var19 * (float) 70.0 / 1.78789789f, -8.0f, -0.0f, 9.0f);
                           GlStateManager.rotate(-var19 * (float) 70.0, 1.5f, -0.5f, -0.2f);
                   	  }
                   	 
                   	  if(mode.equalsIgnoreCase("Ambitious")) {
                   		  this.transformFirstPersonItem(f, 0);
                             this.func_178103_d();
                             GlStateManager.translate(-0.5, 0, 0.5);
                             GlStateManager.rotate(rotate, 0, rotate, rotate);
                   	  }
                   	  
                   	  if(mode.equalsIgnoreCase("Cheatware")) {
                   		  this.transformFirstPersonItem(f, f1 /5 );
                          this.func_178103_d();
                   	  }
                   	  rotate++;
                        break;
