...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        EventPreMotionUpdate eventPreMotionUpdate = new EventPreMotionUpdate(this.rotationYaw, this.rotationPitch, this.lastReportedYaw, this.lastReportedPitch, this.onGround, this.posX, this.posY, this.posZ);
    ...
    public void onLivingUpdate()
    {
        ...
        {
        	if(!Cheatware.instance.moduleManager.getModuleByName("NoSlow").isToggled()) {
