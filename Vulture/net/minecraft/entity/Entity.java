...
public abstract class Entity implements ICommandSender
{
    ...
    public void setAngles(float yaw, float pitch)
    {
        ...
        if (!Client.INSTANCE.getModuleManager().getModuleByClass(NoPitchLimit.class).isEnabled()) {
    ...
    public void setPositionAndRotation(BlockPos pos, float yaw, float pitch)
    {
    	setPositionAndRotation(pos.getX(), pos.getY(), pos.getZ(), yaw, pitch);
    }
