...
public class RealmsSliderButton extends RealmsButton
{
    ...
    public void renderBg(int p_renderBg_1_, int p_renderBg_2_)
    {
        if (this.getProxy().visible)
        {
            ...
            this.blit((int)(this.getProxy().xPosition + (this.value * (float)(this.getProxy().getButtonWidth() - 8))), (int) this.getProxy().yPosition, 0, 66, 4, 20);
            this.blit((int)(this.getProxy().xPosition + (this.value * (float)(this.getProxy().getButtonWidth() - 8)) + 4), (int) this.getProxy().yPosition, 196, 66, 4, 20);
        }
    }
