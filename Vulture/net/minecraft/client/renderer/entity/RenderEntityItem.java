...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    private int func_177077_a(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_)
    {
    	...
    	final ItemPhysics physics = (ItemPhysics) Client.INSTANCE.getModuleManager().getModuleByClass(ItemPhysics.class);
        ...
        else
        {
            ...
            if (flag || this.renderManager.options != null)
            {
                ...
                if (Client.INSTANCE.getModuleManager().getModuleByClass(RenderChanger.class).isEnabled() && !physics.isEnabled() && Client.INSTANCE.getModuleManager().getModuleByClass(RenderChanger.class).getValueByName("RenderChangerItem to view").getBooleanValue()) {
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    	...
    	if (Client.INSTANCE.getModuleManager().getModuleByClass(Chams.class).isEnabled() && Client.INSTANCE.getModuleManager().getModuleByClass(Chams.class).getValueByName("ChamsItems").getBooleanValue()) {
