...
public class ModelBiped extends ModelBase
{
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        else
        {
            ...
            if (changer.isEnabled() && changer.getValueByName("RenderChangerBig heads").getBooleanValue()) {
            	GL11.glPushMatrix();
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn)
    {
        ...
        float rotationPitchHead = (entityIn instanceof EntityPlayerSP ? ((EntityPlayerSP) entityIn).rotationPitchHead + (((EntityPlayerSP) entityIn).rotationPitchHead - ((EntityPlayerSP) entityIn).prevRotationPitchHead) * Minecraft.getMinecraft().timer.renderPartialTicks : p_78087_5_);
        this.bipedHead.rotateAngleX = rotationPitchHead / (180F / (float)Math.PI);
