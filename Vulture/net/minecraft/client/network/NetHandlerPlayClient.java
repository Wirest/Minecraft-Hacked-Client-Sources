...
import de.iotacb.client.events.world.EntityMovementEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityMovement(S14PacketEntity packetIn)
    {
        ...
        if (entity != null)
        {
        	EventManager.call(new EntityMovementEvent(entity));
    ...
    {
    	final PacketEvent event = new PacketEvent(packet, PacketState.SEND);
    ...
    public void addToSendQueue2(Packet packet)
    {
        this.netManager.sendPacket(packet);
    }
