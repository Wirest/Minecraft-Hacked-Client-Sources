...
import de.iotacb.client.events.input.KeyPressedEvent;
...
import de.iotacb.client.gui.login.GuiClientLogin;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(Client.INSTANCE.getClientName() + " " + Client.INSTANCE.getClientVersion());
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
                inputstream = getResourceStream(new ResourceLocation("client/icons/icon_16x16.png"));
                inputstream1 = getResourceStream(new ResourceLocation("client/icons/icon_32x32.png"));
...
//            this.ingameGUI.getChatGUI().clearChatMessages();
    ...
    private void runGameLoop() throws IOException
    {
    	...
    	Client.DELTA_UTIL.deltaTime = deltaTime;
    ...
    {
    	EventManager.call(new MouseEvent(0));
        if (this.leftClickCounter <= 0)
        {
            ...
            else
            {
                ...
                {
                    case ENTITY:
                    	final Friends friends = (Friends) Client.INSTANCE.getModuleManager().getModuleByClass(Friends.class);
                    	if (Client.INSTANCE.getFriendManager().isFriend(this.objectMouseOver.entityHit) && friends.isEnabled()) {
                    		if (friends.getValueByName("FriendsCancel attacks").getBooleanValue()) {
                    			break;
                    		}
                    	}
    ...
    {
    	EventManager.call(new MouseEvent(1));
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                } else if (Keyboard.isKeyDown(Keyboard.KEY_W) && Keyboard.isKeyDown(Keyboard.KEY_M) && Keyboard.isKeyDown(Keyboard.KEY_D) && Keyboard.isKeyDown(Keyboard.KEY_LCONTROL)) {
                	/**
                	 * THIS IS JUST FOR A MEME
                	 */
                	Client.PRINTER.printMessage("Wie macht man das?");
                }
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	Client.INSTANCE.getModuleManager().toggleModules(k);
    ...
    {
    	EventManager.call(new WorldLoadEvent(worldClientIn));
    ...
    {
    	EventManager.call(new MouseEvent(2));
        if (this.objectMouseOver != null)
        {
    ...
    public <V> ListenableFuture<V> addScheduledTask(Callable<V> callableToSchedule)
    {
        ...
        {
            final ListenableFutureTask<V> listenablefuturetask = ListenableFutureTask.<V>create(callableToSchedule);
