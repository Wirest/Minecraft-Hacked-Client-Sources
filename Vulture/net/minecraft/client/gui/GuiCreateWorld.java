...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.field_146344_y)
        {
            ...
            {
                this.fontRendererObj.drawSplitString(I18n.format(WorldType.worldTypes[this.selectedIndex].func_151359_c(), new Object[0]), (int)(this.btnMapType.xPosition + 2), (int)(this.btnMapType.yPosition + 22), (int)this.btnMapType.getButtonWidth(), 10526880);
            }
        }
        else
        {
