...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(147, this.width / 2 + 160, this.height - 28, 75, 20, "Alt login"));
        this.buttonList.add(new GuiButton(148, this.width / 2 - 280, this.height - 28, 120, 20, "Change IP (FritzBox)"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button.id == 147) {
            	mc.displayGuiScreen(new GuiAltManager(this));
            } else if (button.id == 148) {
    ...
    {
    	if (keyCode == Client.INSTANCE.getModuleManager().getModuleByClass(ClickGui.class).getKey() && !Keyboard.isKeyDown(Keyboard.KEY_LCONTROL)) {
    		mc.displayGuiScreen(new GuiAltManager(this));
    	}
    	if (keyCode == Keyboard.KEY_R && Keyboard.isKeyDown(Keyboard.KEY_LCONTROL) && Keyboard.isKeyDown(Keyboard.KEY_LMENU)) {
    		Client.FRITZ_BOX_UTIL.reconnect();
    	}
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.serverListSelector.drawScreen(mouseX, mouseY, partialTicks, true);
//        this.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.title", new Object[0]), this.width / 2, 20, 16777215);
        Client.INSTANCE.getFontManager().getDefaultFont().drawCenteredStringWithShadow(I18n.format("multiplayer.title", new Object[0]), this.width / 2, 20, Color.white);
