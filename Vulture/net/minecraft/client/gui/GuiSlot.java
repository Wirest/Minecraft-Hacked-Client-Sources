...
public abstract class GuiSlot
{
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_) {
    	drawScreen(mouseXIn, mouseYIn, p_148128_3_, false);
    }

    public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_, boolean cut)
    {
        if (this.field_178041_q)
        {
            ...
            Client.BLUR_UTIL.blur(k, top, i - k, bottom - top, 5);
            Client.RENDER2D.rect(k, top, i - k, bottom - top, new Color(20, 20, 20, 200));
            this.drawSelectionBox(k, l, mouseXIn, mouseYIn);
            GlStateManager.disableDepth();
            int i1 = 4;
            Client.BLUR_UTIL.blur(0, 0, width, top, 5);
            Client.BLUR_UTIL.blur(0, bottom, width, height, 5);
            Client.RENDER2D.rect(0, 0, width, top, new Color(20, 20, 20));
            Client.RENDER2D.rect(0, bottom - 1, width, height, new Color(20, 20, 20));
            ...
            if (j1 > 0)
            {
                ...
                Client.RENDER2D.rect(i, top + 2.5, 5, bottom - top - 5, new Color(40, 40, 40));
                Client.RENDER2D.circle(i, top, 5, new Color(40, 40, 40));
                Client.RENDER2D.circle(i, bottom - 6, 5, new Color(40, 40, 40));
                
                Client.RENDER2D.rect(i, l1 + 2.5, 5, k1 - 5, new Color(200, 200, 200));
                Client.RENDER2D.circle(i, l1, 5, new Color(200, 200, 200));
                Client.RENDER2D.circle(i, l1 + k1 - 6, 5, new Color(200, 200, 200));
            }
        }
    }
    ...
    protected void drawSelectionBox(int p_148120_1_, int p_148120_2_, int mouseXIn, int mouseYIn)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            if (this.showSelectionBox && this.isSelected(j))
            {
            	...
            	Client.RENDER2D.gradientSideways(i1 + 2, k - 3, j1 - i1 + 2, l + 3, new Color(20, 20, 20), Client.INSTANCE.getClientColor().setAlpha(100));
            }
