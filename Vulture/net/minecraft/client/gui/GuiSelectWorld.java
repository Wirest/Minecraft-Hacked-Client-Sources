...
//        this.drawCenteredString(this.fontRendererObj, this.field_146628_f, this.width / 2, 20, 16777215);
        Client.INSTANCE.getFontManager().getDefaultFont().drawCenteredStringWithShadow(this.field_146628_f, this.width / 2, 20, Color.white);
    ...
    class List extends GuiSlot
    {
        ...
        {
            GuiSelectWorld.this.drawDefaultBackground(mouseX, mouseY);
        }
...
//            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, s2, p_180791_2_ + 2, p_180791_3_ + 12 + 10, 8421504);
            Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow(s, p_180791_2_ + 2, p_180791_3_ + 1, Color.white);
            Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow(s1, p_180791_2_ + 2, p_180791_3_ + 12, Color.lightGray);
            Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow(s2, p_180791_2_ + 2, p_180791_3_ + 12 + 10, Color.gray);
        }
    }
}
