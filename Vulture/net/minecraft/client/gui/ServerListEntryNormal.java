...
//        this.mc.fontRendererObj.drawString(this.field_148301_e.serverName, x + 32 + 3, y + 1, 16777215);
        Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow(field_148301_e.serverName, x + 34, y + 1, Color.white);
...
//            this.mc.fontRendererObj.drawString((String)list.get(i), x + 32 + 3, y + 12 + this.mc.fontRendererObj.FONT_HEIGHT * i, 8421504);
        	 Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow((String)list.get(i), x + 32 + 2, y + 12 + this.mc.fontRendererObj.FONT_HEIGHT * i, Color.white);
        }
...
//        int j = this.mc.fontRendererObj.getStringWidth(s2);
        int j = (int) Client.INSTANCE.getFontManager().getDefaultFont().getWidth(s2);
//        this.mc.fontRendererObj.drawString(s2, x + listWidth - j - 15 - 2, y + 1, 8421504);
        Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow(s2, x + listWidth - j - 15 - 2, y + 1, Color.white);
        int k = 0;
        String s = null;
        int l;
        String s1;
...
//        Gui.drawModalRectWithCustomSizedTexture(x + listWidth - 15, y, (float)(k * 10), (float)(176 + l * 8), 10, 8, 256.0F, 256.0F);
        ...
        {
            this.func_178012_a(x, y - 1, this.field_148306_i);
        }
        else
        {
            this.func_178012_a(x, y - 1, UNKNOWN_SERVER);
        }
        ...
        {
            Client.RENDER2D.color(new BetterColor(100, 100, 100));
            if (this.field_148305_h != null)
            {
                this.func_178012_a(x, y - 1, this.field_148306_i);
            }
    ...
    private void drawPing(double x, double y, int state) {
//    	Gui.drawModalRectWithCustomSizedTexture(x + listWidth - 15, y, (float)(k * 10), (float)(176 + l * 8), 10, 8, 256.0F, 256.0F);
    	switch (state) {
		case 0:
			Client.RENDER2D.line(x, y + 5, x + 4, y + 10, 2, Color.green);
			Client.RENDER2D.line(x + 12, y, x + 4, y + 10, 2, Color.green);
			break;

		case 1:
//			Client.RENDER2D.rect(x, y, 10, 10, Color.green);
			Client.RENDER2D.line(x, y + 5, x + 4, y + 10, 2, new Color(220, 200, 50));
			Client.RENDER2D.line(x + 12, y, x + 4, y + 10, 2, new Color(220, 200, 50));
			break;
			
		case 2:
//			Client.RENDER2D.rect(x, y, 10, 10, Color.green);
			Client.RENDER2D.line(x, y + 5, x + 10, y + 5, 2, Color.orange);
			break;
			
		case 3:
//			Client.RENDER2D.rect(x, y, 10, 10, Color.green);
			Client.RENDER2D.line(x, y, x + 10, y + 10, 2, new Color(220, 200, 50));
			Client.RENDER2D.line(x + 10, y, x, y + 10, 2, new Color(220, 200, 50));
			break;
			
		case 4:
			Client.RENDER2D.line(x, y, x + 10, y + 10, 2, new Color(250, 200, 50));
			Client.RENDER2D.line(x + 10, y, x, y + 10, 2, new Color(250, 200, 50));
			break;
			
		case 5:
			Client.RENDER2D.line(x, y, x + 10, y + 10, 2, Color.red);
			Client.RENDER2D.line(x + 10, y, x, y + 10, 2, Color.red);
			break;
			
		case 6:
			Client.RENDER2D.circle(x, y + 4, 2, Color.white);
			Client.RENDER2D.circle(x + 4, y + 4, 2, Color.white);
			Client.RENDER2D.circle(x + 8, y + 4, 2, Color.white);
			break;
		}
    }
