...
//        this.mc.fontRendererObj.drawString(I18n.format("lanServer.title", new Object[0]), x + 32 + 3, y + 1, 16777215);
    	Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow(I18n.format("lanServer.title", new Object[0]), x + 34, y + 1, Color.white);
//        this.mc.fontRendererObj.drawString(this.field_148291_b.getServerMotd(), x + 32 + 3, y + 12, 8421504);
    	Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow(this.field_148291_b.getServerMotd(), x + 32 + 2, y + 12, Color.lightGray);
...
//            this.mc.fontRendererObj.drawString(I18n.format("selectServer.hiddenAddress", new Object[0]), x + 32 + 3, y + 12 + 11, 3158064);
        	Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow(I18n.format("selectServer.hiddenAddress", new Object[0]), x + 32 + 2, y + 12 + 11, Color.gray);
        }
        else
        {
//            this.mc.fontRendererObj.drawString(this.field_148291_b.getServerIpPort(), x + 32 + 3, y + 12 + 11, 3158064);
            Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow(this.field_148291_b.getServerIpPort(), x + 32 + 3, y + 12 + 11, Color.gray);
        }
    }
