...
public class GuiLanguage extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        final String title = I18n.format("options.language", new Object[0]);
//        this.drawCenteredString(this.fontRendererObj, I18n.format("options.language", new Object[0]), this.width / 2, 16, 16777215);
        Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow(title, (width - Client.INSTANCE.getFontManager().getDefaultFont().getWidth(title)) / 2, 10, Color.white);
        final String warning = "(" + I18n.format("options.languageWarning", new Object[0]) + ")";
//        this.drawCenteredString(this.fontRendererObj, "(" + I18n.format("options.languageWarning", new Object[0]) + ")", this.width / 2, this.height - 56, 8421504);
        Client.INSTANCE.getFontManager().getDefaultFont().drawStringWithShadow(warning, (width - Client.INSTANCE.getFontManager().getDefaultFont().getWidth(warning)) / 2, this.height - 56, Color.gray);
    ...
    class List extends GuiSlot
    {
        ...
        {
            GuiLanguage.this.drawDefaultBackground(mouseX, mouseY);
        }
