...
public class GuiChat extends GuiScreen
{
    ...
    public void initGui()
    {
    	animUtil = new AnimationUtil(Expo.class);
        Keyboard.enableRepeatEvents(true);
        this.sentHistoryCursor = this.mc.ingameGUI.getChatGUI().getSentMessages().size();
        this.inputField = new GuiTextField(0, this.fontRendererObj, 4, this.height - 12, this.width - 4, 12);
        this.inputField.setMaxStringLength(1000000000);
    ...
    {
    	animatedWidth = animUtil.easeOut(0, 0, calculateChatboxWidth(mc.gameSettings.chatWidth) / mc.gameSettings.chatScale + 6, 1);
    	Client.RENDER2D.rect(0, this.height - 14, animatedWidth, 12, new Color(20, 20, 20, 200));
