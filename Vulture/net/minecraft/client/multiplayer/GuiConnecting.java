...
public class GuiConnecting extends GuiScreen
{
    ...
    private final ParticleManager pManager = new ParticleManager();
...
//            this.drawCenteredString(this.fontRendererObj, I18n.format("connect.connecting", new Object[0]), this.width / 2, this.height / 2 - 50, 16777215);
            Client.INSTANCE.getFontManager().getDefaultFont().drawCenteredStringWithShadow(I18n.format("connect.connecting", new Object[0]), this.width / 2, this.height / 2 - 50, Color.white);
        }
        else
        {
//            this.drawCenteredString(this.fontRendererObj, I18n.format("connect.authorizing", new Object[0]), this.width / 2, this.height / 2 - 50, 16777215);
        	Client.INSTANCE.getFontManager().getDefaultFont().drawCenteredStringWithShadow(I18n.format("connect.authorizing", new Object[0]), this.width / 2, this.height / 2 - 50, Color.white);
        }
