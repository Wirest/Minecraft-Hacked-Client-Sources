...
public class Block
{
    ...
    {
    	final GhostHand hand = (GhostHand) Client.INSTANCE.getModuleManager().getModuleByClass(GhostHand.class);
    	
    	if (hand.isEnabled() && !(getIdFromBlock(this) == getIdFromBlock(Blocks.chest)) && !(getIdFromBlock(this) == getIdFromBlock(Blocks.trapped_chest)) && !(getIdFromBlock(this) == getIdFromBlock(Blocks.ender_chest)) && !(getIdFromBlock(this) == getIdFromBlock(Blocks.barrier))) {
    		return false;
    	}
