...
public class MovementUtil {
    ...
    public final double getYaw(boolean strafing) {
        float rotationYaw = strafing && Client.INSTANCE.getModuleManager().getModuleByClass(Aura.class).getValueByName("AuraStrafing").getBooleanValue() ? MC.thePlayer.rotationYawHead : MC.thePlayer.rotationYaw;
        float forward = 1F;
