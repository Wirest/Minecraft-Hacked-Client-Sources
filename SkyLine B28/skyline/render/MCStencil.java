...
public class MCStencil {
    ...
    public static void checkSetupFBO() {
        ...
        Framebuffer fbo = Mineman.getMinecraft().getFramebuffer();
    ...
    public static void setupFBO(Framebuffer fbo) {
        ...
        EXTFramebufferObject.glRenderbufferStorageEXT(EXTFramebufferObject.GL_RENDERBUFFER_EXT, EXTPackedDepthStencil.GL_DEPTH_STENCIL_EXT, Mineman.getMinecraft().displayWidth, Mineman.getMinecraft().displayHeight);
