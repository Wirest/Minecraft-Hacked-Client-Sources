...
import skyline.specc.mods.combat.fastbow.Area51;
import skyline.specc.mods.combat.fastbow.NewGuardian;
import skyline.specc.mods.combat.velocity.Normal;
...
public class FastBow extends Module {
	...
	public FastBow() {
		super(new ModData("Fastbow", Keyboard.KEY_NONE, new Color(120, 255, 40)), ModType.COMBAT);
		addMode(new Area51(this, "Area51"));
		addMode(new NewGuardian(this, "NewGuardian"));
	}
}