...
import skyline.specc.extras.main.SkyLineTheme;

public class HUD extends Module
{
	public BooleanValue german = new BooleanValue("German", true);
	public BooleanValue left = new BooleanValue("Left", false);
	public HUD(ModData data, ModType type) {
		super(data, type);
		addMode(new SkyLineTheme(this));
		addValue(left);
	}
