    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            ...
            if (var4.length() > 0) {
                ...
                var9 = Mineman.getMinecraft().fontRendererObj.func_175063_a(this.text.replaceAll("(?s).", "*"), var7, var8, var1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                Mineman.getMinecraft().fontRendererObj.func_175063_a(var4.substring(var2), var9, var8, var1);
            }
            if (var6) {
                if (var10) {
                    ...
                    Mineman.getMinecraft().fontRendererObj.func_175063_a("_", var11, var8, var1);
                }
            }
            if (var3 != var2) {
