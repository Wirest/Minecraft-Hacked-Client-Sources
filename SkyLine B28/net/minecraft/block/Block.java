...
import skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.event.main.eventblock.EventBlockBoundingBox;
import skyline.specc.SkyLine;
import skyline.specc.helper.loc.Loc;
import skyline.specc.render.modules.XrayMod;
...
public class Block {
	...
	public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
		...
		if (SkyLine.getManagers().getModuleManager().getModuleFromClass(XrayMod.class).getState()) {
	 ...
	 */
	  public void addCollisionBoxesToList(final World worldIn, final BlockPos pos, final IBlockState state, final AxisAlignedBB mask, final List list, final Entity collidingEntity) {
	        ...
	        final EventEntityCollision event = (EventEntityCollision)EventSystem.call(new EventEntityCollision(collidingEntity, new Loc(pos.getX(), pos.getY(), pos.getZ()), var7, this));
