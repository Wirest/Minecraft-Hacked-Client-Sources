...
import net.minecraft.MoveEvents.EventEntityStep;
...
import skyline.specc.mods.combat.AimAssist;
...
public abstract class Entity implements ICommandSender {
    ...
    public static boolean wasInvisible = true;
    public static boolean movedOnce = true;
    public static boolean touchedGround = true;
...
/*	this.posX = x;
    ...
    public float getCollisionBorderSize() {
    	if(SkyLine.getManagers().getModuleManager().getModuleFromClass(AimAssist.class).getState()) {
    		return 0.5f;
    	}
	return 0.1F;
    }
