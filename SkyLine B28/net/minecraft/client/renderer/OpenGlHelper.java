...
public class OpenGlHelper
{
    ...
    {
        return Config.isMultiTexture() ? false : field_176083_O && Mineman.getMinecraft().gameSettings.field_178881_t;
    }
    ...
    {
        return Config.isFastRender() ? false : (Config.isAntialiasing() ? false : framebufferSupported && Mineman.getMinecraft().gameSettings.fboEnable);
    }
}
