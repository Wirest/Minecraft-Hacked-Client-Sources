...
public class RenderItem implements IResourceManagerReloadListener
{
	...
	private void func_175045_a(IBakedModel p_175045_1_, int p_175045_2_, ItemStack p_175045_3_)
	{
		...
		boolean renderTextureMap = Mineman.getMinecraft().getTextureMapBlocks().isTextureBound();
	...
	private void renderEffect(IBakedModel p_180451_1_)
	{
		...
		float var2 = (float)(Mineman.getSystemTime() % 3000L) / 3000.0F / 8.0F;
		...
		GlStateManager.pushMatrix();
		GlStateManager.scale(8.0F, 8.0F, 8.0F);
		float var3 = (float)(Mineman.getSystemTime() % 4873L) / 4873.0F / 8.0F;
