...
import skyline.specc.render.renderevnts.EventRenderEntity;
...
public abstract class RendererLivingEntity extends Render
{
	...
	protected boolean func_177088_c(EntityLivingBase p_177088_1_)
	{
		...
		if (p_177088_1_ instanceof EntityPlayer)
		{
			...
			if (var6 != null)
			{
				String var7 = Mineman.getMinecraft().fontRendererObj.getFormatFromString(var6.getColorPrefix());
	...
	protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
	{
		...
		boolean var9 = !var8 && !p_77036_1_.isInvisibleToPlayer(Mineman.getMinecraft().thePlayer);
	 ...
	 */
	 ...
	 {
		 EntityPlayerSP var2 = Mineman.getMinecraft().thePlayer;
		 ...
		 return Mineman.isGuiEnabled() && targetEntity != this.renderManager.livingPlayer && !targetEntity.isInvisibleToPlayer(var2) && targetEntity.riddenByEntity == null;
	 }
