            ...
            if (var3 == null)
            {
                if (field_178466_c.size() >= 256)
                {
                    ...
                    while (var6.hasNext())
                    {
                        ...
                        {
                            Mineman.getMinecraft().getTextureManager().deleteTexture(var8.field_178471_b);
                            var6.remove();
                        }
                    }
                ...
                Mineman.getMinecraft().getTextureManager().loadTexture(var3.field_178471_b, new LayeredColorMaskTexture(field_178464_d, var10, var5));
