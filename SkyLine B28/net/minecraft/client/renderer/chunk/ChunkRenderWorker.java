...
public class ChunkRenderWorker implements Runnable
{
    ...
    public void run()
    {
        ...
        catch (Throwable var4)
        {
            ...
            Mineman.getMinecraft().crashed(Mineman.getMinecraft().addGraphicsAndWorldToCrashReport(var2));
        }
    }
    ...
    protected void func_178474_a(final ChunkCompileTaskGenerator p_178474_1_) throws InterruptedException
    {
        ...
        Entity var2 = Mineman.getMinecraft().func_175606_aa();
        ...
        else
        {
            ...
            Futures.addCallback(var19, new FutureCallback()
            {
                ...
                public void onFailure(Throwable p_onFailure_1_)
                {
                    ...
                    {
                        Mineman.getMinecraft().crashed(CrashReport.makeCrashReport(p_onFailure_1_, "Rendering chunk"));
                    }
                }
