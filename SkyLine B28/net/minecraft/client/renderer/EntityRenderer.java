...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private long prevFrameTime = Mineman.getSystemTime();
    ...
    public EntityRenderer(Mineman mcIn, IResourceManager p_i45076_2_)
    {
    ...
    public void updateCameraAndRender(float partialTicks)
    {
        ...
        {
            if (Mineman.getSystemTime() - this.prevFrameTime > 500L)
            {
        ...
        {
            this.prevFrameTime = Mineman.getSystemTime();
        }

        this.mc.mcProfiler.startSection("mouse");

        if (var2 && Mineman.isRunningOnMac && this.mc.inGameHasFocus && !Mouse.isInsideWindow())
        {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                int var12 = Math.max(Mineman.func_175610_ah(), 30);
