...
public abstract class GuiSlot
{
    ...
    public GuiSlot(Mineman mcIn, int width, int height, int p_i1052_4_, int p_i1052_5_, int p_i1052_6_)
    {
        this.mc = mcIn;
        this.width = width;
        this.height = height;
            ...
            if (Mouse.isButtonDown(0) && this.getEnabled())
            {
                if (this.initialClickY == -1.0F)
                {
                    ...
                    if (this.mouseY >= this.top && this.mouseY <= this.bottom)
                    {
                        ...
                        {
                            boolean var6 = var5 == this.selectedElement && Mineman.getSystemTime() - this.lastClicked < 250L;
                            this.elementClicked(var5, var6, this.mouseX, this.mouseY);
                            this.selectedElement = var5;
                            this.lastClicked = Mineman.getSystemTime();
                        }
