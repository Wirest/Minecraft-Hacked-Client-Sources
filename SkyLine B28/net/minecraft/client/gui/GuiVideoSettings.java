...
public class GuiVideoSettings extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        for (var15 = 0; var15 < var14; ++var15)
        {
            ...
            if (y != null)
            {
                ...
                int y1 = this.height / 6 + 21 * (var15 / 2) - 12;
        ...
        int var16 = this.height / 6 + 21 * (var15 / 2) - 12;
        boolean var17 = false;
        x = this.width / 2 - 155 + 0;
        this.buttonList.add(new GuiOptionButton(231, x, var16, "Shaders..."));
    ...
    protected void actionPerformed(GuiButton par1GuiButton) throws IOException
    {
        if (par1GuiButton.enabled)
        {
            ...
            if (par1GuiButton.id == 231)
            {
                ...
                {
                    Config.showGuiMessage("Shaders are not compatible with Fast MotionBlur.", "Please set Performance -> Fast MotionBlur to OFF.");
                    return;
                }
    ...
    public void drawScreen(int x, int y, float z)
    {
        ...
        if (ed.equals("HD_U"))
        {
            ver = "OptiFine HD F8 Ultra";
        }

        if (ed.equals("L"))
        {
            ver = "OptiFine F8 Light";
        }
