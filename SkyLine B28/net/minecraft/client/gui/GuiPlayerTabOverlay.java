...
public class GuiPlayerTabOverlay extends Gui {
	...
	private final Mineman field_175250_f;
	...
	public GuiPlayerTabOverlay(Mineman mcIn, GuiIngame p_i45529_2_) {
	...
	public void func_175246_a(boolean p_175246_1_) {
		if (p_175246_1_ && !this.field_175254_k) {
			this.field_175253_j = Mineman.getSystemTime();
		}
		...
		if (p_175247_1_.func_178766_e() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
			...
			if (this.field_175253_j == p_175247_6_.func_178855_p()) {
				if (var7 < p_175247_6_.func_178835_l()) {
					p_175247_6_.func_178846_a(Mineman.getSystemTime());
			...
			if (Mineman.getSystemTime() - p_175247_6_.func_178847_n() > 1000L
	...
	public static List<EntityPlayer> getPlayerList() {
		final NetHandlerPlayClient var4 = Mineman.getMinecraft().thePlayer.sendQueue;
		...
		for (final Object o : players) {
			...
			list.add(Mineman.getMinecraft().theWorld.getPlayerEntityByName(info.func_178845_a().getName()));
		}
		return list;
	}
}
