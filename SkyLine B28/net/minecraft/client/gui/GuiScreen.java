...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
     ...
     * Container.validate()
     */
    public void setWorldAndResolution(Mineman mc, int width, int height)
    {
        this.mc = mc;
    ...
    public void handleMouseInput() throws IOException
    {
        ...
        if (Mouse.getEventButtonState())
        {
            ...
            this.lastMouseEvent = Mineman.getSystemTime();
        ...
        {
            long var4 = Mineman.getSystemTime() - this.lastMouseEvent;
    ...
    {
        return Mineman.isRunningOnMac ? Keyboard.isKeyDown(219) || Keyboard.isKeyDown(220) : Keyboard.isKeyDown(29) || Keyboard.isKeyDown(157);
    }
    ...
    public void func_175273_b(Mineman mcIn, int p_175273_2_, int p_175273_3_)
    {
