...
import skyline.altman.GuiAltManager;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public GuiMainMenu()
    {
        ...
        try
        {
            ...
            var1 = new BufferedReader(new InputStreamReader(Mineman.getMinecraft().getResourceManager().getResource(splashTexts).getInputStream(), Charsets.UTF_8));
            String var3;
    ...
    public void initGui()
    {
        ...
        boolean var2 = true;
        int var3 = this.height / 4 + 58;

        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, var3, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, var3 + 24 * 1, I18n.format("menu.multiplayer", new Object[0])));
        this.buttonList.add(this.field_175372_K = new GuiButton(2, this.width / 2 - 100, var3 + 24 * 2, "Account Manager"));
        this.buttonList.add(new GuiButton(4, this.width / 2 - 100, var3 + 24 * 3, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(5, this.width / 2 - 100, var3 + 24 * 4, I18n.format("menu.quit", new Object[0])));
        
        String news = "News: Updates coming to a skyline client near you!";
        FontUtil.newsFont.drawString(news, this.width /2 - 100, var3 + 24 * 5, -1);
    ...
    {
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer", new Object[0])));
        this.buttonList.add(this.field_175372_K = new GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Account Manager"));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id == 4 && this.field_175372_K.visible)
        {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("skidnet/background.png"));
        ...
        FontUtil.roboto.drawString("§cAccount: §f" + mc.session.getUsername(), 2, this.height - 18, -1);
        FontUtil.roboto.drawString("SkyLine (MC 1.8.8)", 2, (this.height - 10), -1);
        String copyright = "Copyright 2018 Specc.";
        FontUtil.roboto.drawString(copyright, (scaledRes.getScaledWidth() - FontUtil.roboto.getStringWidth(copyright)), this.height - 10, -1);
/*        FontUtil.roboto.drawString(ingamename, 2, 2, -1);
        FontUtil.roboto.drawString(registered, 2, 12, -1);
        FontUtil.roboto.drawString(accountType, 2, 22, -1);*/
        
        /*String version = "§aYou are currently using the Latest Version!";
        FontUtil.roboto.drawString(version, 2, 2, -1);*/
