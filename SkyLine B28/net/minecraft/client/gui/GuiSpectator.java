...
public class GuiSpectator extends Gui implements ISpectatorMenuReciepient
{
    ...
    private final Mineman field_175268_g;
    private long field_175270_h;
    private SpectatorMenu field_175271_i;

    public GuiSpectator(Mineman mcIn)
    {
    ...
    {
        this.field_175270_h = Mineman.getSystemTime();
    ...
    {
        long var1 = this.field_175270_h - Mineman.getSystemTime() + 5000L;
