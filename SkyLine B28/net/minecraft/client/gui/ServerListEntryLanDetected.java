...
public class ServerListEntryLanDetected implements GuiListExtended.IGuiListEntry
{
    ...
    protected final Mineman field_148293_a;
    ...
    protected ServerListEntryLanDetected(GuiMultiplayer p_i45046_1_, LanServerDetector.LanServer p_i45046_2_)
    {
        ...
        this.field_148293_a = Mineman.getMinecraft();
    }
    ...
    public boolean mousePressed(int p_148278_1_, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_)
    {
        ...
        if (Mineman.getSystemTime() - this.field_148290_d < 250L)
        {
            this.field_148292_c.connectToSelected();
        }

        this.field_148290_d = Mineman.getSystemTime();
        return false;
    }
