...
public class PlayerMenuObject implements ISpectatorMenuObject
{
    ...
    {
        Mineman.getMinecraft().getNetHandler().addToSendQueue(new C18PacketSpectate(this.field_178668_a.getId()));
    }
    ...
    {
        Mineman.getMinecraft().getTextureManager().bindTexture(this.field_178667_b);
