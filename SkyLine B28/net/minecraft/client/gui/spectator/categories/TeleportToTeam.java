...
public class TeleportToTeam implements ISpectatorMenuView, ISpectatorMenuObject
{
    ...
    {
        Mineman var1 = Mineman.getMinecraft();
    ...
    {
        Mineman.getMinecraft().getTextureManager().bindTexture(GuiSpectator.field_175269_a);
    ...
    class TeamSelectionObject implements ISpectatorMenuObject
    {
        ...
        public TeamSelectionObject(ScorePlayerTeam p_i45492_2_)
        {
            ...
            while (var3.hasNext())
            {
                ...
                NetworkPlayerInfo var5 = Mineman.getMinecraft().getNetHandler().func_175104_a(var4);
        ...
        {
            int var3 = -1;
            String var4 = Mineman.getMinecraft().fontRendererObj.getFormatFromString(this.field_178676_b.getColorPrefix());

            if (var4.length() >= 2)
            {
                var3 = Mineman.getMinecraft().fontRendererObj.func_175064_b(var4.charAt(1));
            }
            ...
            Mineman.getMinecraft().getTextureManager().bindTexture(this.field_178677_c);
