...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        if (this.doesGuiPauseGame)
        {
            ...
            this.drawCenteredString(this.fontRendererObj, lanSearchStates[(int)(Mineman.getSystemTime() / 150L % (long)lanSearchStates.length)], this.width / 2, this.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        }
        else
        {
    ...
    class StatsBlock extends GuiStats.Stats
    {
        ...
        public StatsBlock(Mineman mcIn)
        {
            super(mcIn);
    ...
    class StatsGeneral extends GuiSlot
    {
        ...
        public StatsGeneral(Mineman mcIn)
        {
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        public StatsMobsList(Mineman mcIn)
        {
