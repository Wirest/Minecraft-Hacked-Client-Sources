...
public class GuiAchievement extends Gui
{
    ...
    public GuiAchievement(Mineman mc)
    {
        this.mc = mc;
    ...
    public void displayAchievement(Achievement p_146256_1_)
    {
        ...
        this.notificationTime = Mineman.getSystemTime();
    ...
    public void displayUnformattedAchievement(Achievement p_146255_1_)
    {
        ...
        this.notificationTime = Mineman.getSystemTime() + 2500L;
    ...
    {
        if (this.theAchievement != null && this.notificationTime != 0L && Mineman.getMinecraft().thePlayer != null)
        {
            double var1 = (double)(Mineman.getSystemTime() - this.notificationTime) / 3000.0D;
