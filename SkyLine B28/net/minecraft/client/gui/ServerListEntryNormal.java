...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    private final Mineman field_148300_d;
    ...
    protected ServerListEntryNormal(GuiMultiplayer p_i45048_1_, ServerData p_i45048_2_)
    {
        ...
        this.field_148300_d = Mineman.getMinecraft();
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        {
            var15 = 1;
            var16 = (int)(Mineman.getSystemTime() / 100L + (long)(slotIndex * 2) & 7L);
    ...
    public boolean mousePressed(int p_148278_1_, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_)
    {
        ...
        if (Mineman.getSystemTime() - this.field_148298_f < 250L)
        {
            this.field_148303_c.connectToSelected();
        }

        this.field_148298_f = Mineman.getSystemTime();
        return false;
    }
