...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            float var18 = (float)(Mineman.getSystemTime() - this.returningStackTime) / 100.0F;
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        long var6 = Mineman.getSystemTime();
    ...
    protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick)
    {
        ...
        if (this.clickedSlot != null && this.mc.gameSettings.touchscreen)
        {
            if (clickedMouseButton == 0 || clickedMouseButton == 1)
            {
                ...
                {
                    long var8 = Mineman.getSystemTime();
                ...
                if (state == 0 || state == 1)
                {
                    ...
                    if (var8 != -1 && this.draggedStack != null && var9)
                    {
                        ...
                        if (this.mc.thePlayer.inventory.getItemStack() != null)
                        {
                            ...
                            this.returningStackTime = Mineman.getSystemTime();
                        }
                        else
                        {
                            this.returningStack = null;
