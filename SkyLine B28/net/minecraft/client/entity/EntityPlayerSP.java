...
public class EntityPlayerSP extends AbstractClientPlayer {
	...
	public EntityPlayerSP(Mineman mcIn, World worldIn, NetHandlerPlayClient p_i46278_3_, StatFileWriter p_i46278_4_) {
	...
	public void onUpdate() {
		if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
			...
			Event event = new EventPreMotionUpdates(this.posX, this.posY, this.posZ, this.rotationPitch, this.rotationYaw);
			...
			this.posX = ((EventPreMotionUpdates) event).getX();
			final double y = ((EventPreMotionUpdates) event).getY();
			this.posZ = ((EventPreMotionUpdates) event).getZ();
			this.rotationYaw = (float) ((EventPreMotionUpdates) event).getYaw();
			this.rotationPitch = (float) ((EventPreMotionUpdates) event).getPitch();
