...
public class EntityLargeExplodeFX extends EntityFX
{
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        {
            return new EntityLargeExplodeFX(Mineman.getMinecraft().getTextureManager(), worldIn, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
        }
    }
}
