...
public class Main
{
    ...
    public static void main(String[] p_main_0_) throws NoSuchAlgorithmException, IOException, InterruptedException
    {
        ...
        ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo("Player" + Mineman.getSystemTime() % 1000L, new String[0]);
        ...
        ArgumentAcceptingOptionSpec var15 = var1.accepts("width").withRequiredArg().ofType(Integer.class).defaultsTo(Integer.valueOf(1200), new Integer[0]);
        ArgumentAcceptingOptionSpec var16 = var1.accepts("height").withRequiredArg().ofType(Integer.class).defaultsTo(Integer.valueOf(700), new Integer[0]);
        ...
        Runtime.getRuntime().addShutdownHook(new Thread("Client Shutdown Thread")
        {
            public void run()
            {
                Mineman.stopIntegratedServer();
            }
        });
        Thread.currentThread().setName("Client thread");
        (new Mineman(var42)).run();
    }
