...
import skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.skyline.event.EventPlayerAttack;
...
public class PlayerControllerMP
{
    ...
    public PlayerControllerMP(Mineman mcIn, NetHandlerPlayClient p_i45062_2_)
    {
    ...
    public static void func_178891_a(Mineman mcIn, PlayerControllerMP p_178891_1_, BlockPos p_178891_2_, EnumFacing p_178891_3_)
    {
    ...
    public boolean processRightClickBlock(EntityPlayerSP p_178890_1_, WorldClient p_178890_2_, ItemStack p_178890_3_,
            BlockPos p_178890_4_, EnumFacing p_178890_5_, Vec3d p_178890_6_) {
syncCurrentPlayItem();
...
boolean var10 = false;
if (!Mineman.theWorld.getWorldBorder().contains(p_178890_4_)) {
return false;
}
if (this.currentGameType != WorldSettings.GameType.SPECTATOR) {
IBlockState var11 = p_178890_2_.getBlockState(p_178890_4_);
if ((!p_178890_1_.isSneaking()) || (p_178890_1_.getHeldItem() == null)) {
if (var11.getBlock().onBlockActivated(p_178890_2_, p_178890_4_, var11, p_178890_1_, p_178890_5_, var7,
var8, var9)) {
var10 = true;
}
}
...
int var14 = p_178890_3_.getMetadata();
int var15 = p_178890_3_.stackSize;
boolean var13 = p_178890_3_.onItemUse(p_178890_1_, p_178890_2_, p_178890_4_, p_178890_5_, var7, var8,
var9);
p_178890_3_.setItemDamage(var14);
p_178890_3_.stackSize = var15;
return var13;
