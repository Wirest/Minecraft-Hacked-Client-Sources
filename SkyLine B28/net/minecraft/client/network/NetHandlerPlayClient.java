...
import net.minecraft.MoveEvents.EventEntityVelocity;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
     ...
     */
    private Mineman gameController;
    ...
    public NetHandlerPlayClient(Mineman mcIn, GuiScreen p_i46300_2_, NetworkManager p_i46300_3_, GameProfile p_i46300_4_)
    {
    ...
    public void addToKillAuraSendQueue(Packet packet) {
/*        if (packet instanceof C03PacketPlayer.C05PacketPlayerLook && Vital.getManagers().getModuleManager().getModuleFromClass(KillAuraMod.class).getState()) {
            KillAuraMod.look();
        }
        if (packet instanceof C03PacketPlayer.C06PacketPlayerPosLook && Vital.getManagers().getModuleManager().getModuleFromClass(KillAuraMod.class).getState()) {
            KillAuraMod.poslook();
        }*/
                ...
                this.gameController.addScheduledTask(new Runnable()
                {
                    public void run()
                    {
                        NetHandlerPlayClient.this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
                        {
                            ...
                            {
                                NetHandlerPlayClient.this.gameController = Mineman.getMinecraft();
