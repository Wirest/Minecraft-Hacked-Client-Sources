...
public class NetworkPlayerInfo
{
    ...
    {
        return Mineman.getMinecraft().theWorld.getScoreboard().getPlayersTeam(this.func_178845_a().getName());
    }
    ...
    protected void func_178841_j()
    {
        synchronized (this)
        {
            if (!this.field_178864_d)
            {
                ...
                Mineman.getMinecraft().getSkinManager().func_152790_a(this.field_178867_a, new SkinManager.SkinAvailableCallback()
                {
