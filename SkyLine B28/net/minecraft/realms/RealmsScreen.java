...
public class RealmsScreen
{
    ...
    public void init(Mineman p_init_1_, int p_init_2_, int p_init_3_) {}
    ...
    public static void bindFace(String p_bindFace_0_, String p_bindFace_1_)
    {
        ...
        Mineman.getMinecraft().getTextureManager().bindTexture(var2);
    }

    public static void bind(String p_bind_0_)
    {
        ResourceLocation var1 = new ResourceLocation(p_bind_0_);
        Mineman.getMinecraft().getTextureManager().bindTexture(var1);
    }
    ...
    {
        return new RealmsAnvilLevelStorageSource(Mineman.getMinecraft().getSaveLoader());
    }
