        ...
        (new Thread("Realms-connect-task")
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    RealmsConnect.this.connection.setNetHandler(new NetHandlerLoginClient(RealmsConnect.this.connection, Mineman.getMinecraft(), RealmsConnect.this.onlineScreen.getProxy()));
                    ...
                    RealmsConnect.this.connection.sendPacket(new C00PacketLoginStart(Mineman.getMinecraft().getSession().getProfile()));
                }
