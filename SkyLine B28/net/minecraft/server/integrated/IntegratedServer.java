...
public class IntegratedServer extends MinecraftServer
{
    ...
    public IntegratedServer(Mineman mcIn)
    {
    ...
    public IntegratedServer(Mineman mcIn, String folderName, String worldName, WorldSettings settings)
    {
    ...
    public void tick()
    {
        ...
        this.isGamePaused = Mineman.getMinecraft().getNetHandler() != null && Mineman.getMinecraft().isGamePaused();
        ...
        report.getCategory().addCrashSectionCallable("Is Modded", new Callable()
        {
            public String call()
            {
                ...
                else
                {
                    ...
                    return !var1.equals("vanilla") ? "Definitely; Server brand changed to \'" + var1 + "\'" : (Mineman.class.getSigners() == null ? "Very likely; Jar signature invalidated" : "Probably not. Jar signature remains and both client + server brands are untouched.");
                }
            }
        });
        return report;
    ...
    {
        return Mineman.getMinecraft().isSnooperEnabled();
    }
