...
public class ExternalCommandLoader
{
    ...
    public ExternalCommandLoader() {
        this.loadCommands(this.folder = new File("Faurax 3.6/Commands"));
    }
    
    public void loadCommands(final File dir) {
        ...
        for (int length = (listFiles = dir.listFiles()).length, i = 0; i < length; ++i) {
            ...
            if (file.getName().endsWith(".jar")) {
                ...
                try {
                    ...
                    System.out.println("Command found" + this.jar.getName());
                }
                ...
                while (entries.hasMoreElements()) {
                    ...
                    if (!entry.isDirectory()) {
                        ...
                        if (!Command.class.isAssignableFrom(moduleClass)) {
                            continue;
                        }
                        try {
