...
import me.rigamortis.faurax.events.EventRenderEntityName;
...
public abstract class Render
{
    ...
    {
    	  EventRenderEntityName event = new EventRenderEntityName();
          EventManager.call(event);
          if (event.isCancelled() && p_147906_1_ instanceof EntityPlayer) {
              return;
          }	
