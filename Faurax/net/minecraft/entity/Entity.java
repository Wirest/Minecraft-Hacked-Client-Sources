...
import me.rigamortis.faurax.events.EventEntityBoundingBox;
import me.rigamortis.faurax.events.EventPostStep;
import me.rigamortis.faurax.events.EventSafeWalk;
import me.rigamortis.faurax.events.EventStep;
...
public abstract class Entity implements ICommandSender
{
    ...
    protected void setSize(float width, float height) {
        if (width != this.width || height != this.height) {
            ...
            this.width = width;
            this.height = height;
            EventEntityBoundingBox event = new EventEntityBoundingBox();
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            if (this.stepHeight > 0.0F && var54 && (var13 != x || var17 != z))
            {
                ...
                EventPostStep post = new EventPostStep();
