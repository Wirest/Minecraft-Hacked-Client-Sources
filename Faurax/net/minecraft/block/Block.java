...
import me.rigamortis.faurax.events.EventBlockBoundingbox;
import me.rigamortis.faurax.module.modules.render.Xray;
...
public class Block
{
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        if (Xray.enabled) {
            return Xray.shouldRender(Block.getIdFromBlock(this));
        }
    ...
    public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state) {
        EventBlockBoundingbox event = new EventBlockBoundingbox(new AxisAlignedBB((double)pos.getX() + this.minX, (double)pos.getY() + this.minY, (double)pos.getZ() + this.minZ, (double)pos.getX() + this.maxX, (double)pos.getY() + this.maxY, (double)pos.getZ() + this.maxZ), this, pos.getX(), pos.getY(), pos.getZ());
