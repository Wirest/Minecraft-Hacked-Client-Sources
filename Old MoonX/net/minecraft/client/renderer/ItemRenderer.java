...
import moonx.ohare.client.module.impl.other.Animation;
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                        if (Moonx.INSTANCE.getModuleManager().getModule("animation").isEnabled()) {
                            final Animation animation = ((Animation)Moonx.INSTANCE.getModuleManager().getModule("animation"));
            ...
            if (Moonx.INSTANCE.getModuleManager().getModuleClass(Chams.class).isEnabled() && chams.hands.isEnabled()&& chams.colored.isEnabled()) {
                GL11.glDisable(3008);
                GL11.glDisable(3553);
                GL11.glDisable(2896);
                GL11.glEnable(3042);
