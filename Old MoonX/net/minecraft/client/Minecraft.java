...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void clickMouse() {
        Moonx.INSTANCE.getEventBus().dispatch(new ClickMouseEvent());
    ...
    public void runTick() throws IOException {
        Moonx.INSTANCE.getEventBus().dispatch(new TickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (Mouse.getEventButtonState()) {
                    ...
                    Moonx.INSTANCE.getEventBus().dispatch(eventMouse);
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    Moonx.INSTANCE.getEventBus().dispatch(new KeyInputEvent(k));
                    KeyBinding.onTick(k);
                }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            ...
            Moonx.INSTANCE.getEventBus().dispatch(eventWorldLoad);
        } else {
