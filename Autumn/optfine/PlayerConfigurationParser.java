...
public class PlayerConfigurationParser {
   ...
   private BufferedImage downloadTextureImage(String p_downloadTextureImage_1_) {
      ...
      try {
         ...
         Config.warn("Error loading item texture " + p_downloadTextureImage_1_ + ": " + var4.getClass().getName() + ": " + var4.getMessage());
         return null;
      }
   }
   ...
   private PlayerItemModel downloadModel(String p_downloadModel_1_) {
      ...
      try {
         ...
         Config.warn("Error loading item model " + p_downloadModel_1_ + ": " + var9.getClass().getName() + ": " + var9.getMessage());
         return null;
      }
   }
}
