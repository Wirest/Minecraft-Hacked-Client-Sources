...
public class PlayerItemParser {
   ...
   public static PlayerItemModel parseItemModel(JsonObject p_parseItemModel_0_) {
      ...
      if (!Config.equals(s, "PlayerItem")) {
         ...
         PlayerItemRenderer[] aplayeritemrenderer = (PlayerItemRenderer[])((PlayerItemRenderer[])((PlayerItemRenderer[])list.toArray(new PlayerItemRenderer[list.size()])));
   ...
   private static ModelRenderer parseModelRenderer(JsonObject p_parseModelRenderer_0_, ModelBase p_parseModelRenderer_1_) {
      ...
      if (jsonobject != null) {
         ModelRenderer modelrenderer1 = parseModelRenderer(jsonobject, p_parseModelRenderer_1_);
