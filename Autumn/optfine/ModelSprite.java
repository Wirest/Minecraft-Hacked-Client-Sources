...
public class ModelSprite {
   ...
   public static void renderItemIn2D(Tessellator p_renderItemIn2D_0_, float p_renderItemIn2D_1_, float p_renderItemIn2D_2_, float p_renderItemIn2D_3_, float p_renderItemIn2D_4_, int p_renderItemIn2D_5_, int p_renderItemIn2D_6_, float p_renderItemIn2D_7_, float p_renderItemIn2D_8_, float p_renderItemIn2D_9_) {
      ...
      float f9;
      float f12;
      for(l = p_renderItemIn2D_5_ - 1; l >= 0; --l) {
         f9 = (float)l / (float)p_renderItemIn2D_5_;
         f12 = p_renderItemIn2D_1_ + f * f9 + f2;
         worldrenderer.pos((double)f9 * d0, 0.0D, (double)p_renderItemIn2D_7_).tex((double)f12, (double)p_renderItemIn2D_2_).endVertex();
         worldrenderer.pos((double)f9 * d0, 0.0D, 0.0D).tex((double)f12, (double)p_renderItemIn2D_2_).endVertex();
         worldrenderer.pos((double)f9 * d0, d1, 0.0D).tex((double)f12, (double)p_renderItemIn2D_4_).endVertex();
         worldrenderer.pos((double)f9 * d0, d1, (double)p_renderItemIn2D_7_).tex((double)f12, (double)p_renderItemIn2D_4_).endVertex();
      }
      ...
      for(l = p_renderItemIn2D_5_ - 1; l >= 0; --l) {
         ...
         worldrenderer.pos((double)f13 * d0, d1, (double)p_renderItemIn2D_7_).tex((double)f12, (double)p_renderItemIn2D_4_).endVertex();
         worldrenderer.pos((double)f13 * d0, d1, 0.0D).tex((double)f12, (double)p_renderItemIn2D_4_).endVertex();
         worldrenderer.pos((double)f13 * d0, 0.0D, 0.0D).tex((double)f12, (double)p_renderItemIn2D_2_).endVertex();
         worldrenderer.pos((double)f13 * d0, 0.0D, (double)p_renderItemIn2D_7_).tex((double)f12, (double)p_renderItemIn2D_2_).endVertex();
      }
      ...
      for(l = p_renderItemIn2D_6_ - 1; l >= 0; --l) {
         f9 = (float)l / (float)p_renderItemIn2D_6_;
         f12 = p_renderItemIn2D_2_ + f1 * f9 + f3;
         f13 = f9 + 1.0F / (float)p_renderItemIn2D_6_;
         worldrenderer.pos(0.0D, (double)f13 * d1, 0.0D).tex((double)p_renderItemIn2D_1_, (double)f12).endVertex();
         worldrenderer.pos(d0, (double)f13 * d1, 0.0D).tex((double)p_renderItemIn2D_3_, (double)f12).endVertex();
         worldrenderer.pos(d0, (double)f13 * d1, (double)p_renderItemIn2D_7_).tex((double)p_renderItemIn2D_3_, (double)f12).endVertex();
         worldrenderer.pos(0.0D, (double)f13 * d1, (double)p_renderItemIn2D_7_).tex((double)p_renderItemIn2D_1_, (double)f12).endVertex();
      }
   ...
   public void render(Tessellator p_render_1_, float p_render_2_) {
      GL11.glTranslatef(this.posX * p_render_2_, this.posY * p_render_2_, this.posZ * p_render_2_);
      float f = this.minU;
      float f1 = this.maxU;
      float f2 = this.minV;
      float f3 = this.maxV;
