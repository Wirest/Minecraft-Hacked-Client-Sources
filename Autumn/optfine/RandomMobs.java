      ...
      if (working) {
         ...
         try {
            ...
            if (!(entity1 instanceof EntityLiving)) {
               ResourceLocation var11 = p_getTextureLocation_0_;
               return var11;
            }
            ...
            if (s.startsWith("textures/entity/")) {
               ...
               if (randommobsproperties == null) {
                  var7 = p_getTextureLocation_0_;
                  return var7;
               }

               resourcelocation1 = randommobsproperties.getTextureLocation(p_getTextureLocation_0_, entityliving);
               var7 = resourcelocation1;
               return var7;
            }

            resourcelocation1 = p_getTextureLocation_0_;
         } finally {
            working = false;
         }
