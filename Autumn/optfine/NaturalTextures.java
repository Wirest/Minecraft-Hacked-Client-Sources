...
public class NaturalTextures {
   ...
   private static NaturalProperties[] makeDefaultProperties() {
      ...
      NaturalProperties[] anaturalproperties = (NaturalProperties[])((NaturalProperties[])((NaturalProperties[])list.toArray(new NaturalProperties[list.size()])));
      ...
      if (textureatlassprite == null) {
         ...
         if (i < 0) {
            ...
            while(i >= p_setIconProperties_0_.size()) {
               p_setIconProperties_0_.add((Object)null);
            }
