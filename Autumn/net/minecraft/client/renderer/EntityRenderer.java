   ...
   public void func_181560_a(float p_181560_1_, long p_181560_2_) {
      ...
      if (!this.mc.skipRenderWorld) {
         ...
         if (this.mc.theWorld != null) {
            ...
            GlStateManager.matrixMode(5888);
            GlStateManager.loadIdentity();
            this.setupOverlayRendering((double)l, (double)i1);
            this.renderEndNanoTime = System.nanoTime();
         }
         ...
         if (this.mc.currentScreen != null) {
            ...
            try {
               ...
               crashreportcategory.addCrashSectionCallable("Screen size", () -> {
                  return String.format("Scaled: (%d, %d). Absolute: (%d, %d). Scale factor of %d", scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight(), this.mc.displayWidth, this.mc.displayHeight, scaledresolution.getScaleFactor());
               });
   ...
   private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
      ...
      if (!this.debugView) {
         ...
         if (this.mc.objectMouseOver != null && entity.isInsideOfMaterial(Material.water) && flag) {
            ...
            if ((!flag1 || !Reflector.callBoolean(Reflector.ForgeHooksClient_onDrawBlockHighlight, renderglobal, entityplayer, this.mc.objectMouseOver, 0, entityplayer.getHeldItem(), partialTicks)) && !this.mc.gameSettings.hideGUI) {
