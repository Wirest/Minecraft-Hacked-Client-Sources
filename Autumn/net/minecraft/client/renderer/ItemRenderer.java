      ...
      if (this.itemToRender != null) {
         if (this.itemToRender.getItem() == Items.filled_map) {
            ...
            case DRINK:
               ...
               break;
            case BLOCK:
               AnimationsMod animationsMod = (AnimationsMod)Autumn.MANAGER_REGISTRY.moduleManager.getModuleOrNull(AnimationsMod.class);
               float var9 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
               if (animationsMod.isEnabled()) {
                  GL11.glTranslated((Double)animationsMod.x.getValue(), (Double)animationsMod.y.getValue(), (Double)animationsMod.z.getValue());
                  switch((AnimationsMod.Mode)animationsMod.mode.getValue()) {
                  case OLD:
                     this.transformFirstPersonItem(f, f1);
                     this.func_178103_d();
                     break label31;
