...
public class Stitcher {
   ...
   public List getStichSlots() {
      ...
      while(var2.hasNext()) {
         Object stitcher$slot = var2.next();
      ...
      while(var9.hasNext()) {
         Object stitcher$slot10 = var9.next();
         ...
         if (this.holder != null) {
            ...
            if (i <= this.width && j <= this.height) {
               if (i == this.width && j == this.height) {
                  ...
                  Object stitcher$slot;
                  do {
                     if (!var8.hasNext()) {
                        return false;
                     }

                     stitcher$slot = var8.next();
                  } while(!((Stitcher.Slot)stitcher$slot).addSlot(holderIn));
