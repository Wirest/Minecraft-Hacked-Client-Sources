      ...
      if (!flag && !flag1 && !aboolean[0] && !aboolean[1] && !aboolean[2] && !aboolean[3]) {
         ...
         if (flag) {
            ...
            if (f12 < -999.0F) {
               ...
               f40 = MathHelper.sin(f12) * 0.25F;
               float f23 = MathHelper.cos(f12) * 0.25F;
               float f24 = 8.0F;
               f13 = textureatlassprite.getInterpolatedU((double)(8.0F + (-f23 - f40) * 16.0F));
               f17 = textureatlassprite.getInterpolatedV((double)(8.0F + (-f23 + f40) * 16.0F));
               f14 = textureatlassprite.getInterpolatedU((double)(8.0F + (-f23 + f40) * 16.0F));
               f19 = textureatlassprite.getInterpolatedV((double)(8.0F + (f23 + f40) * 16.0F));
               f15 = textureatlassprite.getInterpolatedU((double)(8.0F + (f23 + f40) * 16.0F));
               f20 = textureatlassprite.getInterpolatedV((double)(8.0F + (f23 - f40) * 16.0F));
               f16 = textureatlassprite.getInterpolatedU((double)(8.0F + (f23 - f40) * 16.0F));
               f39 = textureatlassprite.getInterpolatedV((double)(8.0F + (-f23 - f40) * 16.0F));
            }
            ...
            float f26 = f4 * f1;
            f41 = f4 * f2;
            worldRendererIn.pos(d0 + 0.0D, d1 + (double)f7, d2 + 0.0D).color(f25, f26, f41, 1.0F).tex((double)f13, (double)f17).lightmap(l2, i3).endVertex();
            worldRendererIn.pos(d0 + 0.0D, d1 + (double)f8, d2 + 1.0D).color(f25, f26, f41, 1.0F).tex((double)f14, (double)f19).lightmap(l2, i3).endVertex();
            worldRendererIn.pos(d0 + 1.0D, d1 + (double)f9, d2 + 1.0D).color(f25, f26, f41, 1.0F).tex((double)f15, (double)f20).lightmap(l2, i3).endVertex();
            worldRendererIn.pos(d0 + 1.0D, d1 + (double)f10, d2 + 0.0D).color(f25, f26, f41, 1.0F).tex((double)f16, (double)f39).lightmap(l2, i3).endVertex();
         ...
         if (flag1) {
            ...
            int k1 = i1 >> 16 & '\uffff';
            int i2 = i1 & '\uffff';
            worldRendererIn.pos(d0, d1, d2 + 1.0D).color(f3, f3, f3, 1.0F).tex((double)f35, (double)f14).lightmap(k1, i2).endVertex();
            worldRendererIn.pos(d0, d1, d2).color(f3, f3, f3, 1.0F).tex((double)f35, (double)f13).lightmap(k1, i2).endVertex();
            worldRendererIn.pos(d0 + 1.0D, d1, d2).color(f3, f3, f3, 1.0F).tex((double)f12, (double)f13).lightmap(k1, i2).endVertex();
            worldRendererIn.pos(d0 + 1.0D, d1, d2 + 1.0D).color(f3, f3, f3, 1.0F).tex((double)f12, (double)f14).lightmap(k1, i2).endVertex();
            flag2 = true;
         }
         ...
         for(int j1 = 0; j1 < 4; ++j1) {
            ...
            if (aboolean[j1]) {
               ...
               flag2 = true;
               f41 = textureatlassprite1.getInterpolatedU(0.0D);
