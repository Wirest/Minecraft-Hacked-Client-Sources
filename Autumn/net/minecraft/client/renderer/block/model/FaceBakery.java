...
public class FaceBakery {
   ...
   public static EnumFacing getFacingFromVertexData(int[] faceData) {
      ...
      for(int var12 = 0; var12 < var11; ++var12) {
         EnumFacing enumfacing1 = var10[var12];
   ...
   private void func_178408_a(int[] p_178408_1_, EnumFacing p_178408_2_) {
      ...
      for(int j = 0; j < 4; ++j) {
         i1 = 7 * j;
         float f1 = Float.intBitsToFloat(aint[i1]);
         float f2 = Float.intBitsToFloat(aint[i1 + 1]);
         f = Float.intBitsToFloat(aint[i1 + 2]);
      ...
      for(i1 = 0; i1 < 4; ++i1) {
         ...
         f = afloat[enumfacedirection$vertexinformation.field_179184_a];
         ...
         p_178408_1_[j1] = Float.floatToRawIntBits(f);
         ...
         for(int k = 0; k < 4; ++k) {
            ...
            if (MathHelper.epsilonEquals(f, f5) && MathHelper.epsilonEquals(f3, f6) && MathHelper.epsilonEquals(f4, f7)) {
