...
public class GuiIngame extends Gui {
   ...
   public void renderGameOverlay(float partialTicks) {
      ...
      this.mc.entityRenderer.setupOverlayRendering((double)i, (double)j);
      ...
      if (this.mc.thePlayer.getSleepTimer() > 0) {
         ...
         drawRect(0.0D, 0.0D, (double)i, (double)j, l1);
         GlStateManager.enableAlpha();
      ...
      if (this.recordPlayingUpFor > 0) {
         ...
         if (l1 > 8) {
            ...
            this.getFontRenderer().drawString(this.recordPlaying, -this.getFontRenderer().getStringWidth(this.recordPlaying) / 2, -4, j2 + (l1 << 24 & -16777216));
            GlStateManager.disableBlend();
   ...
   public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_) {
      ...
      if (i > 0) {
         ...
         this.drawTexturedModalRect(p_175176_2_, i1, 0, 64, short1, 5);
         if (k > 0) {
            this.drawTexturedModalRect(p_175176_2_, i1, 0, 69, k, 5);
         }
      }
      ...
      if (this.mc.thePlayer.experienceLevel > 0) {
         ...
         i1 = (p_175176_1_.getScaledWidth() - this.getFontRenderer().getStringWidth(s)) / 2;
   ...
   private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
      ...
      if (instance == null || !instance.shouldHideScoreboard()) {
         ...
         String s;
         for(Iterator var9 = arraylist1.iterator(); var9.hasNext(); i = Math.max(i, this.getFontRenderer().getStringWidth(s))) {
         ...
         while(var14.hasNext()) {
            ...
            double var28 = (double)(j - 2);
            double var10001 = (double)l;
            double var10002 = (double)i1;
            this.getFontRenderer();
            drawRect(var28, var10001, var10002, (double)(l + 9), 1342177280);
            ...
            if (k == arraylist1.size()) {
               ...
               var28 = (double)(j - 2);
               this.getFontRenderer();
               drawRect(var28, (double)(l - 9 - 1), (double)i1, (double)(l - 1), 1610612736);
               drawRect((double)(j - 2), (double)(l - 1), (double)i1, (double)l, 1342177280);
            }
         }
   ...
   private void renderPlayerStats(ScaledResolution p_180477_1_) {
      if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
         ...
         int l3;
         int i4;
         for(j5 = MathHelper.ceiling_float_int((f + f1) / 2.0F) - 1; j5 >= 0; --j5) {
            k5 = 16;
         ...
         if (entity == null) {
            ...
            for(k5 = 0; k5 < 10; ++k5) {
               ...
               i4 = j1 - k5 * 8 - 9;
               this.drawTexturedModalRect(i4, l7, 16 + b4 * 9, 27, 9, 9);
               if (flag1) {
                  if (k5 * 2 + 1 < l) {
                     this.drawTexturedModalRect(i4, l7, j6 + 54, 27, 9, 9);
                  }

                  if (k5 * 2 + 1 == l) {
                     this.drawTexturedModalRect(i4, l7, j6 + 63, 27, 9, 9);
                  }
               }

               if (k5 * 2 + 1 < k) {
                  this.drawTexturedModalRect(i4, l7, j6 + 36, 27, 9, 9);
               }

               if (k5 * 2 + 1 == k) {
                  this.drawTexturedModalRect(i4, l7, j6 + 45, 27, 9, 9);
               }
            }
            ...
            for(int j4 = 0; l3 > 0; j4 += 20) {
               ...
               for(int l4 = 0; l4 < k4; ++l4) {
                  ...
                  int i5 = j1 - l4 * 8 - 9;
                  this.drawTexturedModalRect(i5, i4, b2 + b3 * 9, 9, 9, 9);
                  if (l4 * 2 + 1 + j4 < l7) {
                     this.drawTexturedModalRect(i5, i4, b2 + 36, 9, 9, 9);
                  }

                  if (l4 * 2 + 1 + j4 == l7) {
                     this.drawTexturedModalRect(i5, i4, b2 + 45, 9, 9, 9);
                  }
               }
