...
public class GuiVideoSettings extends GuiScreen {
   ...
   public void initGui() {
      ...
      int k1 = false;
      j = this.width / 2 - 155 + 160;
      this.buttonList.add(new GuiOptionButton(202, j, j1, "Quality..."));
      j1 += 21;
      j = this.width / 2 - 155 + 0;
      this.buttonList.add(new GuiOptionButton(201, j, j1, "Details..."));
      j = this.width / 2 - 155 + 160;
      this.buttonList.add(new GuiOptionButton(212, j, j1, "Performance..."));
      j1 += 21;
      j = this.width / 2 - 155 + 0;
      this.buttonList.add(new GuiOptionButton(211, j, j1, "Animations..."));
      j = this.width / 2 - 155 + 160;
      this.buttonList.add(new GuiOptionButton(222, j, j1, "Other..."));
