...
public class GuiCommandBlock extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawString(var10001, var10002, var10003, i + j * 9, 10526880);
      var10001 = this.fontRendererObj;
      var10002 = I18n.format("advMode.randomPlayer");
      var10003 = this.width / 2 - 150;
      int var9 = j++;
      var10006 = this.fontRendererObj;
      this.drawString(var10001, var10002, var10003, i + var9 * 9, 10526880);
      var10001 = this.fontRendererObj;
      var10002 = I18n.format("advMode.allPlayers");
      var10003 = this.width / 2 - 150;
      var9 = j++;
      var10006 = this.fontRendererObj;
      this.drawString(var10001, var10002, var10003, i + var9 * 9, 10526880);
      var10001 = this.fontRendererObj;
      var10002 = I18n.format("advMode.allEntities");
      var10003 = this.width / 2 - 150;
      var9 = j++;
      var10006 = this.fontRendererObj;
      this.drawString(var10001, var10002, var10003, i + var9 * 9, 10526880);
      ...
      var9 = j++;
      var10006 = this.fontRendererObj;
      this.drawString(this.fontRendererObj, "", var10003, i + var9 * 9, 10526880);
