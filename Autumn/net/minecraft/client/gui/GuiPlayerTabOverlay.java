...
public class GuiPlayerTabOverlay extends Gui {
   ...
   public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
      ...
      double var10002;
      int var10004;
      FontRenderer var10005;
      int j5;
      FontRenderer var35;
      if (list1 != null) {
         var10000 = (double)(width / 2 - l1 / 2 - 1);
         var10001 = (double)(k1 - 1);
         var10002 = (double)(width / 2 + l1 / 2 + 1);
         var10004 = list1.size();
         var10005 = this.mc.fontRendererObj;
         drawRect(var10000, var10001, var10002, (double)(k1 + var10004 * 9), Integer.MIN_VALUE);

         for(var19 = list1.iterator(); var19.hasNext(); k1 += 9) {
            s4 = (String)var19.next();
      ...
      if (list2 != null) {
         ...
         for(var19 = list2.iterator(); var19.hasNext(); k1 += 9) {
            s4 = (String)var19.next();
            j5 = this.mc.fontRendererObj.getStringWidth(s4);
            this.mc.fontRendererObj.drawStringWithShadow(s4, (float)(width / 2 - j5 / 2), (float)k1, -1);
            var35 = this.mc.fontRendererObj;
