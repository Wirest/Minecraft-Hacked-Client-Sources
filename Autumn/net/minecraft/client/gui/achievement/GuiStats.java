...
public class GuiStats extends GuiScreen implements IProgressMeter {
   ...
   class StatsMobsList extends GuiSlot {
      ...
      public StatsMobsList(Minecraft mcIn) {
         int var10002 = GuiStats.this.width;
         int var10003 = GuiStats.this.height;
         int var10005 = GuiStats.this.height - 64;
         GuiStats.this.fontRendererObj;
         super(mcIn, var10002, var10003, 32, var10005, 9 * 4);
         ...
         while(true) {
            ...
            } while(GuiStats.this.field_146546_t.readStat(entitylist$entityegginfo.field_151512_d) <= 0 && GuiStats.this.field_146546_t.readStat(entitylist$entityegginfo.field_151513_e) <= 0);
      ...
      protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
         ...
         GuiStats.this.fontRendererObj;
         var10000.drawString(var10001, s1, var10003, var10004 + 9, i == 0 ? 6316128 : 9474192);
         var10000 = GuiStats.this;
         var10001 = GuiStats.this.fontRendererObj;
         var10003 = p_180791_2_ + 2;
         var10004 = p_180791_3_ + 1;
         GuiStats.this.fontRendererObj;
         var10000.drawString(var10001, s2, var10003, var10004 + 9 * 2, j == 0 ? 6316128 : 9474192);
      }
   }
   ...
   abstract class Stats extends GuiSlot {
      ...
      protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_) {
         String s;
         if (p_148209_1_ != null) {
            s = p_148209_1_.format(GuiStats.this.field_146546_t.readStat(p_148209_1_));
