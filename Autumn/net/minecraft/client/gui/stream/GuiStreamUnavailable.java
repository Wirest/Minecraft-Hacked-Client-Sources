...
public class GuiStreamUnavailable extends GuiScreen {
   ...
   public void initGui() {
      if (this.field_152323_r.isEmpty()) {
         ...
         if (this.field_152327_i != null) {
            ...
            while(var1.hasNext()) {
               ChatComponentTranslation chatcomponenttranslation = (ChatComponentTranslation)var1.next();
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      double var10000 = (double)this.height * 0.85D / 2.0D;
      int var10001 = this.field_152323_r.size();
      FontRenderer var10002 = this.fontRendererObj;
      int i = Math.max((int)(var10000 - (double)((float)(var10001 * 9) / 2.0F)), 50);
      FontRenderer var7 = this.fontRendererObj;
      String var8 = this.field_152324_f.getFormattedText();
      int var10003 = this.width / 2;
      FontRenderer var10005 = this.fontRendererObj;
      this.drawCenteredString(var7, var8, var10003, i - 9 * 2, 16777215);

      for(Iterator var5 = this.field_152323_r.iterator(); var5.hasNext(); i += 9) {
         String s = (String)var5.next();
         this.drawCenteredString(this.fontRendererObj, s, this.width / 2, i, 10526880);
         var7 = this.fontRendererObj;
      }
