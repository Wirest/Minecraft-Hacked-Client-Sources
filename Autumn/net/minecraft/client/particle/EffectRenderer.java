...
public class EffectRenderer {
   ...
   public void updateEffects() {
      ...
      for(int emittersSize = emitters.size(); i < emittersSize; ++i) {
   ...
   public void addBlockDestroyEffects(BlockPos pos, IBlockState state) {
      ...
      if (Reflector.ForgeBlock_addDestroyEffects.exists() && Reflector.ForgeBlock_isAir.exists()) {
         ...
         flag = !Reflector.callBoolean(block, Reflector.ForgeBlock_isAir, world, pos) && !Reflector.callBoolean(block, Reflector.ForgeBlock_addDestroyEffects, world, pos, this);
      } else {
         ...
         for(int i = 0; i < b0; ++i) {
            for(int j = 0; j < b0; ++j) {
               for(int k = 0; k < b0; ++k) {
                  ...
                  this.addEffect((new EntityDiggingFX(world, d0, d1, d2, d0 - (double)pos.getX() - 0.5D, d1 - (double)pos.getY() - 0.5D, d2 - (double)pos.getZ() - 0.5D, state)).func_174846_a(pos));
               }
            }
         }
      }
