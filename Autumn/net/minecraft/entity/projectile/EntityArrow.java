      ...
      if (this.inGround) {
         ...
         for(k = 0; k < list.size(); ++k) {
            ...
            if (entity1.canBeCollidedWith() && (entity1 != this.shootingEntity || this.ticksInAir >= 5)) {
               f6 = 0.3F;
               AxisAlignedBB axisalignedbb1 = entity1.getEntityBoundingBox().expand((double)f6, (double)f6, (double)f6);
         ...
         if (movingobjectposition != null) {
            if (movingobjectposition.entityHit != null) {
               ...
               int l = MathHelper.ceiling_double_int((double)f3 * this.damage);
               ...
               f6 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ);
               this.posX -= this.motionX / (double)f6 * 0.05000000074505806D;
               this.posY -= this.motionY / (double)f6 * 0.05000000074505806D;
               this.posZ -= this.motionZ / (double)f6 * 0.05000000074505806D;
               this.playSound("random.bowhit", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
               this.inGround = true;
               this.arrowShake = 7;
         ...
         if (this.isInWater()) {
            for(int i1 = 0; i1 < 4; ++i1) {
               f7 = 0.25F;
               this.worldObj.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX - this.motionX * (double)f7, this.posY - this.motionY * (double)f7, this.posZ - this.motionZ * (double)f7, this.motionX, this.motionY, this.motionZ);
            }
