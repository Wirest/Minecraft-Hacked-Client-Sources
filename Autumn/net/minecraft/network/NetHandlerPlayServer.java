...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable {
   ...
   public void kickPlayerFromServer(String reason) {
      ...
      this.netManager.sendPacket(new S40PacketDisconnect(chatcomponenttext), (future) -> {
         this.netManager.closeChannel(chatcomponenttext);
      });
      this.netManager.disableAutoRead();
      MinecraftServer var10000 = this.serverController;
      NetworkManager var10001 = this.netManager;
      var10001.getClass();
      Futures.getUnchecked(var10000.addScheduledTask(var10001::checkDisconnected));
   }
   ...
   public void processTabComplete(C14PacketTabComplete packetIn) {
      ...
      this.playerEntity.playerNetServerHandler.sendPacket(new S3APacketTabComplete((String[])((String[])list.toArray(new String[list.size()]))));
   }
