...
public class S21PacketChunkData implements Packet {
   ...
   public static S21PacketChunkData.Extracted func_179756_a(Chunk p_179756_0_, boolean p_179756_1_, boolean p_179756_2_, int p_179756_3_) {
      ...
      while(var15.hasNext()) {
         extendedblockstorage3 = (ExtendedBlockStorage)var15.next();
         char[] achar = extendedblockstorage3.getData();
         char[] var11 = achar;
         int var12 = achar.length;
      ...
      for(var15 = list.iterator(); var15.hasNext(); j = func_179757_a(extendedblockstorage3.getBlocklightArray().getData(), s21packetchunkdata$extracted.data, j)) {
         extendedblockstorage3 = (ExtendedBlockStorage)var15.next();
      }

      if (p_179756_2_) {
         for(var15 = list.iterator(); var15.hasNext(); j = func_179757_a(extendedblockstorage3.getSkylightArray().getData(), s21packetchunkdata$extracted.data, j)) {
            extendedblockstorage3 = (ExtendedBlockStorage)var15.next();
         }
      }
