   ...
   public static class Room extends StructureComponent {
      ...
      public void buildComponent(StructureComponent componentIn, List listIn, Random rand) {
         ...
         for(k = 0; k < this.boundingBox.getXSize(); k += 4) {
            ...
            structurecomponent3 = StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
