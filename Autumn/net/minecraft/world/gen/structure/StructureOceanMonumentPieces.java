...
public class StructureOceanMonumentPieces {
   ...
   public static class WingRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         if (this.field_175834_o == 0) {
            int i1;
            for(i1 = 0; i1 < 4; ++i1) {
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, 10 - i1, 3 - i1, 20 - i1, 12 + i1, 3 - i1, 20, field_175826_b, field_175826_b, false);
            }
   ...
   public static class MonumentCoreRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         for(i = 1; i <= 6; ++i) {
            ...
            for(k = 0; k <= 15; k += 15) {
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, k, i, 0, k, i, 1, iblockstate, iblockstate, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, k, i, 6, k, i, 9, iblockstate, iblockstate, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, k, i, 14, k, i, 15, iblockstate, iblockstate, false);
            }
   ...
   public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece {
               ...
               do {
                  do {
                     if (!var7.hasNext()) {
                        ...
                        while(var17.hasNext()) {
                           StructureOceanMonumentPieces.Piece structureoceanmonumentpieces$piece = (StructureOceanMonumentPieces.Piece)var17.next();
                     ...
                     structureoceanmonumentpieces$roomdefinition = (StructureOceanMonumentPieces.RoomDefinition)var7.next();
                  } while(structureoceanmonumentpieces$roomdefinition.field_175963_d);
               } while(structureoceanmonumentpieces$roomdefinition.func_175961_b());

               Iterator iterator = list1.iterator();

               while(iterator.hasNext()) {
                  StructureOceanMonumentPieces.MonumentRoomFitHelper structureoceanmonumentpieces$monumentroomfithelper = (StructureOceanMonumentPieces.MonumentRoomFitHelper)iterator.next();
         ...
         while(var22.hasNext()) {
            ...
            while(true) {
               while(true) {
                  ...
                  } while(!structureoceanmonumentpieces$roomdefinition3.field_175966_c[l5]);

                  k1 = EnumFacing.getFront(l5).getOpposite().getIndex();
                  structureoceanmonumentpieces$roomdefinition3.field_175966_c[l5] = false;
                  structureoceanmonumentpieces$roomdefinition3.field_175965_b[l5].field_175966_c[k1] = false;
                  if (structureoceanmonumentpieces$roomdefinition3.func_175959_a(i5++) && structureoceanmonumentpieces$roomdefinition3.field_175965_b[l5].func_175959_a(i5++)) {
                     ...
                     structureoceanmonumentpieces$roomdefinition3.field_175965_b[l5].field_175966_c[k1] = true;
                  }
               }
            }
         }
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         for(j = 0; j < 5; ++j) {
            this.func_181655_a(worldIn, structureBoundingBoxIn, -1 - j, 0 + j * 2, -1 - j, -1 - j, 23, 58 + j, false);
            this.func_181655_a(worldIn, structureBoundingBoxIn, 58 + j, 0 + j * 2, -1 - j, 58 + j, 23, 58 + j, false);
            this.func_181655_a(worldIn, structureBoundingBoxIn, 0 - j, 0 + j * 2, -1 - j, 57 + j, 23, -1 - j, false);
            this.func_181655_a(worldIn, structureBoundingBoxIn, 0 - j, 0 + j * 2, 58 + j, 57 + j, 23, 58 + j, false);
         }
      ...
      private void func_175840_a(boolean p_175840_1_, int p_175840_2_, World worldIn, Random p_175840_4_, StructureBoundingBox p_175840_5_) {
         ...
         if (this.func_175818_a(p_175840_5_, p_175840_2_, 0, p_175840_2_ + 23, 20)) {
            ...
            int j1;
            for(j1 = 0; j1 < 4; ++j1) {
               this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + j1, j1 + 1, j1, p_175840_2_ + j1, j1 + 1, 20, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + j1 + 7, j1 + 5, j1 + 7, p_175840_2_ + j1 + 7, j1 + 5, 20, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + 17 - j1, j1 + 5, j1 + 7, p_175840_2_ + 17 - j1, j1 + 5, 20, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + 24 - j1, j1 + 1, j1, p_175840_2_ + 24 - j1, j1 + 1, 20, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + j1 + 1, j1 + 1, j1, p_175840_2_ + 23 - j1, j1 + 1, j1, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + j1 + 8, j1 + 5, j1 + 7, p_175840_2_ + 16 - j1, j1 + 5, j1 + 7, field_175826_b, field_175826_b, false);
            }
            ...
            j1 = p_175840_1_ ? p_175840_2_ + 19 : p_175840_2_ + 5;
            int k = p_175840_1_ ? p_175840_2_ + 5 : p_175840_2_ + 19;

            int l1;
            for(l1 = 20; l1 >= 5; l1 -= 3) {
               this.setBlockState(worldIn, field_175824_d, j1, 5, l1, p_175840_5_);
            }

            for(l1 = 19; l1 >= 7; l1 -= 3) {
               this.setBlockState(worldIn, field_175824_d, k, 5, l1, p_175840_5_);
            }
      ...
      private void func_175837_c(World worldIn, Random p_175837_2_, StructureBoundingBox p_175837_3_) {
         if (this.func_175818_a(p_175837_3_, 15, 20, 42, 21)) {
            ...
            int k;
            for(k = 0; k < 7; ++k) {
               this.setBlockState(worldIn, field_175827_c, 28 - k, 6 + k, 21, p_175837_3_);
               this.setBlockState(worldIn, field_175827_c, 29 + k, 6 + k, 21, p_175837_3_);
            }

            for(k = 0; k < 4; ++k) {
               this.setBlockState(worldIn, field_175827_c, 28 - k, 9 + k, 21, p_175837_3_);
               this.setBlockState(worldIn, field_175827_c, 29 + k, 9 + k, 21, p_175837_3_);
            }
      ...
      private void func_175835_e(World worldIn, Random p_175835_2_, StructureBoundingBox p_175835_3_) {
         ...
         if (this.func_175818_a(p_175835_3_, 0, 21, 6, 58)) {
            ...
            for(k = 23; k < 53; k += 3) {
               this.setBlockState(worldIn, field_175824_d, 5, 5, k, p_175835_3_);
            }
         ...
         if (this.func_175818_a(p_175835_3_, 51, 21, 58, 58)) {
            ...
            for(k = 0; k < 4; ++k) {
               this.fillWithBlocks(worldIn, p_175835_3_, 57 - k, k + 1, 21, 57 - k, k + 1, 57 - k, field_175826_b, field_175826_b, false);
            }

            for(k = 23; k < 53; k += 3) {
               this.setBlockState(worldIn, field_175824_d, 52, 5, k, p_175835_3_);
            }
         ...
         if (this.func_175818_a(p_175835_3_, 0, 51, 57, 57)) {
            ...
            for(k = 0; k < 4; ++k) {
               this.fillWithBlocks(worldIn, p_175835_3_, k + 1, k + 1, 57 - k, 56 - k, k + 1, 57 - k, field_175826_b, field_175826_b, false);
            }
         }
      ...
      private void func_175842_f(World worldIn, Random p_175842_2_, StructureBoundingBox p_175842_3_) {
         ...
         if (this.func_175818_a(p_175842_3_, 7, 21, 13, 50)) {
            ...
            for(j1 = 0; j1 < 4; ++j1) {
               this.fillWithBlocks(worldIn, p_175842_3_, j1 + 7, j1 + 5, 21, j1 + 7, j1 + 5, 54, field_175826_b, field_175826_b, false);
            }

            for(j1 = 21; j1 <= 45; j1 += 3) {
               this.setBlockState(worldIn, field_175824_d, 12, 9, j1, p_175842_3_);
            }
         }
         ...
         if (this.func_175818_a(p_175842_3_, 44, 21, 50, 54)) {
            ...
            for(j1 = 0; j1 < 4; ++j1) {
               this.fillWithBlocks(worldIn, p_175842_3_, 50 - j1, j1 + 5, 21, 50 - j1, j1 + 5, 54, field_175826_b, field_175826_b, false);
            }

            for(j1 = 21; j1 <= 45; j1 += 3) {
               this.setBlockState(worldIn, field_175824_d, 45, 9, j1, p_175842_3_);
            }
         }
         ...
         if (this.func_175818_a(p_175842_3_, 8, 44, 49, 54)) {
            ...
            for(j1 = 12; j1 <= 45; j1 += 3) {
               this.setBlockState(worldIn, field_175824_d, j1, 9, 45, p_175842_3_);
               this.setBlockState(worldIn, field_175824_d, j1, 9, 52, p_175842_3_);
               if (j1 == 12 || j1 == 18 || j1 == 24 || j1 == 33 || j1 == 39 || j1 == 45) {
                  this.setBlockState(worldIn, field_175824_d, j1, 9, 47, p_175842_3_);
                  this.setBlockState(worldIn, field_175824_d, j1, 9, 50, p_175842_3_);
                  this.setBlockState(worldIn, field_175824_d, j1, 10, 45, p_175842_3_);
                  this.setBlockState(worldIn, field_175824_d, j1, 10, 46, p_175842_3_);
                  this.setBlockState(worldIn, field_175824_d, j1, 10, 51, p_175842_3_);
                  this.setBlockState(worldIn, field_175824_d, j1, 10, 52, p_175842_3_);
                  this.setBlockState(worldIn, field_175824_d, j1, 11, 47, p_175842_3_);
                  this.setBlockState(worldIn, field_175824_d, j1, 11, 50, p_175842_3_);
                  this.setBlockState(worldIn, field_175824_d, j1, 12, 48, p_175842_3_);
                  this.setBlockState(worldIn, field_175824_d, j1, 12, 49, p_175842_3_);
               }
            }
      ...
      private void func_175838_g(World worldIn, Random p_175838_2_, StructureBoundingBox p_175838_3_) {
         ...
         if (this.func_175818_a(p_175838_3_, 14, 21, 20, 43)) {
            ...
            for(j1 = 0; j1 < 4; ++j1) {
               this.fillWithBlocks(worldIn, p_175838_3_, j1 + 14, j1 + 9, 21, j1 + 14, j1 + 9, 43 - j1, field_175826_b, field_175826_b, false);
            }

            for(j1 = 23; j1 <= 39; j1 += 3) {
               this.setBlockState(worldIn, field_175824_d, 19, 13, j1, p_175838_3_);
            }
         }
         ...
         if (this.func_175818_a(p_175838_3_, 37, 21, 43, 43)) {
            ...
            for(j1 = 0; j1 < 4; ++j1) {
               this.fillWithBlocks(worldIn, p_175838_3_, 43 - j1, j1 + 9, 21, 43 - j1, j1 + 9, 43 - j1, field_175826_b, field_175826_b, false);
            }

            for(j1 = 23; j1 <= 39; j1 += 3) {
               this.setBlockState(worldIn, field_175824_d, 38, 13, j1, p_175838_3_);
            }
         }
         ...
         if (this.func_175818_a(p_175838_3_, 15, 37, 42, 43)) {
            ...
            for(j1 = 0; j1 < 4; ++j1) {
               this.fillWithBlocks(worldIn, p_175838_3_, 15 + j1, j1 + 9, 43 - j1, 42 - j1, j1 + 9, 43 - j1, field_175826_b, field_175826_b, false);
            }
   ...
   public static class DoubleYZRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         for(j = 1; j <= 7; ++j) {
            iblockstate1 = field_175826_b;
            if (j == 2 || j == 6) {
               iblockstate1 = field_175828_a;
            }
