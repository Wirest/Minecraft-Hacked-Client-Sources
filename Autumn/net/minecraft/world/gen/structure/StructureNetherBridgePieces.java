...
public class StructureNetherBridgePieces {
   ...
   abstract static class Piece extends StructureComponent {
      ...
      private int getTotalWeight(List p_74960_1_) {
         ...
         for(Iterator var4 = p_74960_1_.iterator(); var4.hasNext(); i += structurenetherbridgepieces$pieceweight.field_78826_b) {
   ...
   public static class NetherStalkRoom extends StructureNetherBridgePieces.Piece {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         int k1;
         for(k1 = 1; k1 <= 11; k1 += 2) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, k1, 10, 0, k1, 11, 0, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, k1, 10, 12, k1, 11, 12, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 10, k1, 0, 11, k1, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 12, 10, k1, 12, 11, k1, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);
            this.setBlockState(worldIn, Blocks.nether_brick.getDefaultState(), k1, 13, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick.getDefaultState(), k1, 13, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick.getDefaultState(), 0, 13, k1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick.getDefaultState(), 12, 13, k1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), k1 + 1, 13, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), k1 + 1, 13, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), 0, 13, k1 + 1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), 12, 13, k1 + 1, structureBoundingBoxIn);
         }
         ...
         for(k1 = 3; k1 <= 9; k1 += 2) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 7, k1, 1, 8, k1, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 11, 7, k1, 11, 8, k1, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);
         }

         k1 = this.getMetadataWithOffset(Blocks.nether_brick_stairs, 3);
         ...
         for(j = 0; j <= 6; ++j) {
            ...
            for(l2 = 5; l2 <= 7; ++l2) {
               this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(k1), l2, 5 + j, k, structureBoundingBoxIn);
            }
         ...
         for(j = 5; j <= 7; ++j) {
            this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(k1), j, 12, 11, structureBoundingBoxIn);
         }
         ...
         this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(k), 4, 5, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(k), 4, 5, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(k), 4, 5, 9, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(k), 4, 5, 10, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(j), 8, 5, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(j), 8, 5, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(j), 8, 5, 9, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(j), 8, 5, 10, structureBoundingBoxIn);
         ...
         for(l2 = 4; l2 <= 8; ++l2) {
            for(i3 = 0; i3 <= 2; ++i3) {
               ...
               this.replaceAirAndLiquidDownwards(worldIn, Blocks.nether_brick.getDefaultState(), l2, -1, 12 - i3, structureBoundingBoxIn);
            }
         }
   ...
   public static class End extends StructureNetherBridgePieces.Piece {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         for(l = 0; l <= 4; ++l) {
            j1 = random.nextInt(5);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, l, 2, 0, l, 2, j1, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
         }
