...
public class StructureVillagePieces {
   ...
   public static class House4Garden extends StructureVillagePieces.Village {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         int k;
         if (this.isRoofAccessible) {
            k = this.getMetadataWithOffset(Blocks.ladder, 3);
            this.setBlockState(worldIn, Blocks.ladder.getStateFromMeta(k), 3, 1, 3, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.ladder.getStateFromMeta(k), 3, 2, 3, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.ladder.getStateFromMeta(k), 3, 3, 3, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.ladder.getStateFromMeta(k), 3, 4, 3, structureBoundingBoxIn);
         }
   ...
   public static class House3 extends StructureVillagePieces.Village {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         for(k1 = -1; k1 <= 2; ++k1) {
            for(i2 = 0; i2 <= 8; ++i2) {
               this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(i), i2, 4 + k1, k1, structureBoundingBoxIn);
               if ((k1 > -1 || i2 <= 1) && (k1 > 0 || i2 <= 3) && (k1 > 1 || i2 <= 4 || i2 >= 6)) {
                  this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(j), i2, 4 + k1, 5 - k1, structureBoundingBoxIn);
               }
            }
         }
         ...
         k1 = this.getMetadataWithOffset(Blocks.oak_stairs, 0);

         int l2;
         for(i2 = 4; i2 >= 1; --i2) {
            this.setBlockState(worldIn, Blocks.planks.getDefaultState(), i2, 2 + i2, 7 - i2, structureBoundingBoxIn);

            for(l2 = 8 - i2; l2 <= 10; ++l2) {
               this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(k1), i2, 2 + i2, l2, structureBoundingBoxIn);
            }
         }

         i2 = this.getMetadataWithOffset(Blocks.oak_stairs, 1);
         ...
         for(l2 = 6; l2 <= 8; ++l2) {
            for(j3 = 5; j3 <= 10; ++j3) {
               this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(i2), l2, 12 - l2, j3, structureBoundingBoxIn);
            }
         }
   ...
   public static class House2 extends StructureVillagePieces.Village {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         int k;
         for(k = 6; k <= 8; ++k) {
            if (this.getBlockStateFromPos(worldIn, k, 0, -1, structureBoundingBoxIn).getBlock().getMaterial() == Material.air && this.getBlockStateFromPos(worldIn, k, -1, -1, structureBoundingBoxIn).getBlock().getMaterial() != Material.air) {
               this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(this.getMetadataWithOffset(Blocks.stone_stairs, 3)), k, 0, -1, structureBoundingBoxIn);
            }
         }
   ...
   public static class House1 extends StructureVillagePieces.Village {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         for(k = -1; k <= 2; ++k) {
            for(k1 = 0; k1 <= 8; ++k1) {
               this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(i), k1, 6 + k, k, structureBoundingBoxIn);
               this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(j), k1, 6 + k, 5 - k, structureBoundingBoxIn);
            }
         }
         ...
         this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(k), 6, 1, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(k), 5, 1, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(k), 4, 1, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(k), 3, 1, 4, structureBoundingBoxIn);
   ...
   public static class Hall extends StructureVillagePieces.Village {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         for(i1 = -1; i1 <= 2; ++i1) {
            for(j1 = 0; j1 <= 8; ++j1) {
               this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(i), j1, 4 + i1, i1, structureBoundingBoxIn);
               this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(j), j1, 4 + i1, 5 - i1, structureBoundingBoxIn);
            }
         }
   ...
   public static class Field2 extends StructureVillagePieces.Village {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         int k;
         for(k = 1; k <= 7; ++k) {
            this.setBlockState(worldIn, this.cropTypeA.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, 2, 7)), 1, 1, k, structureBoundingBoxIn);
            this.setBlockState(worldIn, this.cropTypeA.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, 2, 7)), 2, 1, k, structureBoundingBoxIn);
            this.setBlockState(worldIn, this.cropTypeB.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, 2, 7)), 4, 1, k, structureBoundingBoxIn);
            this.setBlockState(worldIn, this.cropTypeB.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, 2, 7)), 5, 1, k, structureBoundingBoxIn);
         }
   ...
   public static class Field1 extends StructureVillagePieces.Village {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         for(k = 1; k <= 7; ++k) {
            ...
            this.setBlockState(worldIn, this.cropTypeB.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, 2, 7)), 4, 1, k, structureBoundingBoxIn);
            this.setBlockState(worldIn, this.cropTypeB.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, 2, 7)), 5, 1, k, structureBoundingBoxIn);
            this.setBlockState(worldIn, this.cropTypeC.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, 2, 7)), 7, 1, k, structureBoundingBoxIn);
            this.setBlockState(worldIn, this.cropTypeC.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, 2, 7)), 8, 1, k, structureBoundingBoxIn);
            this.setBlockState(worldIn, this.cropTypeD.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, 2, 7)), 10, 1, k, structureBoundingBoxIn);
            this.setBlockState(worldIn, this.cropTypeD.getStateFromMeta(MathHelper.getRandomIntegerInRange(randomIn, 2, 7)), 11, 1, k, structureBoundingBoxIn);
         }
   ...
   public static class Church extends StructureVillagePieces.Village {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         int l;
         for(l = 1; l <= 9; ++l) {
            this.setBlockState(worldIn, Blocks.ladder.getStateFromMeta(i), 3, l, 3, structureBoundingBoxIn);
         }
