      ...
      for(int i = 0; i < areaHeight; ++i) {
         for(int j = 0; j < areaWidth; ++j) {
            ...
            if (k == BiomeGenBase.mushroomIsland.biomeID) {
               ...
               if (l != BiomeGenBase.ocean.biomeID && i1 != BiomeGenBase.ocean.biomeID && j1 != BiomeGenBase.ocean.biomeID && k1 != BiomeGenBase.ocean.biomeID) {
               ...
               j1 = aint[j + 1 - 1 + (i + 1) * (areaWidth + 2)];
               k1 = aint[j + 1 + (i + 1 + 1) * (areaWidth + 2)];
               if (this.func_151631_c(l) && this.func_151631_c(i1) && this.func_151631_c(j1) && this.func_151631_c(k1)) {
