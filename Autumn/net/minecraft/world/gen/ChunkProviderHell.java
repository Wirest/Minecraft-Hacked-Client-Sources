...
public class ChunkProviderHell implements IChunkProvider {
      ...
      for(j = 0; j < p_73164_5_; ++j) {
         for(int i1 = 0; i1 < p_73164_7_; ++i1) {
            ...
            for(int k = 0; k < p_73164_6_; ++k) {
               ...
               double d10;
               if (k > p_73164_6_ - 4) {
                  d10 = (double)((float)(k - (p_73164_6_ - 4)) / 3.0F);
                  d4 = d4 * (1.0D - d10) + -10.0D * d10;
               }

               if ((double)k < d3) {
                  d10 = (d3 - (double)k) / 4.0D;
   ...
   public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_) {
      ...
      for(j1 = 0; j1 < this.hellRNG.nextInt(this.hellRNG.nextInt(10) + 1) + 1; ++j1) {
      ...
      for(j1 = 0; j1 < this.hellRNG.nextInt(this.hellRNG.nextInt(10) + 1); ++j1) {
