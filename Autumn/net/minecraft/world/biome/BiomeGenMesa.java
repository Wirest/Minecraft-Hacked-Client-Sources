...
public class BiomeGenMesa extends BiomeGenBase {
   ...
   public void genTerrainBlocks(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int p_180622_4_, int p_180622_5_, double p_180622_6_) {
      ...
      if (this.field_150626_aH) {
         j1 = (p_180622_4_ & -16) + (p_180622_5_ & 15);
         k1 = (p_180622_5_ & -16) + (p_180622_4_ & 15);
         double d0 = Math.min(Math.abs(p_180622_6_), this.field_150623_aE.func_151601_a((double)j1 * 0.25D, (double)k1 * 0.25D));
         if (d0 > 0.0D) {
            double d1 = 0.001953125D;
            double d2 = Math.abs(this.field_150624_aF.func_151601_a((double)j1 * d1, (double)k1 * d1));
            d4 = d0 * d0 * 2.5D;
   ...
   private void func_150619_a(long p_150619_1_) {
      ...
      for(i2 = 0; i2 < 64; ++i2) {
         ...
         if (i2 < 64) {
            this.field_150621_aC[i2] = Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE);
         }
      }
      ...
      for(j2 = 0; j2 < i2; ++j2) {
         ...
         for(j4 = 0; k3 + j4 < 64 && j4 < l2; ++j4) {
            this.field_150621_aC[k3 + j4] = Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW);
         }
      }
      ...
      for(l2 = 0; l2 < j2; ++l2) {
         ...
         for(k4 = 0; j4 + k4 < 64 && k4 < k3; ++k4) {
            this.field_150621_aC[j4 + k4] = Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.BROWN);
         }
      }
