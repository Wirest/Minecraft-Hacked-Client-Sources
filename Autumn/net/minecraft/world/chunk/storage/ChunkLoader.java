...
public class ChunkLoader {
   ...
   public static void convertToAnvilFormat(ChunkLoader.AnvilConverterData p_76690_0_, NBTTagCompound p_76690_1_, WorldChunkManager p_76690_2_) {
      ...
      for(k = 0; k < 16; ++k) {
         for(l = 0; l < 16; ++l) {
            blockpos$mutableblockpos.func_181079_c(p_76690_0_.x << 4 | k, 0, p_76690_0_.z << 4 | l);
            abyte[l << 4 | k] = (byte)(p_76690_2_.getBiomeGenerator(blockpos$mutableblockpos, BiomeGenBase.field_180279_ad).biomeID & 255);
         }
      }
