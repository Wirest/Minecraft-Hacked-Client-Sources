         ...
         if (!nbttagcompound.getBoolean("resolved")) {
            ...
            if (validBookTagContents(nbttagcompound)) {
               ...
               for(int i = 0; i < nbttaglist.tagCount(); ++i) {
                  ...
                  Object lvt_7_1_;
                  try {
                     IChatComponent lvt_7_1_ = IChatComponent.Serializer.jsonToComponent(s);
                     lvt_7_1_ = ChatComponentProcessor.processComponent(player, lvt_7_1_, player);
                  } catch (Exception var9) {
                     lvt_7_1_ = new ChatComponentText(s);
                  }

                  nbttaglist.set(i, new NBTTagString(IChatComponent.Serializer.componentToJson((IChatComponent)lvt_7_1_)));
               }
