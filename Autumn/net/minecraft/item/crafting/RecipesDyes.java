...
public class RecipesDyes {
   public void addRecipes(CraftingManager p_77607_1_) {
      int j;
      for(j = 0; j < 16; ++j) {
         p_77607_1_.addShapelessRecipe(new ItemStack(Blocks.wool, 1, j), new ItemStack(Items.dye, 1, 15 - j), new ItemStack(Item.getItemFromBlock(Blocks.wool), 1, 0));
         p_77607_1_.addRecipe(new ItemStack(Blocks.stained_hardened_clay, 8, 15 - j), "###", "#X#", "###", '#', new ItemStack(Blocks.hardened_clay), 'X', new ItemStack(Items.dye, 1, j));
         p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass, 8, 15 - j), "###", "#X#", "###", '#', new ItemStack(Blocks.glass), 'X', new ItemStack(Items.dye, 1, j));
         p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass_pane, 16, j), "###", "###", '#', new ItemStack(Blocks.stained_glass, 1, j));
      }
