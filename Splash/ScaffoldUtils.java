...
public class ScaffoldUtils
{
    ...
    public static float getRandom() {
        return ScaffoldUtils.rng.nextFloat();
    }
    
    public static int getRandom(final int cap) {
        return ScaffoldUtils.rng.nextInt(cap);
    }
    
    public static int getRandom(final int floor, final int cap) {
        return floor + ScaffoldUtils.rng.nextInt(cap - floor + 1);
    }
    
    public static double getRandomf(final double min, final double max) {
        return min + ScaffoldUtils.rng.nextDouble() * (max - min + 1.0);
    }
