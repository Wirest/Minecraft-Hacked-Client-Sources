...
public class Gui
{
     ...
     */
    public static void drawTexturedModalRect(float f, float g, int textureX, int textureY, int width, int height)
    {
        ...
        WorldRenderer var10 = var9.getWorldRenderer();
        var10.startDrawingQuads();
        var10.addVertexWithUV((double)(f + 0), (double)(g + height), (double)zLevel, (double)((float)(textureX + 0) * var7), (double)((float)(textureY + height) * var8));
        var10.addVertexWithUV((double)(f + width), (double)(g + height), (double)zLevel, (double)((float)(textureX + width) * var7), (double)((float)(textureY + height) * var8));
        var10.addVertexWithUV((double)(f + width), (double)(g + 0), (double)zLevel, (double)((float)(textureX + width) * var7), (double)((float)(textureY + 0) * var8));
        var10.addVertexWithUV((double)(f + 0), (double)(g + 0), (double)zLevel, (double)((float)(textureX + 0) * var7), (double)((float)(textureY + 0) * var8));
        var9.draw();
    }
