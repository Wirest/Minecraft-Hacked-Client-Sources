...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void func_175161_p()
    {
        ...
        if (this.func_175160_A()) {
            ...
            final double var4 = eventPre.y - this.field_175166_bJ;
            final double var5 = this.posZ - this.field_175167_bK;
            final double var6 = eventPre.yaw - this.field_175164_bL;
            final double var7 = eventPre.pitch - this.field_175165_bM;
            boolean var8 = var3 * var3 + var4 * var4 + var5 * var5 > 9.0E-4 || this.field_175168_bP >= 20;
            final boolean var9 = var6 != 0.0 || var7 != 0.0;
            if (this.ridingEntity == null) {
                if (var8 && var9) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.posX, eventPre.y, this.posZ, eventPre.yaw, eventPre.pitch, eventPre.onGround));
                }
                else if (var8) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(this.posX, eventPre.y, this.posZ, eventPre.onGround));
                }
                else if (var9) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(eventPre.yaw, eventPre.pitch, eventPre.onGround));
                }
                else {
    ...
    {
        if (this.noClip || Euphoria.getEuphoria().theMods.getMod(Freecam.class).isEnabled() || Euphoria.getEuphoria().theMods.getMod(Phase.class).isEnabled())
        {
            return false;
        }
        else
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding() && !Euphoria.getEuphoria().theMods.getMod(NoSlow.class).isEnabled()){
