...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void setupViewBobbing(float p_78475_1_)
    {
        if (this.mc.func_175606_aa() instanceof EntityPlayer) {
            ...
            float var6;
            if (Euphoria.getEuphoria().theMods.getMod(DankBobbing.class).isEnabled()) {
                ...
                GlStateManager.rotate(MathHelper.sin(var4 * 3.1415927f) * var5 * 8.0f, 0.0f, 0.0f, 1.0f);
                GlStateManager.rotate(Math.abs(MathHelper.cos(var4 * 3.1415927f - 5.2f) * var5) * 5.0f, 1.0f, 0.0f, 0.0f);
            }
            else {
                final float var3 = var2.distanceWalkedModified - var2.prevDistanceWalkedModified;
                final float var4 = -(var2.distanceWalkedModified + var3 * p_78475_1_);
