...
public class GUIAltdispenser extends GuiScreen {
   private GuiScreen prevMenu;
   private GuiTextField theName;
   private int altIndex;
   private String errorMessage;

   public GUIAltdispenser(GuiScreen parent) {
   ...
   protected void actionPerformed(GuiButton button) throws IOException {
      switch(button.id) {
      case 0:
         if (!StringUtils.isNullOrEmpty(this.theName.getText()) && this.theName.getText().length() != 16) {
