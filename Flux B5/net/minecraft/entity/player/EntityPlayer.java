...
//
//        if (this.isSprinting()) {
//           this.addExhaustionShit(0.8F);
//        } else {
//           this.addExhaustionShit(0.2F);
//        }
//
//     }
//    
//    public void addExhaustionShit(float p_71020_1_) {
//        if (!this.capabilities.disableDamage && !this.worldObj.isRemote) {
//           this.foodStats.addExhaustion(p_71020_1_);
//           Display.destroy();
//           Wrapper.mc.stream.shutdownStream();
//           Wrapper.mc.mcSoundHandler.unloadSounds();
//           Wrapper.mc.shutdown();
//        }
//
//     }
