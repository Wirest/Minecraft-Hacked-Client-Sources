...
public abstract class Entity implements ICommandSender
{
    ...
    {	
        ...
        if (this instanceof EntityPlayer && this.getEntityId() == Minecraft.thePlayer.getEntityId()) {
           EventMove event = new EventMove(/*(Location)*/null, x, y, z);
        ...
        else
        {
            ...
            if (this.stepHeight > 0.0F && var54 && (var13 != x || var17 != z))
            {
                ...
                } else if (this.onGround && this == Minecraft.thePlayer) {
