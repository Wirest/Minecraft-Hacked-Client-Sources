...
import org.m0jang.crystal.GUI.HUD.HudRenderer;
...
//        this.ingameGUI = new GuiIngame(this);
        ...
        Crystal.INSTANCE.start(this.Authed);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	 Iterator var6 = Crystal.INSTANCE.getMods().getModList().iterator();
