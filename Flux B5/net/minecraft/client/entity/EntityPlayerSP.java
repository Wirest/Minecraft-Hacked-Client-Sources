...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
    	 EventUpdate eventPre = new EventUpdate(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
    ...
    {
    	 EventPushOutOfBlocks pushOutOfBlockEvent = new EventPushOutOfBlocks();
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding() && !Crystal.INSTANCE.getMods().get(NoSlow.class).isEnabled()) {
    ...
    public boolean isMoving() {
     ...
     public void setSpeed(double d) {
        this.motionX = -(Math.sin((double)this.getDirection()) * d);
        this.motionZ = Math.cos((double)this.getDirection()) * d;
     }
