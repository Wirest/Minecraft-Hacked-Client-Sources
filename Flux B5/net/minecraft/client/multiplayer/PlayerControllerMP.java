...
import org.m0jang.crystal.Events.EventAimBlock;
...
public class PlayerControllerMP
{
    ...
    {
        EventAimBlock eventAimBlock = new EventAimBlock(p_180511_1_);
        EventManager.call(eventAimBlock);
        p_180511_1_ = eventAimBlock.To;
        Block var3;
    ...
    public float getBlockReachDistance() {
        return !this.currentGameType.isCreative() && !Reach.enabledReach() ? 4.5F : 5.0F;
     }
    ...
    public boolean extendedReach() {
        return this.currentGameType.isCreative() || Reach.enabledReach();
     }
