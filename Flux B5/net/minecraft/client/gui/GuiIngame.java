...
public class GuiIngame extends Gui
{
    ...
    public void renderUI(float p_175180_1_){
        ScaledResolution var2 = new ScaledResolution(this.mc, Minecraft.displayWidth, Minecraft.displayHeight);
        int var3 = var2.getScaledWidth();
        int var4 = var2.getScaledHeight();
        this.mc.entityRenderer.setupOverlayRendering();
        GlStateManager.enableBlend();
        EventRender2D event = new EventRender2D(p_175180_1_);
    ...
    public void func_175182_a(ScaledResolution p_175182_1_)
    {
        ...
        if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null)
        {
            ...
            int var3 = (p_175182_1_.getScaledWidth() - Fonts.segoe18.getStringWidth(var2)) / 2;
...
//                this.func_175179_f().func_175063_a(var2, (float)var3, (float)var4, 16777215 + (var5 << 24));
                Fonts.segoe18.func_175063_a(var2, (float)var3, (float)var4, 16777215 + (var5 << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        }
    ...
    private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        while (var12.hasNext())
        {
            ...
            if (var11 == var21.size())
            {
                ...
                EventDrawText eventDrawText = new EventDrawText(var20);
    ...
    private void func_175184_a(int p_175184_1_, int p_175184_2_, int p_175184_3_, float p_175184_4_, EntityPlayer p_175184_5_)
    {
        ...
        if (var6 != null)
        {
            ...
            this.itemRenderer.renderItemAboveHead(var6, p_175184_2_, p_175184_3_);
