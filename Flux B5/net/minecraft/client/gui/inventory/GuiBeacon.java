...
public class GuiBeacon extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.itemRender.renderItemAboveHead(new ItemStack(Items.emerald), var4 + 42, var5 + 109);
        this.itemRender.renderItemAboveHead(new ItemStack(Items.diamond), var4 + 42 + 22, var5 + 109);
        this.itemRender.renderItemAboveHead(new ItemStack(Items.gold_ingot), var4 + 42 + 44, var5 + 109);
        this.itemRender.renderItemAboveHead(new ItemStack(Items.iron_ingot), var4 + 42 + 66, var5 + 109);
