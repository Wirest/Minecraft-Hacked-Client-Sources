...
public class GuiMerchant extends GuiContainer
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (var4 != null && !var4.isEmpty())
        {
            ...
            this.itemRender.renderItemAboveHead(var9, var5 + 36, var6 + 24);
            this.itemRender.renderItemOverlays(this.fontRendererObj, var9, var5 + 36, var6 + 24);

            if (var10 != null)
            {
                this.itemRender.renderItemAboveHead(var10, var5 + 62, var6 + 24);
                this.itemRender.renderItemOverlays(this.fontRendererObj, var10, var5 + 62, var6 + 24);
            }

            this.itemRender.renderItemAboveHead(var11, var5 + 120, var6 + 24);
