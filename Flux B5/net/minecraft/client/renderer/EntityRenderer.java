...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {	
    	 Boolean noHurtCam = Crystal.INSTANCE.getMods().get(NoHurtCam.class).isEnabled();
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase && !noHurtCam.booleanValue())
        {
    ...
    private void setupViewBobbing(float p_78475_1_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            if (!Crystal.INSTANCE.getMods().get(RealBobbing.class).isEnabled()) {
            ...
            else
            {
                ...
                for (int var20 = 0; var20 < 8; ++var20)
                {
                    ...
                    if (var24 != null) {
                        ...
                        if (var25 < var28 && !Crystal.INSTANCE.getMods().get(ViewClip.class).isEnabled()) {
                           var28 = var25;
                        }
                     }
                  }
