...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float p_78440_1_) {
        ...
        float var6;
        EnumAction var7;
        if (Crystal.SwordAnimation.getSelectedOption().equals("Slide")) {
           var2 = 1.0F - (this.prevEquippedProgress + (this.equippedProgress - this.prevEquippedProgress) * p_78440_1_);
           var3 = Minecraft.thePlayer;
           var4 = var3.getSwingProgress(p_78440_1_);
           var5 = var3.prevRotationPitch + (var3.rotationPitch - var3.prevRotationPitch) * p_78440_1_;
           var6 = var3.prevRotationYaw + (var3.rotationYaw - var3.prevRotationYaw) * p_78440_1_;
           ...
           if (this.itemToRender == null) {
              ...
              } else if (this.itemToRender.getItem().getUnlocalizedName().contains("sword") && !Minecraft.thePlayer.isBlocking()) {
                 this.func_178096_b(var2, var4);
              } else if (var3.getItemInUseCount() > 0) {
                 var7 = this.itemToRender.getItemUseAction();
        ...
        if (Crystal.SwordAnimation.getSelectedOption().equals("Flux")) {
           var2 = 1.0F - (this.prevEquippedProgress + (this.equippedProgress - this.prevEquippedProgress) * p_78440_1_);
           var3 = Minecraft.thePlayer;
           var4 = var3.getSwingProgress(p_78440_1_);
           var5 = var3.prevRotationPitch + (var3.rotationPitch - var3.prevRotationPitch) * p_78440_1_;
        ...
        if (Crystal.SwordAnimation.getSelectedOption().equals("Vanilla")) {
           var2 = 1.0F - (this.prevEquippedProgress + (this.equippedProgress - this.prevEquippedProgress) * p_78440_1_);
           var3 = Minecraft.thePlayer;
           var4 = var3.getSwingProgress(p_78440_1_);
           var5 = var3.prevRotationPitch + (var3.rotationPitch - var3.prevRotationPitch) * p_78440_1_;
