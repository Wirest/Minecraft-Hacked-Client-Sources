...
public class RenderEntityItem extends Render
{
    ...
    private int func_177077_a(EntityItem p_177077_1_, double x, double y, double z, float f1, IBakedModel ItemModel) {
        ...
        if (var11 == null) {
           ...
           float var17;
           float var18;
           if (Crystal.RealsticItem.getBooleanValue()) {
              var12 = ItemModel.isAmbientOcclusionEnabled();
              var13 = this.func_177078_a(var10);
              if (!(var11 instanceof ItemBlock)) {
                 GlStateManager.translate((double)((float)x), (double)((float)y) + 0.1D, (double)((float)z));
              } else {
                 GlStateManager.translate((double)((float)x), (double)((float)y) + 0.2D, (double)((float)z));
              }

              GlStateManager.rotate(90.0F, 1.0F, 0.0F, 0.0F);
              GlStateManager.rotate(p_177077_1_.rotationYaw, 0.0F, 0.0F, 1.0F);
              if (!var12) {
                 var16 = -0.0F * (float)(var13 - 1) * 0.5F;
                 var17 = -0.0F * (float)(var13 - 1) * 0.5F;
                 var18 = -0.046875F * (float)(var13 - 1) * 0.5F;
              ...
              var13 = this.func_177078_a(var10);
              var16 = 0.25F;
              var17 = MathHelper.sin(((float)p_177077_1_.func_174872_o() + f1) / 10.0F + p_177077_1_.hoverStart) * 0.1F + 0.1F;
              GlStateManager.translate((float)x, (float)y + var17 + 0.25F, (float)z);
              if (var12 || this.renderManager.options != null && this.renderManager.options.fancyGraphics) {
                 var18 = (((float)p_177077_1_.func_174872_o() + f1) / 20.0F + p_177077_1_.hoverStart) * 57.295776F;
                 GlStateManager.rotate(var18, 0.0F, 1.0F, 0.0F);
              }

              if (!var12) {
                 var18 = -0.0F * (float)(var13 - 1) * 0.5F;
                 float f4 = -0.0F * (float)(var13 - 1) * 0.5F;
                 float f5 = -0.046875F * (float)(var13 - 1) * 0.5F;
                 GlStateManager.translate(var18, var17, var18);
              }
