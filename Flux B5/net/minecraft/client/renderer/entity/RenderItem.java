...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    float delay = 0.0F;
    TimeHelper rotationTimer = new TimeHelper();
    ...
    protected void func_175040_a(ItemStack p_175040_1_, IBakedModel p_175040_2_, ItemCameraTransforms.TransformType p_175040_3_)
    {
        ...
        if (Crystal.RotateItem.getBooleanValue() && (RenderItem.SwitchTransformType.field_178640_a[p_175040_3_.ordinal()] == 2 || RenderItem.SwitchTransformType.field_178640_a[p_175040_3_.ordinal()] == 3)) {
            GlStateManager.rotate(this.delay, 1.0F, 1.0F, 0.0F);
            if (this.rotationTimer.hasPassed(8.0D)) {
               ++this.delay;
    ...
    public void renderItemAboveHead(final ItemStack p_180450_1_, int p_180450_2_, int p_180450_3_)
    {
        if (p_180450_1_ != null)
        {
            this.zLevel += 50.0F;
