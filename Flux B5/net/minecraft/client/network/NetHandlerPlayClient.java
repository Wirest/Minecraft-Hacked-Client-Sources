    ...
    public void handlePlayerListItem(S38PacketPlayerListItem packetIn)
    {
        ...
        while(var2.hasNext()) {
            ...
            if (packetIn.func_179768_b() == S38PacketPlayerListItem.Action.REMOVE_PLAYER) {
               UUID tempUuid = var3.func_179962_a().getId();
               this.playerInfoMap.remove(tempUuid);
               EventPlayerList event = new EventPlayerList(packetIn.func_179768_b(), tempUuid);
               ...
               if (packetIn.func_179768_b() == S38PacketPlayerListItem.Action.ADD_PLAYER) {
                  ...
                  UUID tempUuid = var4.func_178845_a().getId();
                  this.playerInfoMap.put(tempUuid, var4);
                  EventPlayerList event = new EventPlayerList(packetIn.func_179768_b(), tempUuid);
                  EventManager.call(event);
               }
