...
import static cedo.ui.clickgui.ClickGUI.Handle.*;
...
public class ClickGUI extends GuiScreen {
    ...
    public void handle(int mouseX, int mouseY, int button, Handle type) {
        ...
        if (Fan.clickGui.blur.isEnabled())
            BlurUtil.blur((int) Math.max((15 * openingAnimation.getOutput()), 1));
        ...
        fr = Fan.getClientFont("Regular", false);
        ...
        small = Fan.getClientFont("Small", false);
        categoryPos = 4.5;
