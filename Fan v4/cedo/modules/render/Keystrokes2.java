...
import cedo.util.render.CircleUtil;
...
public class Keystrokes2 extends Module {
    ...
    public static CircleUtil Wcircles = new CircleUtil();
    public static CircleUtil Acircles = new CircleUtil();
    public static CircleUtil Scircles = new CircleUtil();
    public static CircleUtil Dcircles = new CircleUtil();
    public static CircleUtil Lcircles = new CircleUtil();
    public static CircleUtil Rcircles = new CircleUtil();
    public static CircleUtil SPACEcircles = new CircleUtil();
