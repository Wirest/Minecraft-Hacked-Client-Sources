...
public class ChestAssist extends Module {
    ...
    public static EnumFacing getFacing(BlockPos pos) {
        ...
        EnumFacing[] arrenumFacing = new EnumFacing[]{EnumFacing.UP, EnumFacing.NORTH, EnumFacing.EAST, EnumFacing.SOUTH, EnumFacing.WEST, EnumFacing.DOWN};
                    ...
                    for (int y = -radius; y < radius; y++) {
                        for (int z = -radius; z < radius; z++) {
                            ...
                            if (block == Blocks.chest) {
                                ...
                                if (closest == null && mc.thePlayer.getDistance(pos.getX(), pos.getY(), pos.getZ()) < 4) {
                                    closest = pos;
                                } else if (closest != null) {
                                    if (mc.thePlayer.getDistance(pos.getX(), pos.getY(), pos.getZ()) < mc.thePlayer.getDistance(closest.getX(), closest.getY(), closest.getZ())) {
                                        closest = pos;
                                    }
                                }
                            }
