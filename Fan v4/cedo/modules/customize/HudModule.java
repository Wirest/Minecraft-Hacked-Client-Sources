...
public class HudModule extends Module {
    public ModeSetting backgroundMode = new ModeSetting("Menu Background", "Fan", "Fan", "ZeroTwo1", "ZeroTwo2"),
            logo = new ModeSetting("Logo", "Text", "Medium", "Text", "ZeroTwo"),
            infoPos = new ModeSetting("Info Pos", "Clip", "Clip", "Bottom"),
            font = new ModeSetting("Client Font", "Fan", "Fan", "Moon");
    ...
    public HudModule() {
        ...
        addSettings(logo, font, text, info, infoPos, scoreboard, scoreboardClip, scoreboardX, scoreboardY);
        toggled = true;
    }
