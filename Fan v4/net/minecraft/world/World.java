...
public abstract class World implements IBlockAccess
{
            ...
            for (int k1 = i; k1 < j; ++k1)
            {
                for (int l1 = k; l1 < l; ++l1)
                {
                    for (int i2 = i1; i2 < j1; ++i2)
                    {
                        ...
                        {
                            double d0 = (float)(l1 + 1) - BlockLiquid.getLiquidHeightPercent((Integer) iblockstate.getValue(BlockLiquid.LEVEL));
    ...
    public TileEntity getTileEntity(BlockPos pos)
    {
        ...
        else
        {
            ...
            {
                for (TileEntity tileEntity : this.addedTileEntityList) {
                    TileEntity tileentity2 = (TileEntity) tileEntity;
    ...
    public EntityPlayer getClosestPlayer(double x, double y, double z, double distance)
    {
        ...
        for (EntityPlayer playerEntity : this.playerEntities) {
            EntityPlayer entityplayer1 = (EntityPlayer) playerEntity;
    ...
    {
        for (IWorldAccess worldAccess : this.worldAccesses) {
            IWorldAccess iworldaccess = (IWorldAccess) worldAccess;
