...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        float speed = (float) Fan.itemCustomization.handspeed.getValue();
        return  (int)(this.isPotionActive(Potion.digSpeed) ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier()) : (this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6) * (speed));
    }
