            ...
            else
            {
                ...
                if (i >= 0 && i < Potion.potionTypes.length && Potion.potionTypes[i] != null)
                {
                    ...
                    if (l > 0)
                    {
                        ...
                        notifyOperators(sender, this, "commands.effect.success", new ChatComponentTranslation(potioneffect.getEffectName()), i, k, entitylivingbase.getCommandSenderName(), l);
                    }
