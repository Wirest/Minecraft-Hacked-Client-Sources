    ...
    static class RecipeAddPattern implements IRecipe
    {
        ...
        public ItemStack getCraftingResult(InventoryCrafting inv)
        {
            ...
            if (tileentitybanner$enumbannerpattern != null)
            {
                ...
                NBTTagCompound nbttagcompound1 = Objects.requireNonNull(itemstack).getSubCompound("BlockEntityTag", true);
                NBTTagList nbttaglist;

                if (Objects.requireNonNull(nbttagcompound1).hasKey("Patterns", 9))
                {
