...
public class GuiChat extends GuiScreen
{
    ...
    private DecelerateAnimation openingAnimation = new DecelerateAnimation(1000, 1);
    ...
    public void initGui()
    {
        ...
        this.inputField = new GuiTextField(0, FontUtil.cleanmedium, 4, this.height - 11, this.width - 4, 12);
    ...
    {
        drawRect(2, this.height - 14, this.width - 2 - (this.width * 0.9f) + (openingAnimation.getOutput() * (this.width * 0.9f)), this.height - 2, Integer.MIN_VALUE);
