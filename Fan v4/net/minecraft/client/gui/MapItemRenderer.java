...
public class MapItemRenderer
{
    ...
    class Instance
    {
        ...
        private void render(boolean noOverlayRendering)
        {
            ...
            worldrenderer.func_181662_b((float)(i) + f, (float)(j + 128) - f, -0.009999999776482582D).func_181673_a(0.0D, 1.0D).func_181675_d();
            worldrenderer.func_181662_b((float)(i + 128) - f, (float)(j + 128) - f, -0.009999999776482582D).func_181673_a(1.0D, 1.0D).func_181675_d();
            worldrenderer.func_181662_b((float)(i + 128) - f, (float)(j) + f, -0.009999999776482582D).func_181673_a(1.0D, 0.0D).func_181675_d();
            worldrenderer.func_181662_b((float)(i) + f, (float)(j) + f, -0.009999999776482582D).func_181673_a(0.0D, 0.0D).func_181675_d();
            tessellator.draw();
            ...
            for (Vec4b vec4b : this.mapData.playersVisibleOnMap.values())
            {
                if (!noOverlayRendering || vec4b.func_176110_a() == 1)
                {
                    ...
                    worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
                    float f5 = -0.001F;
                    worldrenderer.func_181662_b(-1.0D, 1.0D, (float)k * -0.001F).func_181673_a(f1, f2).func_181675_d();
                    worldrenderer.func_181662_b(1.0D, 1.0D, (float)k * -0.001F).func_181673_a(f3, f2).func_181675_d();
                    worldrenderer.func_181662_b(1.0D, -1.0D, (float)k * -0.001F).func_181673_a(f3, f4).func_181675_d();
                    worldrenderer.func_181662_b(-1.0D, -1.0D, (float)k * -0.001F).func_181673_a(f1, f4).func_181675_d();
                    tessellator.draw();
