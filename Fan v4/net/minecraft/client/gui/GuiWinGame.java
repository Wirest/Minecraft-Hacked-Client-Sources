...
public class GuiWinGame extends GuiScreen
{
    ...
    private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_)
    {
        ...
        f3 = f3 * f3;
        f3 = f3 * 96.0F / 255.0F;
        worldrenderer.func_181662_b(0.0D, this.height, zLevel).func_181673_a(0.0D, f * f2).func_181666_a(f3, f3, f3, 1.0F).func_181675_d();
        worldrenderer.func_181662_b(i, this.height, zLevel).func_181673_a((float)i * f2, f * f2).func_181666_a(f3, f3, f3, 1.0F).func_181675_d();
        worldrenderer.func_181662_b(i, 0.0D, zLevel).func_181673_a((float)i * f2, f1 * f2).func_181666_a(f3, f3, f3, 1.0F).func_181675_d();
        worldrenderer.func_181662_b(0.0D, 0.0D, zLevel).func_181673_a(0.0D, f1 * f2).func_181666_a(f3, f3, f3, 1.0F).func_181675_d();
        tessellator.draw();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        int k1 = this.height;
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.func_181662_b(0.0D, k1, zLevel).func_181673_a(0.0D, 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
        worldrenderer.func_181662_b(j1, k1, zLevel).func_181673_a(1.0D, 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
        worldrenderer.func_181662_b(j1, 0.0D, zLevel).func_181673_a(1.0D, 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
        worldrenderer.func_181662_b(0.0D, 0.0D, zLevel).func_181673_a(0.0D, 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
        tessellator.draw();
