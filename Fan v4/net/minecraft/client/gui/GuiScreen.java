...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    {
        this.drawHoveringText(Arrays.<String>asList(tabName), mouseX, mouseY);
    }
    ...
    public void drawWorldBackground(int tint)
    {
        ...
        {
            drawGradientRect(0, 0, this.width+1, this.height+1, -1072689136, -804253680);
        }
        else
        {
    ...
    public void drawBackground(int tint)
    {
        ...
        worldrenderer.func_181662_b(0.0D, this.height, 0.0D).func_181673_a(0.0D, (float)this.height / 32.0F + (float)tint).func_181669_b(64, 64, 64, 255).func_181675_d();
        worldrenderer.func_181662_b(this.width, this.height, 0.0D).func_181673_a((float)this.width / 32.0F, (float)this.height / 32.0F + (float)tint).func_181669_b(64, 64, 64, 255).func_181675_d();
        worldrenderer.func_181662_b(this.width, 0.0D, 0.0D).func_181673_a((float)this.width / 32.0F, tint).func_181669_b(64, 64, 64, 255).func_181675_d();
        worldrenderer.func_181662_b(0.0D, 0.0D, 0.0D).func_181673_a(0.0D, tint).func_181669_b(64, 64, 64, 255).func_181675_d();
        tessellator.draw();
    }
