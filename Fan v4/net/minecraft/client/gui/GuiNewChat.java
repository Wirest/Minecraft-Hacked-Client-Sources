...
public class GuiNewChat extends Gui
{
    ...
    public void drawChat(int p_146230_1_)
    {
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN)
        {
            ...
            if (k > 0)
            {
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                ...
                                FontUtil.cleanmedium.drawStringWithShadow(s, (float)i2, (float)(j2 - 8), 16777215 + (l1 << 24));
                ...
                if (flag)
                {
                    int k2 = FontUtil.cleanmedium.getHeight();
    ...
    private void setChatLine(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_)
    {
        ...
        List<IChatComponent> list = GuiUtilRenderComponents.func_178908_a(p_146237_1_, i, FontUtil.cleanmedium, false, false);
    ...
    public IChatComponent getChatComponent(int p_146236_1_, int p_146236_2_)
    {
        ...
        else
        {
            ...
            if (j >= 0 && k >= 0)
            {
                ...
                if (j <= MathHelper.floor_float((float)this.getChatWidth() / this.getChatScale()) && k < FontUtil.cleanmedium.getHeight() * l + l)
                {
                    int i1 = k / FontUtil.cleanmedium.getHeight() + this.scrollPos;
                    ...
                    if (i1 >= 0 && i1 < this.field_146253_i.size())
                    {
                        ...
                        for (IChatComponent ichatcomponent : chatline.getChatComponent())
                        {
                            ...
                            {
                                j1 += FontUtil.cleanmedium.getStringWidth(GuiUtilRenderComponents.func_178909_a(((ChatComponentText)ichatcomponent).getChatComponentText_TextValue(), false));
