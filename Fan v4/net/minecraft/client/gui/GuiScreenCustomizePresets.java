...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_175317_i = new GuiTextField(2, FontUtil.cleanmedium, 50, 40, this.width - 100, 20);
    ...
    class ListPreset extends GuiSlot
    {
        ...
        private void func_178051_a(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_)
        {
            ...
            worldrenderer.func_181662_b(i, p_178051_2_ + 32, 0.0D).func_181673_a(0.0D, 1.0D).func_181675_d();
            worldrenderer.func_181662_b(i + 32, p_178051_2_ + 32, 0.0D).func_181673_a(1.0D, 1.0D).func_181675_d();
            worldrenderer.func_181662_b(i + 32, p_178051_2_, 0.0D).func_181673_a(1.0D, 0.0D).func_181675_d();
            worldrenderer.func_181662_b(i, p_178051_2_, 0.0D).func_181673_a(0.0D, 0.0D).func_181675_d();
            tessellator.draw();
        }
