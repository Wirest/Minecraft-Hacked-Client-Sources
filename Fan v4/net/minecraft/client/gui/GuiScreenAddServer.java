...
public class GuiScreenAddServer extends GuiScreen
{
    ...
    private Predicate<String> field_181032_r = new Predicate<String>()
    {
        ...
        {
            if (Objects.requireNonNull(p_apply_1_).length() == 0)
            {
                return true;
            }
            else
    ...
    public void initGui()
    {
        ...
        this.serverNameField = new GuiTextField(0, FontUtil.cleanmedium, this.width / 2 - 100, 66, 200, 20);
        this.serverNameField.setFocused(true);
        this.serverNameField.setText(this.serverData.serverName);
        this.serverIPField = new GuiTextField(1, FontUtil.cleanmedium, this.width / 2 - 100, 106, 200, 20);
