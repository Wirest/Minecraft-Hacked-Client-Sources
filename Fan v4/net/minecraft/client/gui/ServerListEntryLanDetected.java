...
public class ServerListEntryLanDetected implements GuiListExtended.IGuiListEntry
{
    ...
    {
        FontUtil.cleanmedium.drawString(I18n.format("lanServer.title"), x + 32 + 3, y + 1, 16777215);
        ...
        {
            FontUtil.cleanmedium.drawString(I18n.format("selectServer.hiddenAddress"), x + 32 + 3, y + 12 + 11, 3158064);
        }
        else
        {
