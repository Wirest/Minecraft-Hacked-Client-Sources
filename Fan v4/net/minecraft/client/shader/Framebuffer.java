...
public class Framebuffer
{
    ...
    public void framebufferRenderExt(int p_178038_1_, int p_178038_2_, boolean p_178038_3_)
    {
        if (OpenGlHelper.isFramebufferEnabled())
        {
            ...
            worldrenderer.func_181662_b(0.0D, f1, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
            worldrenderer.func_181662_b(f, f1, 0.0D).func_181673_a(f2, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
            worldrenderer.func_181662_b(f, 0.0D, 0.0D).func_181673_a(f2, f3).func_181669_b(255, 255, 255, 255).func_181675_d();
