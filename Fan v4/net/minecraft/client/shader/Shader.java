...
public class Shader
{
    ...
    public void loadShader(float p_148042_1_)
    {
        ...
        worldrenderer.func_181662_b(0.0D, f1, 500.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(f, f1, 500.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(f, 0.0D, 500.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
