...
public class NetworkPlayerInfo
{
    ...
    public ResourceLocation getLocationSkin()
    {
        ...
        return MoreObjects.firstNonNull(this.locationSkin, gameProfile == null ? DefaultPlayerSkin.getDefaultSkin(UUID.randomUUID()) : DefaultPlayerSkin.getDefaultSkin(this.gameProfile.getId()));
    }
