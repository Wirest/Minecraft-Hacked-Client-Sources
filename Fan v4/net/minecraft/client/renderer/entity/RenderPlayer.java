...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    private void setModelVisibilities(AbstractClientPlayer clientPlayer)
    {
        ...
        else
        {
            ...
            modelplayer.bipedHeadwear.showModel = isViewingModelInAltManager || clientPlayer.isWearing(EnumPlayerModelParts.HAT);
            modelplayer.bipedBodyWear.showModel = isViewingModelInAltManager || clientPlayer.isWearing(EnumPlayerModelParts.JACKET);
            modelplayer.bipedLeftLegwear.showModel = isViewingModelInAltManager || clientPlayer.isWearing(EnumPlayerModelParts.LEFT_PANTS_LEG);
            modelplayer.bipedRightLegwear.showModel = isViewingModelInAltManager || clientPlayer.isWearing(EnumPlayerModelParts.RIGHT_PANTS_LEG);
            modelplayer.bipedLeftArmwear.showModel = isViewingModelInAltManager || clientPlayer.isWearing(EnumPlayerModelParts.LEFT_SLEEVE);
            modelplayer.bipedRightArmwear.showModel = isViewingModelInAltManager || clientPlayer.isWearing(EnumPlayerModelParts.RIGHT_SLEEVE);
            modelplayer.heldItemLeft = 0;
            modelplayer.aimedBow = false;
            modelplayer.isSneak = !isViewingModelInAltManager && clientPlayer.isSneaking();
