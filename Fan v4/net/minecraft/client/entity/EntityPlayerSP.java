...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        boolean flag = this.movementInput != null ? (!Objects.requireNonNull(Fan.getModule(Scaffold.class)).isToggled())  && this.movementInput.sneak : false;
    ...
    public float getDirection() {
        ...
        return (float) (yaw * (Math.PI / 180.0F));
    }
