...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        //this.ctm.bindTexture(new ResourceLocation("Fan/Background.jpg"));
        SplashScreen.drawSplash(ctm);
        //this.ctm.bindTexture(new ResourceLocation("Fan/Background.jpg"));
        SplashScreen.setProgress(1, "Initializing Minecraft");
        ...
        SplashScreen.setProgress(2, "Starting " + Fan.fullname);

        // Start Fan Client
        Fan.startup();
        if(Wrapper.getFuckedPrinceKin == 423499) {
            SplashScreen.setProgress(3, 3, "Finishing");
        }
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading " + Fan.name + " - Minecraft 1.8.9");
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException
    {
        ...
        worldrenderer.func_181662_b(0.0D, this.displayHeight, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(this.displayWidth, this.displayHeight, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(this.displayWidth, 0.0D, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
    ...
    public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_, int p_181536_6_, int p_181536_7_, int p_181536_8_, int p_181536_9_, int p_181536_10_)
    {
        ...
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.func_181662_b(p_181536_1_, p_181536_2_ + p_181536_6_, 0.0D).func_181673_a((float)p_181536_3_ * f, (float)(p_181536_4_ + p_181536_6_) * f1).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
        worldrenderer.func_181662_b(p_181536_1_ + p_181536_5_, p_181536_2_ + p_181536_6_, 0.0D).func_181673_a((float)(p_181536_3_ + p_181536_5_) * f, (float)(p_181536_4_ + p_181536_6_) * f1).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
        worldrenderer.func_181662_b(p_181536_1_ + p_181536_5_, p_181536_2_, 0.0D).func_181673_a((float)(p_181536_3_ + p_181536_5_) * f, (float)p_181536_4_ * f1).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
        worldrenderer.func_181662_b(p_181536_1_, p_181536_2_, 0.0D).func_181673_a((float)p_181536_3_ * f, (float)p_181536_4_ * f1).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
    ...
    private void displayDebugInfo(long elapsedTicksTime)
    {
        if (this.mcProfiler.profilingEnabled)
        {
            ...
            worldrenderer.func_181662_b((float)j - (float)i * 1.1F, (float)k - (float)i * 0.6F - 16.0F, 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
            worldrenderer.func_181662_b((float)j - (float)i * 1.1F, k + i * 2, 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
            worldrenderer.func_181662_b((float)j + (float)i * 1.1F, k + i * 2, 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
            worldrenderer.func_181662_b((float)j + (float)i * 1.1F, (float)k - (float)i * 0.6F - 16.0F, 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
            tessellator.draw();
            ...
            for (Profiler.Result result : list) {
                Profiler.Result profiler$result1 = (Profiler.Result) result;
                ...
                int l1 = j1 >> 8 & 255;
                int i2 = j1 & 255;
                worldrenderer.func_181662_b(j, k, 0.0D).func_181669_b(k1, l1, i2, 255).func_181675_d();
                ...
                for (int j2 = i1; j2 >= 0; --j2) {
                    ...
                    worldrenderer.func_181662_b((float) j + f1, (float) k - f2, 0.0D).func_181669_b(k1, l1, i2, 255).func_181675_d();
                }
                ...
                for (int i3 = i1; i3 >= 0; --i3) {
                    ...
                    worldrenderer.func_181662_b((float) j + f4, (float) k - f5, 0.0D).func_181669_b(k1 >> 1, l1 >> 1, i2 >> 1, 255).func_181675_d();
                    worldrenderer.func_181662_b((float) j + f4, (float) k - f5 + 10.0F, 0.0D).func_181669_b(k1 >> 1, l1 >> 1, i2 >> 1, 255).func_181675_d();
                }
     ...
     */
    public void rightClickMouseSilent()
    {
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        {
            worldSettingsIn = new WorldSettings(Objects.requireNonNull(worldinfo));
        }
    ...
    public void setDimensionAndSpawnPlayer(int dimension)
    {
        ...
        this.thePlayer.getDataWatcher().updateWatchedObjectsFromList(Objects.requireNonNull(entityplayersp).getDataWatcher().getAllWatched());
