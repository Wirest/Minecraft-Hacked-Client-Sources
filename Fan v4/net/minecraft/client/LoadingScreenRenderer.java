        ...
        else
        {
            ...
            if (i - this.systemTime >= 100L)
            {
                ...
                else
                {
                    ...
                    worldrenderer.func_181662_b(0.0D, l, 0.0D).func_181673_a(0.0D, (float)l / f).func_181669_b(64, 64, 64, 255).func_181675_d();
                    worldrenderer.func_181662_b(k, l, 0.0D).func_181673_a((float)k / f, (float)l / f).func_181669_b(64, 64, 64, 255).func_181675_d();
                    worldrenderer.func_181662_b(k, 0.0D, 0.0D).func_181673_a((float)k / f, 0.0D).func_181669_b(64, 64, 64, 255).func_181675_d();
                ...
                if (progress >= 0)
                {
                    ...
                    worldrenderer.func_181662_b(j1, k1, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
                    worldrenderer.func_181662_b(j1, k1 + i1, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
                    worldrenderer.func_181662_b(j1 + l1, k1 + i1, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
                    worldrenderer.func_181662_b(j1 + l1, k1, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
                    worldrenderer.func_181662_b(j1, k1, 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
                    worldrenderer.func_181662_b(j1, k1 + i1, 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
                    worldrenderer.func_181662_b(j1 + progress, k1 + i1, 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
                    worldrenderer.func_181662_b(j1 + progress, k1, 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
                    tessellator.draw();
