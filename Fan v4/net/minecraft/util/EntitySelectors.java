...
public final class EntitySelectors
{
    public static final Predicate<Entity> selectAnything = new Predicate<Entity>()
    {
        ...
        {
            return Objects.requireNonNull(p_apply_1_).isEntityAlive();
        }
    };
    public static final Predicate<Entity> IS_STANDALONE = new Predicate<Entity>()
    {
        public boolean apply(Entity p_apply_1_)
        {
            return Objects.requireNonNull(p_apply_1_).isEntityAlive() && p_apply_1_.riddenByEntity == null && p_apply_1_.ridingEntity == null;
        }
    };
