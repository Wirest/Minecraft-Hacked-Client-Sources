...
/*     */   {
/* 244 */     return (buf.getByte(offset) & 0xFF) << 8 | buf.getByte(offset + 1) & 0xFF;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 252 */     return (buf.getByte(offset) & 0xFF) << 16 | (buf.getByte(offset + 1) & 0xFF) << 8 | buf.getByte(offset + 2) & 0xFF;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 261 */     return (buf.getByte(offset) & 0x7F) << 24 | (buf.getByte(offset + 1) & 0xFF) << 16 | (buf.getByte(offset + 2) & 0xFF) << 8 | buf.getByte(offset + 3) & 0xFF;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 271 */     return (buf.getByte(offset) & 0xFF) << 24 | (buf.getByte(offset + 1) & 0xFF) << 16 | (buf.getByte(offset + 2) & 0xFF) << 8 | buf.getByte(offset + 3) & 0xFF;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 324 */       if (c == 0) {
/* 325 */         throw new IllegalArgumentException("value contains null character: " + value);
/*     */       }
/*     */     }
/*     */   }
/*     */ }
