...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(1, this.width / 2 + 120, j - 20, 90, 20, I18n.format("Singleplayer", new Object[0])));
        this.buttonList.add(new GuiButton(2, this.width / 2 + 120, j + 0, 90, 20, I18n.format("Multiplayer", new Object[0])));
        this.buttonList.add(new GuiButton(0, this.width / 2 + 120, j + 20, 90, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 120, j + 40, 90, 20, I18n.format("menu.quit", new Object[0])));
        this.buttonList.add(new GuiButton(508 , this.width / 2 + 120, j + 60, 90, 20, "Client Settings"));
        super.initGui();
    }
...
//        Gui.drawCenteredString(Wrapper.fr(), String.valueOf(String.valueOf(ColorUtil.getColor(Weepcraft.normalColor))) + "§lMinecraft", this.width / 2 - 100, j2 - 11 - 20, -1);
//        Gui.drawCenteredString(Wrapper.fr(), weepcraftString, this.width / 2 + 3, j2 - 11 - 20, -1);
//    	vin-cen.t@hotmail.fr	j22022001
        GL11.glPushMatrix();
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        ...
        if (button.id == 508) {
        	this.mc.displayGuiScreen(new Weepcraftmenu(this));
        }
        if (button.id == 11) {
        }
        if (button.id == 12) {
