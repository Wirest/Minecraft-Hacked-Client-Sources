...
public class Gui
{
     ...
     */
    public static void drawRect(float g, float h, float k, float l, int color)
    {
        if (g < k)
        {
            float i = g;
        ...
        bufferbuilder.pos((double)g, (double)l, 0.0D).endVertex();
        bufferbuilder.pos((double)k, (double)l, 0.0D).endVertex();
        bufferbuilder.pos((double)k, (double)h, 0.0D).endVertex();
...
//    }
     ...
     */
    public static void drawCenteredString(FontRenderer fontRendererIn, String text, float half, float f, int color)
    {
        fontRendererIn.drawStringWithShadow(text, (float)(half - fontRendererIn.getStringWidth(text) / 2), (float)f, color);
    }
