...
import darkmagician6.events.EventClick;
import darkmagician6.events.EventDimensionChange;
import darkmagician6.events.EventDisplayScreen;
...
import me.razerboy420.weepcraft.gui.firstload.GuiFirstLoad;
import me.razerboy420.weepcraft.update.Update;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Weepcraft weepcraft = new Weepcraft();
        if (this.serverName != null) {
          displayGuiScreen(new GuiConnecting(new GuiMainMenu(), this, this.serverName, this.serverPort));
        } else if (Weepcraft.firstLoad) {
          displayGuiScreen(new GuiFirstLoad());
    ...
    {
    	  EventDisplayScreen event = new EventDisplayScreen(guiScreenIn);
    ...
    {
    	 EventDimensionChange event = new EventDimensionChange(dimension);
    	    EventManager.call(event);
    ...
    {
    	 EventMiddleClick event = new EventMiddleClick();
    	    EventManager.call(event);
