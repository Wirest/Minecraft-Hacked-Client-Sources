package me.xatzdevelopments.xatz.hackerdetect.gui;
...
public class GuiXatzHackerDetect extends GuiScreen {
	private GuiScreen before;
	public Hacker selected;
	public int scroll;

	public GuiXatzHackerDetect(GuiScreen before) {
		this.before = before;
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		drawCenteredString(fontRendererObj, "Xatz HackerDetect GUI BETA", width / 2, 5, 0xffdddddd);
	}
