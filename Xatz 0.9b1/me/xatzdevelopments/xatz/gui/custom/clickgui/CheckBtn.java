...
//		}
	...
	public void draw() {
		...
		GL11.glColor4f(0.2f, 0.2f, 0.2f, 0.8f - Xatz.getClickGuiManager().getAlpha());//untoggled settings box -masterjunior
		if(isToggled()) {
			GL11.glColor4f((float)ClientSettings.hudcolorred, (float)ClientSettings.hudcolorgreen, (float)ClientSettings.hudcolorblue, 0.8f - Xatz.getClickGuiManager().getAlpha());//toggled settings box -masterjunior
		}
