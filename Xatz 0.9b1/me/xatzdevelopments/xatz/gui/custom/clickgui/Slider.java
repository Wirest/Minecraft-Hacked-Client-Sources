...
public class Slider extends Component {
	...
	public void draw() {
		...
		GL11.glColor4f(0.2f, 0.2f, 0.2f, 0.8f - Xatz.getClickGuiManager().getAlpha());//slider background -masterjunior
		...
		glEnd();
		GL11.glColor4f(0.3f, 0.3f, 0.3f, 0.8f - Xatz.getClickGuiManager().getAlpha());//small line above slider -masterjunior
		...
		glEnd();
		GL11.glColor4f(0.1f, 0.1f, 0.1f, 0.8f - Xatz.getClickGuiManager().getAlpha());//small line below slider -masterjunior
		glBegin(GL11.GL_LINES);
		{
		...
		GL11.glColor4f(1f, 1f, 1f, 1f - Xatz.getClickGuiManager().getAlpha());//slider color -masterjunior
		glBegin(GL11.GL_QUADS);
		{
