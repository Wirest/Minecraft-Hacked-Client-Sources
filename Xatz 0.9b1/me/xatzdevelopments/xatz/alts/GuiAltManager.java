...
import me.xatzdevelopments.xatz.alts.mcleaks.GuiMCLeaks;
...
public class GuiAltManager extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 22:{
            	this.mc.displayGuiScreen(new GuiMCLeaks());
            }
    ...
    public void initGui() {
        ...
        //this.buttonList.add( new GuiButton(10,width / 2 + 4 + 155, height - 48, 100, 20 , "Import"));
        //this.buttonList.add(new GuiButton(11, width / 2 + 4 + 155, height - 23, 100, 20, "Export"));
        //this.buttonList.add( new GuiButton(22,width / 2 - 260, height - 48, 100, 20 , "MCLeaks"));
        //this.buttonList.add(new GuiButton(23,width / 2 + 4 + 155, height - 48, 100, 20 , "The Altening"));
