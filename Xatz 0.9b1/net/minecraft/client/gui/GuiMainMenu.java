...
//			tessellator.draw();
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (!Xatz.ghostMode) {
			...
			this.mc.getTextureManager().bindTexture(Xatz.images[ClientSettings.bgImage]);
			if(Xatz.gifMenu) {
...
//		this.drawCenteredString(this.fontRendererObj, this.splashText, 0, -8, -256);
		...
		int scroll = 0;
		if(LoadTools.showupdatetext !=false) {
		...
		if(Xatz.firstStart) {
			{
				String str = "Only download from our official website (xatzclient.tk)";
			...
			{
				String str = "<------- Please read this";
	            Gui.drawString(this.fontRendererObj, str, 110, 423, -1);
			}
		}
