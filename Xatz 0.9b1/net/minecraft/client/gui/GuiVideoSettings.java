...
public class GuiVideoSettings extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiOptionButton(231, i1, l, Lang.get("Shaders...")));
		i1 = this.width / 2 - 155 + 160;
		this.buttonList.add(new GuiOptionButton(202, i1, l, Lang.get("Quality...")));
		l = l + 21;
		i1 = this.width / 2 - 155 + 0;
		this.buttonList.add(new GuiOptionButton(201, i1, l, Lang.get("Details...")));
		i1 = this.width / 2 - 155 + 160;
		this.buttonList.add(new GuiOptionButton(212, i1, l, Lang.get("Performance...")));
		l = l + 21;
		i1 = this.width / 2 - 155 + 0;
		this.buttonList.add(new GuiOptionButton(211, i1, l, Lang.get("Animations...")));
		i1 = this.width / 2 - 155 + 160;
		this.buttonList.add(new GuiOptionButton(222, i1, l, Lang.get("Other...")));
		l = l + 21;
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		if (button.enabled) {
			...
			if (button.id < 200 && button instanceof GuiOptionButton) {
				// TODO Xatz lock gui scale
				if (button.displayString.contains("GUI Scale:")) {
					if(ClientSettings.lockGuiScale) {
						mc.gameSettings.guiScale = 2;
						return;
					}
					if(button.displayString.contains("Large")) {
			...
			if (button.id == 231) {
				if (Config.isAntialiasing() || Config.isAntialiasingConfigured()) {
					Config.showGuiMessage(Lang.get("Shaders are not compatible with Antialiasing."), Lang.get("Please set Quality -> Antialiasing to OFF and restart the game."));
					return;
				}

				if (Config.isAnisotropicFiltering()) {
					Config.showGuiMessage(Lang.get("Shaders are not compatible with Anisotropic Filtering."), Lang.get("Please set Quality -> Anisotropic Filtering to OFF."));
					return;
				}

				if (Config.isFastRender()) {
					Config.showGuiMessage(Lang.get("Shaders are not compatible with Fast Render."), Lang.get("Please set Performance -> Fast Render to OFF."));
					return;
				}
