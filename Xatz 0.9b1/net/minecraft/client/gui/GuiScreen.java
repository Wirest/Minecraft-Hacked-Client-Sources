...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		if (button.id == 1234512345 && this.getUsePanicButton() && !Xatz.ghostMode) {
			for (Module m : Xatz.getModuleGroupMananger().getModuleGroupByName("AuraGroup").getModules()) {
	...
	public void setWorldAndResolution(Minecraft mc, int width, int height) {
		...
		if(!(this instanceof UIRenderer)) {
			Xatz.getUIRenderer().setWorldAndResolution(mc, width, height);
		}
	}
	...
	public void initGui() {
		ticks = 0;
		if (this.getUsePanicButton() && !Xatz.ghostMode) {
...
//		// TODO Xatz invmove
//		if (Xatz.getModuleByName("InvMove").isToggled() && this instanceof GuiContainer) {
//			return;
//		}
