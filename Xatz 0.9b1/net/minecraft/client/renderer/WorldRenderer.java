...
import net.minecraft.client.renderer.vertex.VertexFormat2;
import net.minecraft.client.renderer.vertex.VertexFormatElement;
import net.minecraft.client.renderer.vertex.VertexFormatElement2;
...
public class WorldRenderer {
	...
	private VertexFormat2 vertexFormat2;
	...
	public void addVertexData(int[] vertexData) {
	 ...
	 public void setTextureUV(double p_178992_1_, double p_178992_3_)
	    {
	        if (!this.vertexFormat2.func_177347_a(0) && !this.vertexFormat2.func_177347_a(1))
	        {
	            VertexFormatElement2 var5 = new VertexFormatElement2(0, VertexFormatElement2.EnumType.FLOAT, VertexFormatElement2.EnumUseage.UV, 2);
	            this.vertexFormat2.func_177349_a(var5);
	        }
	 ...
	 public void addVertex(double p_178984_1_, double p_178984_3_, double p_178984_5_)
	    {
	        ...
	        for (int i = 0; i < listSize; ++i)
	        {
	            ...
	            switch (WorldRenderer.SwitchEnumUseage.field_178959_a[var9.getUsage().ordinal()])
	            {
	                case 1:
	...
	// TODO atlas worldrenderer startDrawingQuads add method
	public void startDrawingQuads() {
		this.begin(7, DefaultVertexFormats.POSITION_NORMAL);
