...
public class ItemRenderer {
	...
	private void renderRightArm(RenderPlayer renderPlayerIn) {
		...
		GlStateManager.translate(0.25F * ClientSettings.itemSize, -0.85F * ClientSettings.itemSize, 0.75F * ClientSettings.itemSize);
	...
	private void renderLeftArm(RenderPlayer renderPlayerIn) {
		...
		GlStateManager.translate(-0.3F * ClientSettings.itemSize, -1.1F * ClientSettings.itemSize, 0.45F * ClientSettings.itemSize);
	...
	private void renderItemMap(AbstractClientPlayer clientPlayer, float p_178097_2_, float p_178097_3_,
		...
		GlStateManager.scale(0.38F * ClientSettings.itemSize, 0.38F * ClientSettings.itemSize, 0.38F * ClientSettings.itemSize);
		GlStateManager.rotate(90.0F, 0.0F, 1.0F, 0.0F);
	...
	private void func_178095_a(AbstractClientPlayer clientPlayer, float p_178095_2_, float p_178095_3_) {
		...
		GlStateManager.scale(1.0F * ClientSettings.itemSize, 1.0F * ClientSettings.itemSize, 1.0F * ClientSettings.itemSize);
	...
	private void transformFirstPersonItem(float equipProgress, float swingProgress) {
		...
		float size = (float)ClientSettings.itemSize / 2.5f;
					...
					if(Xatz.getModuleByName("AutoBlock").isToggled()) {
						...
						if(Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Exhi")) {
							...
							this.transformFirstPersonItem(f / 2f, 0.0F);
		                     ...
		                     this.func_178103_d();
							/*GL11.glTranslated(-0.1D, 0.15D, 0.0D);
							//GlStateManager.rotate(10f, -0.1f, 0.15f, 0.0f);
							float var9 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
						...
						if(Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Crusher")) {
							float size = (float)ClientSettings.itemSize;
							GlStateManager.scale(size, size, 1.7f);
							this.transformFirstPersonItem(f1, 0);
							GL11.glRotatef(360.0f, 0.1f, 0.1f, 1.7f);
