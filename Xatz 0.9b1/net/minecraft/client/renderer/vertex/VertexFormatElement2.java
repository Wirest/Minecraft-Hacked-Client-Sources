...
public class VertexFormatElement2
{
    private static final Logger field_177381_a = LogManager.getLogger();
    private final VertexFormatElement2.EnumType field_177379_b;
    private final VertexFormatElement2.EnumUseage field_177380_c;
    ...
    public VertexFormatElement2(int p_i46096_1_, VertexFormatElement2.EnumType p_i46096_2_, VertexFormatElement2.EnumUseage p_i46096_3_, int p_i46096_4_)
    {
        if (!this.func_177372_a(p_i46096_1_, p_i46096_3_))
        {
            ...
            this.field_177380_c = VertexFormatElement2.EnumUseage.UV;
        }
        else
        {
    ...
    private final boolean func_177372_a(int p_177372_1_, VertexFormatElement2.EnumUseage p_177372_2_)
    {
        return p_177372_1_ == 0 || p_177372_2_ == VertexFormatElement2.EnumUseage.UV;
    }

    public final VertexFormatElement2.EnumType func_177367_b()
    {
        return this.field_177379_b;
    }

    public final VertexFormatElement2.EnumUseage func_177375_c()
    {
    ...
    {
        return this.field_177380_c == VertexFormatElement2.EnumUseage.POSITION;
    }
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        {
            VertexFormatElement2 var2 = (VertexFormatElement2)p_equals_1_;
    ...
    public static enum EnumType
    {
        ...
        private static final VertexFormatElement2.EnumType[] $VALUES = new VertexFormatElement2.EnumType[]{FLOAT, UBYTE, BYTE, USHORT, SHORT, UINT, INT};
    ...
    public static enum EnumUseage
    {
        ...
        private static final VertexFormatElement2.EnumUseage[] $VALUES = new VertexFormatElement2.EnumUseage[]{POSITION, NORMAL, COLOR, UV, MATRIX, BLEND_WEIGHT, PADDING};
