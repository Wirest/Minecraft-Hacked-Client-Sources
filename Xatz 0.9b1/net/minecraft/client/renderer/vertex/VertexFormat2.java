...
public class VertexFormat2
{
    ...
    public VertexFormat2(VertexFormat2 p_i46097_1_)
    {
        this();
    ...
    public void func_177349_a(VertexFormatElement2 p_177349_1_)
    {
        ...
        else
        {
            ...
            switch (VertexFormat2.SwitchEnumUseage.field_177382_a[p_177349_1_.func_177375_c().ordinal()])
            {
                case 1:
    ...
    public String toString()
    {
        ...
        {
            var1 = var1 + ((VertexFormatElement2)this.field_177355_b.get(var2)).toString();
    ...
    private boolean func_177341_i()
    {
        ...
        do
        {
            ...
            var2 = (VertexFormatElement2)var1.next();
        }
    ...
    public VertexFormatElement2 func_177348_c(int p_177348_1_)
    {
        return (VertexFormatElement2)this.field_177355_b.get(p_177348_1_);
    }
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        {
            VertexFormat2 var2 = (VertexFormat2)p_equals_1_;
    ...
    static final class SwitchEnumUseage
    {
        ...
        static
        {
            ...
            try
            {
                field_177382_a[VertexFormatElement2.EnumUseage.UV.ordinal()] = 3;
            }
