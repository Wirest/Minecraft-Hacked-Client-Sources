...
public class ModelSprite {
	...
	public ModelSprite(ModelRenderer p_i60_1_, int p_i60_2_, int p_i60_3_, float p_i60_4_, float p_i60_5_,
			float p_i60_6_, int p_i60_7_, int p_i60_8_, int p_i60_9_, float p_i60_10_) {
		this.modelRenderer = p_i60_1_;
		this.textureOffsetX = p_i60_2_;
		this.textureOffsetY = p_i60_3_;
		this.posX = p_i60_4_;
		this.posY = p_i60_5_;
		this.posZ = p_i60_6_;
		this.sizeX = p_i60_7_;
		this.sizeY = p_i60_8_;
		this.sizeZ = p_i60_9_;
		this.sizeAdd = p_i60_10_;
		this.minU = (float) p_i60_2_ / p_i60_1_.textureWidth;
		this.minV = (float) p_i60_3_ / p_i60_1_.textureHeight;
		this.maxU = (float) (p_i60_2_ + p_i60_7_) / p_i60_1_.textureWidth;
		this.maxV = (float) (p_i60_3_ + p_i60_8_) / p_i60_1_.textureHeight;
	}
