...
public class HttpPipelineSender extends Thread {
	...
	public HttpPipelineSender(HttpPipelineConnection p_i52_1_) {
		super("HttpPipelineSender");
		this.httpPipelineConnection = p_i52_1_;
	}
	...
	private void writeRequest(HttpRequest p_writeRequest_1_, OutputStream p_writeRequest_2_) throws IOException {
		this.write(p_writeRequest_2_, p_writeRequest_1_.getMethod() + " " + p_writeRequest_1_.getFile() + " "
				+ p_writeRequest_1_.getHttp() + "\r\n");
