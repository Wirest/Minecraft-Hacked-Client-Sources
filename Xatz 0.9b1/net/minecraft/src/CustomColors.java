...
public class CustomColors {
	...
	private static final CustomColors.IColorizer COLORIZER_WATER = new CustomColors.IColorizer() {
		public int getColor(IBlockAccess p_getColor_1_, BlockPos p_getColor_2_) {
			...
			return CustomColors.waterColors != null ? CustomColors.waterColors.getColor(biomegenbase, p_getColor_2_)
					: (Reflector.ForgeBiomeGenBase_getWaterColorMultiplier.exists() ? Reflector.callInt(biomegenbase,
	...
	public static int getXpOrbColor(float p_getXpOrbColor_0_) {
		if (xpOrbColors == null) {
			...
			int i = (int) ((double) ((MathHelper.sin(p_getXpOrbColor_0_) + 1.0F)
					* (float) (xpOrbColors.getLength() - 1)) / 2.0D);
	...
	public static Vec3 getWorldSkyColor(Vec3 p_getWorldSkyColor_0_, WorldClient p_getWorldSkyColor_1_,
														...
														: (p_getMapColorIndex_0_.equals("ice")
																...
																: (p_getMapColorIndex_0_.equals("iron")
																		...
																		: (p_getMapColorIndex_0_.equals("foliage")
																				...
																				: (p_getMapColorIndex_0_.equals("snow")
																						? MapColor.snowColor.colorIndex
																						: (p_getMapColorIndex_0_.equals(
																								"clay") ? MapColor.clayColor.colorIndex
