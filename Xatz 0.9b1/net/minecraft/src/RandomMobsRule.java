...
public class RandomMobsRule {
	...
	public RandomMobsRule(ResourceLocation p_i72_1_, int[] p_i72_2_, int[] p_i72_3_, BiomeGenBase[] p_i72_4_,
			RangeListInt p_i72_5_) {
	...
	public boolean matches(EntityLiving p_matches_1_) {
		return !Matches.biome(p_matches_1_.spawnBiome, this.biomes) ? false
				: (this.heights != null && p_matches_1_.spawnPosition != null
						? this.heights.isInRange(p_matches_1_.spawnPosition.getY()) : true);
	}
