...
public class TextureAnimation {
	...
	public TextureAnimation(String p_i83_1_, byte[] p_i83_2_, String p_i83_3_, ResourceLocation p_i83_4_, int p_i83_5_,
			int p_i83_6_, int p_i83_7_, int p_i83_8_, Properties p_i83_9_, int p_i83_10_) {
		...
		if (p_i83_2_.length % i != 0) {
			Config.warn("Invalid animated texture length: " + p_i83_2_.length + ", frameWidth: " + p_i83_7_
					+ ", frameHeight: " + p_i83_8_);
		}
