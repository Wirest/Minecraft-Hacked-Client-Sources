...
public class HttpPipelineConnection {
	...
	public HttpPipelineConnection(String p_i48_1_, int p_i48_2_) {
		this(p_i48_1_, p_i48_2_, Proxy.NO_PROXY);
	}

	public HttpPipelineConnection(String p_i49_1_, int p_i49_2_, Proxy p_i49_3_) {
		this.host = null;
		this.port = 0;
