...
import me.xatzdevelopments.xatz.client.modules.scaffoldevents.JumpEvent;
...
public abstract class EntityLivingBase extends Entity {
	...
	protected void onDeathUpdate() {
		++this.deathTime;
		//TODO Xatz deathkill
		if(this instanceof EntityPlayerSP && Xatz.getModuleByName("GodMode").isToggled()) {
			this.deathTime = 0;
			return;
		}
		if (this.deathTime == (this instanceof EntityPlayerSP && !Xatz.ghostMode ? 100 : 20)) {
