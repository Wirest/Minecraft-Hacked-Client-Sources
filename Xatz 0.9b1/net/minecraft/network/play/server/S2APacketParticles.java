...
public class S2APacketParticles extends AbstractPacket<INetHandlerPlayClient> {
	...
	/**
	 * These are the block/item ids and possibly metaData ids that are used to
	 * color or texture the particle.
	 */
	...
	/**
	 * Gets the particle arguments. Some particles rely on block and/or item ids
	 * and sometimes metadata ids to color or texture the particle.
	 */
