...
public abstract class Enchantment {
	...
	public static Enchantment getEnchantmentById(int enchID) {
		return enchID >= 0 && enchID < getEnchantmentslist().length ? getEnchantmentslist()[enchID] : null;
	}
	...
	protected Enchantment(int enchID, ResourceLocation enchName, int enchWeight, EnumEnchantmentType enchType) {
		...
		if (getEnchantmentslist()[enchID] != null) {
			throw new IllegalArgumentException("Duplicate enchantment id!");
		} else {
			getEnchantmentslist()[enchID] = this;
	...
	public static Enchantment[] getEnchantmentslist() {
