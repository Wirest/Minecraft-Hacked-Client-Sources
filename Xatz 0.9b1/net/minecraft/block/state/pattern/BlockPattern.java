...
public class BlockPattern {
	 ...
	 * fairly heavy function. @return a BlockPattern.PatternHelper if found,
	 * null otherwise.
	 */
	...
	/**
	 * Offsets the position of pos in the direction of finger and thumb facing
	 * by offset amounts, follows the right-hand rule for cross products
	 * (finger, thumb, palm) @return A new BlockPos offset in the facing
	 * directions
	 */
