    ...
    public static void spawnBonemealParticles(World worldIn, BlockPos pos, int amount)
    {
        ...
        if (var3.getMaterial() != Material.air)
        {
            ...
            for (int var4 = 0; var4 < amount; ++var4)
            {
                ...
                worldIn.spawnParticle(EnumParticleTypes.VILLAGER_HAPPY, pos.getX() + itemRand.nextFloat(), pos.getY() + itemRand.nextFloat() * var3.getBlockBoundsMaxY(), pos.getZ() + itemRand.nextFloat(), var5, var7, var9, new int[0]);
            }
        }
    }
