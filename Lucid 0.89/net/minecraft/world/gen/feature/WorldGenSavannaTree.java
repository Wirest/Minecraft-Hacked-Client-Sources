            ...
            else
            {
                ...
                if ((var20 == Blocks.grass || var20 == Blocks.dirt) && position.getY() < 256 - var4 - 1)
                {
                    ...
                    for (int var13 = 0; var13 < var4; ++var13)
                    {
                        ...
                        {
                            this.func_175905_a(worldIn, var15, Blocks.log2, BlockPlanks.EnumType.ACACIA.getMetadata() - 4);
                            var12 = var14;
                        }
                    }
                    ...
                    if (var23 != var21)
                    {
                        ...
                        for (int var25 = var14; var25 < var4 && var24 > 0; --var24)
                        {
                            if (var25 >= 1)
                            {
                                ...
                                {
                                    this.func_175905_a(worldIn, var18, Blocks.log2, BlockPlanks.EnumType.ACACIA.getMetadata() - 4);
                                    var12 = var17;
                                }
                            }
