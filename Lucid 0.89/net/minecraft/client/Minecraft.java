...
import me.aristhena.lucid.eventapi.Event.State;
...
import me.aristhena.lucid.eventapi.events.UseItemEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
	...
	{
	    lastTickY = getRenderViewEntity().lastTickPosY;
	    prevY = getRenderViewEntity().posY;
	    //getRenderViewEntity().lastTickPosY = 4;
	    //getRenderViewEntity().onGround = true;
	    //getRenderViewEntity().setPosition(getRenderViewEntity().posX, 4, getRenderViewEntity().posZ);
	}
	...
	if (getRenderViewEntity() != null)
	{
	    getRenderViewEntity().lastTickPosY = lastTickY;
	    getRenderViewEntity().setPosition(getRenderViewEntity().posX, prevY, getRenderViewEntity().posZ);
	}
