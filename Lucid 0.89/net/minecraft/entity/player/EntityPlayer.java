...
import me.aristhena.lucid.eventapi.events.JumpEvent;
import me.aristhena.lucid.management.module.ModuleManager;
import me.aristhena.lucid.modules.player.Phase;
import me.aristhena.lucid.modules.player.SpeedMine;
import me.aristhena.lucid.modules.render.Freecam;
...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    if ((isPotionActive(Potion.digSpeed)) || (ModuleManager.getModule(SpeedMine.class).enabled)) {
        if (ModuleManager.getModule(SpeedMine.class).enabled) {
          var2 = (float)(var2 * (1.0D + SpeedMine.amplifier * 0.20000000298023224D));
        } else {
    ...
    {
      return (!ModuleManager.getModule(Phase.class).enabled) && (!ModuleManager.getModule(Freecam.class).enabled) && (!this.sleeping) && (super.isEntityInsideOpaqueBlock());
    }
