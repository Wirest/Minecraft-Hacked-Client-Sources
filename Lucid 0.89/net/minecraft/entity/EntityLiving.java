...
public abstract class EntityLiving extends EntityLivingBase
{
    ...
    public void faceEntity(Entity entityIn, float p_70625_2_, float p_70625_3_)
    {
        ...
        if (entityIn instanceof EntityLivingBase)
        {
            ...
            var6 = var14.posY + var14.getEyeHeight() - (this.posY + this.getEyeHeight());
        }
        else
        {
            var6 = (entityIn.getEntityBoundingBox().minY + entityIn.getEntityBoundingBox().maxY) / 2.0D - (this.posY + this.getEyeHeight());
        }
	...
	public boolean isEntityInsideOpaqueBlock()
    {
        ...
        else
        {
            ...
            for (int var1 = 0; var1 < 8; ++var1)
            {
                ...
                posM.setXyz(var2, var4 + this.getEyeHeight(), var6);
    ...
    public static enum SpawnPlacementType
    {
        ...
        private SpawnPlacementType(String p_i46389_1_, int p_i46389_2_, String p_i45893_1_, int p_i45893_2_) {}
    }
}
