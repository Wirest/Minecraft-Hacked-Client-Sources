...
public abstract class Entity implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && (this.isSneaking() || (Client.INSTANCE.featureManager.scaffold.getState() && Client.INSTANCE.featureManager.scaffold.safeWalk.getValue())) && this instanceof EntityPlayer;
            ...
            EventStep eventStep = new EventStep(EventType.PRE, stepHeight);
            if (this == Minecraft.getMinecraft().thePlayer)
                Client.INSTANCE.bus.post(eventStep);
            ...
            if (this == Minecraft.getMinecraft().thePlayer) {
                eventStep.setEventType(EventType.POST);
                Client.INSTANCE.bus.post(eventStep);
            }
