...
import dev.astroclient.client.ClientRuntimeException;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
        ...
        if (this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    case ENTITY:
                        this.getNetHandler().getNetworkManager().sendPacketNoEvent(new C02PacketUseEntity(this.objectMouseOver.entityHit, C02PacketUseEntity.Action.ATTACK));
                        break;
    ...
    public void runTick() throws IOException {
        Client.INSTANCE.bus.post(new EventTick());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    Client.INSTANCE.bus.post(eventKey);
                    KeyBinding.onTick(k);
                }
