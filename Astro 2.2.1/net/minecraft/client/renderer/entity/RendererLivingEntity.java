...
import dev.astroclient.client.event.impl.render.EventRenderEntity;
...
import dev.astroclient.client.feature.impl.visuals.OutlineESP;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[]{entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)})) {
            EventRenderEntity eventRenderEntity = new EventRenderEntity(EventType.PRE, partialTicks, entity);
            Client.INSTANCE.bus.post(eventRenderEntity);
            ...
            try {
                ...
                if (this.renderOutlines) {
                    ...
                    setDoRenderBrightness(entity, f4);
            ...
            eventRenderEntity.setEventType(EventType.POST);
            Client.INSTANCE.bus.post(eventRenderEntity);
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_,
        ...
        OutlineESP outline = Client.INSTANCE.featureManager.outline;
        boolean flag2 = chams.getState() && chams.isValid(entitylivingbaseIn);
...
//                        Color color = outline.color.getColor();
...
//            }
            ...
            EventRenderModel eventRenderModel = new EventRenderModel(EventType.PRE, entitylivingbaseIn, this.mainModel, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
            Client.INSTANCE.bus.post(eventRenderModel);

            this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);

            if (flag2) {
                if (entitylivingbaseIn == Minecraft.getMinecraft().thePlayer && !chams.localPlayer.getValue())
                    return;
            ...
            eventRenderModel.setEventType(EventType.POST);
            Client.INSTANCE.bus.post(eventRenderModel);
    ...
    public void renderName(T entity, double x, double y, double z) {
        if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, new Object[]{entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)})) {
            EventRenderTag eventRenderTag = new EventRenderTag(entity);
            Client.INSTANCE.bus.post(eventRenderTag);
            if (eventRenderTag.isCancelled()) return;
