...
import dev.astroclient.client.feature.impl.visuals.Crosshair;
...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (this.showCrosshair() && this.mc.gameSettings.thirdPersonView < 1 && !((ToggleableFeature) Client.INSTANCE.featureManager.get(Crosshair.class)).getState()) {
        ...
        Client.INSTANCE.bus.post(new EventRender2D(scaledresolution, partialTicks));
        ...
        if (scoreobjective1 != null) {
            if (!Client.INSTANCE.featureManager.streamerMode.getState() || !Client.INSTANCE.featureManager.streamerMode.hideScoreboard.getValue())
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        ...
        for (Object score1 : arraylist1) {
            ...
            Client.INSTANCE.featureManager.autoPlay.insane = s1.toLowerCase().contains("insane");
            Client.INSTANCE.featureManager.autoPlay.teams = s1.toLowerCase().contains("teams");
            ...
            if (k == arraylist1.size()) {
                ...
                skywars = s3.toLowerCase().contains("skywars");
