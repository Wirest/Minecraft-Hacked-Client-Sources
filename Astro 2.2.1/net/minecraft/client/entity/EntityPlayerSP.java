...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        Client.INSTANCE.bus.post(eventMove);
    ...
    public void onUpdateWalkingPlayer() {
        EventMotion eventMotion = new EventMotion(EventType.PRE, mc.thePlayer.posX, this.getEntityBoundingBox().minY, mc.thePlayer.posZ, mc.thePlayer.lastReportedPosX, mc.thePlayer.lastReportedPosY, mc.thePlayer.lastReportedPosZ, mc.thePlayer.rotationYaw, mc.thePlayer.rotationPitch, mc.thePlayer.onGround);
        Client.INSTANCE.bus.post(eventMotion);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            if (this.ridingEntity != null) {
                ...
                if (flag2)
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(this.posX, eventMotion.getY(), this.posZ, eventMotion.isOnGround()));
                else if (flag3)
                ...
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.posX, eventMotion.getY(), this.posZ, eventMotion.getYaw(), eventMotion.getPitch(), eventMotion.isOnGround()));
        ...
        eventMotion.setEventType(EventType.POST);
        Client.INSTANCE.bus.post(eventMotion);
    }
    ...
    public void sendChatMessage(String message) {
        if (!Client.INSTANCE.commandManager.execute(message)) {
            ...
            if (((ToggleableFeature) Client.INSTANCE.featureManager.get(ChatBypass.class)).getState() && !message.startsWith("/"))
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            if (!Client.INSTANCE.featureManager.noSlowdown.getState()) {
