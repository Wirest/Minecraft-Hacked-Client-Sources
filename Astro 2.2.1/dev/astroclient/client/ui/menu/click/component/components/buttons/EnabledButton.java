...
public class EnabledButton extends Button {
    ...
    public EnabledButton(Category parent, String label, int posX, int posY, int width, int height, ToggleableFeature mod) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Render2DUtil.drawGradientRect(posX - 0.5f, posY + .5, posX + 3f, posY + 4f, mod.isEnabled() ? new Color(Client.INSTANCE.featureManager.clickGUI.guiColor.getColor().getRed(), Client.INSTANCE.featureManager.clickGUI.guiColor.getColor().getGreen(), Client.INSTANCE.featureManager.clickGUI.guiColor.getColor().getBlue(), Math.min(getParent().getParent().getParent().getAlpha(), 255)).getRGB() : new Color(53, 53, 53, Math.min(getParent().getParent().getParent().getAlpha(), 255)).getRGB(), mod.isEnabled() ? new Color(Client.INSTANCE.featureManager.clickGUI.secondaryGuiColor.getColor().getRed(), Client.INSTANCE.featureManager.clickGUI.secondaryGuiColor.getColor().getGreen(), Client.INSTANCE.featureManager.clickGUI.secondaryGuiColor.getColor().getBlue(), Math.min(getParent().getParent().getParent().getAlpha(), 255)).getRGB() : new Color(74, 74, 74, Math.min(getParent().getParent().getParent().getAlpha(), 255)).getRGB());
