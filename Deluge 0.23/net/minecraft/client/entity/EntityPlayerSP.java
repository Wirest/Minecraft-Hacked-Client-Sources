...
import com.ihl.client.event.EventPlayerHurt;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void setPlayerSPHealth(float p_71150_1_)
    {
        if (this.field_175169_bQ)
        {
            ...
            {
                EventPlayerHurt event = new EventPlayerHurt(Event.Type.PRE, this.getHealth(), p_71150_1_);
    ...
    {
        return this.mc.getRenderEntity() == this;
    }
    ...
    public void onLivingUpdate()
    {
        ...
        boolean noSlow = !Module.get("noslow").active;
        ...
        if (this.onGround && !var2 && !var4 && this.movementInput.moveForward >= var3 && !this.isSprinting() && var5 && (!this.isUsingItem() || !noSlow) && !this.isPotionActive(Potion.blindness))
        {
        ...
        if (!this.isSprinting() && this.movementInput.moveForward >= var3 && var5 && (!this.isUsingItem() || !noSlow) && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSprint.getIsKeyPressed())
        {
            this.setSprinting(true);
        }
		...
		EventPlayerLiving event = new EventPlayerLiving(Event.Type.PRE);
		Module.event(event, false);
