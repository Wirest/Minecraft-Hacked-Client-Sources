...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    {
        EventMouse event = new EventMouse(Event.Type.CLICKL);
    ...
    {
        EventMouse event = new EventMouse(Event.Type.CLICKR);
        Module.event(event, false);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    InputUtil.keyPress(Keyboard.getEventKey(), Keyboard.getEventCharacter());
                } else {
                    InputUtil.keyRelease(Keyboard.getEventKey(), Keyboard.getEventCharacter());
                }
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        if (this.gameSettings.keyBindTogglePerspective.isPressed())
                        {
                            ...
                            {
                                this.entityRenderer.func_175066_a(this.getRenderEntity());
                            }
    ...
    {
        EventMouse event = new EventMouse(Event.Type.CLICKM);
        Module.event(event, false);

        if (this.objectMouseOver != null)
        {
            EventPlayerPickBlock event2 = new EventPlayerPickBlock(Event.Type.PRE, this.objectMouseOver);
            Module.event(event2, false);
            ...
            event2.type = Event.Type.POST;
            Module.event(event2, true);
        }
    }
