...
import com.ihl.client.event.EventPlayerUse;
import com.ihl.client.hook.HookEntityPlayerSP;
...
public class PlayerControllerMP
{
    ...
    {
        EventPlayerUse event = new EventPlayerUse(Event.Type.PRE);
    ...
    {
        return new HookEntityPlayerSP(this.mc, worldIn, this.netClientHandler, p_178892_2_);
    }
    ...
    {
        EventPlayerAttack event = new EventPlayerAttack(Event.Type.PRE, targetEntity);
        Module.event(event, false);
