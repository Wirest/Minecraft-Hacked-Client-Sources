...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
        if (OpenGlHelper.shadersSupported && this.mc.getRenderEntity() instanceof EntityPlayer)
        {
            if (this.theShaderGroup != null)
            {
                this.theShaderGroup.deleteShaderGroup();
    ...
    public void onResourceManagerReload(IResourceManager resourceManager)
    {
        ...
        {
            this.func_175066_a(this.mc.getRenderEntity());
        }
    }
    ...
    public void updateRenderer()
    {
        ...
        var1 = this.mc.theWorld.getLightBrightness(new BlockPos(this.mc.getRenderEntity()));
    ...
    private void updateFovModifierHand()
    {
        ...
        if (this.mc.getRenderEntity() instanceof AbstractClientPlayer)
        {
            AbstractClientPlayer var2 = (AbstractClientPlayer)this.mc.getRenderEntity();
    ...
    private float getFOVModifier(float partialTicks, boolean p_78481_2_)
    {
        ...
        {
            Entity var3 = this.mc.getRenderEntity();
            float var4 = 70.0F;
    ...
    {
        if (this.mc.getRenderEntity() instanceof EntityLivingBase)
        {
            EntityLivingBase var2 = (EntityLivingBase)this.mc.getRenderEntity();
    ...
    {
        if (this.mc.getRenderEntity() instanceof EntityPlayer)
        {
            EntityPlayer var2 = (EntityPlayer)this.mc.getRenderEntity();
            ...
            else
            {
                ...
                for (int var20 = 0; var20 < 8; ++var20)
                {
                    ...
                    if (var24 != null)
                    {
                        ...
                        if (var25 < var28)
                        {
                            var28 = Module.get("cameraclip").active ? var28 : var25;
                        }
                    }
                }
    ...
    private void renderHand(float p_78476_1_, int p_78476_2_)
    {
        if (!this.field_175078_W)
        {
            ...
            boolean var4 = this.mc.getRenderEntity() instanceof EntityLivingBase && ((EntityLivingBase)this.mc.getRenderEntity()).isPlayerSleeping();
        ...
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (var2 != null)
            {
                ...
                for (int var3 = 0; var3 < 256; ++var3)
                {
                    ...
                    var16 = Module.get("fullbright").active ? 1000 : this.mc.gameSettings.gammaSetting;
                    var17 = 1.0F - var13;
    ...
    public void updateCameraAndRender(float partialTicks)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                EventRender event = new EventRender(Event.Type.POST);
    ...
    private boolean func_175070_n()
    {
        ...
        {
            Entity var1 = this.mc.getRenderEntity();
    ...
    private void func_175068_a(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Entity var9 = this.mc.getRenderEntity();
        ...
        var5.func_174970_a(var9, (double)partialTicks, var8, this.field_175084_ae++, this.mc.thePlayer.isSpectator());
        ...
        EntityUtil.captureEntities();

        EventRender event = new EventRender(Event.Type.PRE);
        Module.event(event, true);
    ...
    protected void renderRainSnow(float partialTicks)
    {
        ...
        if (var421 > 0.0F)
        {
            ...
            this.func_180436_i();
            Entity var431 = this.mc.getRenderEntity();
    ...
    private void updateFogColor(float partialTicks)
    {
        ...
        Vec3 var5 = var2.getSkyColor(this.mc.getRenderEntity(), partialTicks);
        var5 = CustomColorizer.getWorldSkyColor(var5, var2, this.mc.getRenderEntity(), partialTicks);
        float var6 = (float)var5.xCoord;
        float var7 = (float)var5.yCoord;
        float var8 = (float)var5.zCoord;
        Vec3 var9 = var2.getFogColor(partialTicks);
        var9 = CustomColorizer.getWorldFogColor(var9, var2, this.mc.getRenderEntity(), partialTicks);
        ...
        else if (var211.getMaterial() == Material.water)
        {
            ...
            fogYFactor = CustomColorizer.getUnderwaterColor(this.mc.theWorld, this.mc.getRenderEntity().posX, this.mc.getRenderEntity().posY + 1.0D, this.mc.getRenderEntity().posZ);
