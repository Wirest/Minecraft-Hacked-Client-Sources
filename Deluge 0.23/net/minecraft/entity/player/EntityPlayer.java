...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    {
        this.noClip = this.isSpectator() || (Module.get("freecam").active && Option.get(Module.get("freecam").options, "noclip").BOOLEAN());
                ...
                if (var2 > 0.0F || var4 > 0.0F)
                {
                    ...
                    if (var14)
                    {
                        if (var18 > 0)
                        {
                            ...
                            if (!Module.get("aura").active && !Module.get("noslow").active) {
                                this.motionX *= 0.6D;
                                this.motionZ *= 0.6D;
