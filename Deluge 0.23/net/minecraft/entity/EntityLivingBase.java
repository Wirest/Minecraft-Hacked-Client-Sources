...
import com.ihl.client.module.FastClimb;
    ...
    public void moveEntityWithHeading(float p_70612_1_, float p_70612_2_)
    {
        ...
        if (this.isServerWorld())
        {
            ...
            else
            {
                ...
                var6 = 0.15F;
                FastClimb fastClimb = (FastClimb)Module.get("fastclimb");
                if (fastClimb.active) {
                    double speed = Option.get(fastClimb.options, "speed").DOUBLE();
                    var6*= speed;
                }
