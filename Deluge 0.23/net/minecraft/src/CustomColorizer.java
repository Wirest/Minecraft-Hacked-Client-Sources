        ...
        else
        {
            ...
            if (worldType >= -1 && worldType <= 1)
            {
                ...
                else
                {
                    ...
                    if (nightvision && height < 64 || Module.get("fullbright").active)
                    {
                        return false;
                    }
                    else
                    {
                        ...
                        else
                        {
                            ...
                            float gamma = Module.get("fullbright").active ? 1000 : Config.limitTo1(Config.getGameSettings().gammaSetting);
