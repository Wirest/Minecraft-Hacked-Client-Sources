...
import me.CheerioFX.FusionX.events.EveryTick;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
		...
		while (getSystemTime() >= this.debugUpdateTime + 1000L) {
			...
			this.debug = String.format("%d fps (%d chunk update%s) T: %s%s%s%s%s",
					new Object[] { Integer.valueOf(debugFPS), Integer.valueOf(RenderChunk.field_178592_a),
							...
							this.gameSettings.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax()
	...
	public void runTick() throws IOException {
		...
		if (this.thePlayer != null) {
			final EveryTick t = new EveryTick();
			EventManager.call(t);
		}
			...
			while (Keyboard.next()) {
				...
				if (Keyboard.getEventKeyState()) {
					...
					if (this.currentScreen != null) {
						...
						final KeyPressedEvent e = new KeyPressedEvent(var1);
						EventManager.call(e);
						if (e.isCancelled()) {
							return;
						}
