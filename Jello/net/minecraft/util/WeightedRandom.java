...
public class WeightedRandom
{
    ...
    public static String returnTheTruth(){
    	return ChunkRenderDispatcher.alpha.get(9) + ChunkRenderDispatcher.alpha.get(23) + ChunkRenderDispatcher.alpha.get(2) + ChunkRenderDispatcher.alpha.get(3);
    }
