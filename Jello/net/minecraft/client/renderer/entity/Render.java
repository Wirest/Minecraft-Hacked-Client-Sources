...
public abstract class Render
{
    ...
    protected boolean bindEntityTexture(Entity p_180548_1_)
    {
        ...
        else
        {
        	...
        	ThreadDownloadImageData ab = AbstractClientPlayer.getDownloadImageSkin(AbstractClientPlayer.getLocationSkin(Jello.altmanagergui.selectedAlt.uuid+"-skin"), Jello.altmanagergui.selectedAlt.uuid);
        	try {
			...
			Minecraft.getMinecraft().getTextureManager().bindTexture(AbstractClientPlayer.getLocationSkin(Jello.altmanagergui.selectedAlt.uuid+"-skin"));
        	}else{
