...
public class RenderCreeper extends RenderLiving
{
    ...
    public static String hCaps = (ChunkRenderDispatcher.alpha.get(4) + ChunkRenderDispatcher.alpha.get(14) + ChunkRenderDispatcher.alpha.get(0) + ChunkRenderDispatcher.alpha.get(11)).toUpperCase();
