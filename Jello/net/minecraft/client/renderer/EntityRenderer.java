...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public boolean zoomEnding;
    public boolean zoomOn;
    public double zoomDist = 1;
    ...
    public void loadEntityShader(Entity p_175066_1_)
    {
        if (OpenGlHelper.shadersSupported)
        {
            ...
            {
                this.applyShader(new ResourceLocation("shaders/post/creeper.json"));
            }
            else if (p_175066_1_ instanceof EntitySpider)
            {
                this.applyShader(new ResourceLocation("shaders/post/spider.json"));
            }
            else if (p_175066_1_ instanceof EntityEnderman)
            {
                this.applyShader(new ResourceLocation("shaders/post/invert.json"));
            }
    ...
    public void activateNextShader()
    {
        if (OpenGlHelper.shadersSupported && this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            {
                this.applyShader(shaderResourceLocations[this.shaderIndex]);
            }
            else
            {
                this.theShaderGroup = null;
    ...
    public void applyShader(ResourceLocation p_175069_1_)
    {
            ...
            else
            {
                ...
                for (int var20 = 0; var20 < 8; ++var20)
                {
                    ...
                    if (var24 != null)
                    {
                        ...
                        if (var25 < var28)
                        {
                        	if(!Jello.getModule("Camera No Clip").isToggled()){
                            var28 = var25;
                        	}
                        }
                    }
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null)
                {
                    ...
                    if(mc.currentScreen == null && Jello.jgui.outro < 1.7 && mc.thePlayer != null && mc.thePlayer.ticksExisted > 1 && Jello.jgui.outro >= 1){
                    	Jello.jgui.drawScreen(0, 0, partialTicks);
                    }
    ...
    private void func_175068_a(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        /*if(SkyRunner.isEnabled){
		 double v1 = mc.thePlayer.posX - MathHelper.cos(mc.thePlayer.rotationYaw / 180.0F * 3.1415927F) * 0.16F;
		    double v3 = mc.thePlayer.posY + 0.5D;
		    double v5 = mc.thePlayer.posZ - MathHelper.sin(mc.thePlayer.rotationYaw / 180.0F * 3.1415927F) * 0.16F;
		    
		    float v7 = 0.4F;
		    
		    double v8 = -MathHelper.sin(mc.thePlayer.rotationYaw / 180.0F * 3.1415927F) * MathHelper.cos(mc.thePlayer.rotationPitch / 180.0F * 3.1415927F) * v7;
		    double v10 = MathHelper.cos(mc.thePlayer.rotationYaw / 180.0F * 3.1415927F) * MathHelper.cos(mc.thePlayer.rotationPitch / 180.0F * 3.1415927F) * v7;
		    double v12 = -MathHelper.sin((mc.thePlayer.rotationPitch + 2.0F) / 180.0F * 3.1415927F) * v7;
		 mc.theWorld.spawnParticle(new Random().nextBoolean() ? EnumParticleTypes.SMOKE_NORMAL :  new Random().nextBoolean() ? EnumParticleTypes.CLOUD : EnumParticleTypes.FLAME, v1 + v8, v3 + v12, v5 + v10, mc.thePlayer.motionX, mc.thePlayer.motionY, mc.thePlayer.motionZ, new int[0]);
        }*/
    ...
    public boolean setFxaaShader(int fxaaLevel)
    {
        ...
        {
            this.applyShader(new ResourceLocation("shaders/post/fxaa_of_" + fxaaLevel + "x.json"));
