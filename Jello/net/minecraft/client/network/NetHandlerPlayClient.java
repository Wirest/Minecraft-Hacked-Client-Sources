...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleSetSlot(S2FPacketSetSlot packetIn)
    {
        ...
        {
            var2.inventory.setItemStack(packetIn.getItem());
        }
        else
        {
            boolean var3 = false;
            ...
            {
                ItemStack var5 = var2.inventoryContainer.getSlot(packetIn.getSlot()).getStack();

                if (packetIn.getItem() != null && (var5 == null || var5.stackSize < packetIn.getItem().stackSize))
                {
                    packetIn.getItem().animationsToGo = 5;
                }

                var2.inventoryContainer.putStackInSlot(packetIn.getSlot(), packetIn.getItem());
            }
            else if (packetIn.getWindowId() == var2.openContainer.windowId && (packetIn.getWindowId() != 0 || !var3))
            {
                var2.openContainer.putStackInSlot(packetIn.getSlot(), packetIn.getItem());
            }
        }
    }
