...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            EventSafe e = new EventSafe();
            e.call();

            if (flag || e.isCancelled() && this instanceof EntityPlayer)
            {
                double d6;
            ...
            EventEntityStep step = new EventEntityStep(this, this.stepHeight);
            step.call();

            if (step.getStepHeight() > 0.0F && flag1 && (d3 != x || d5 != z))
            {
                double d11 = x;
                double d7 = y;
                double d8 = z;
