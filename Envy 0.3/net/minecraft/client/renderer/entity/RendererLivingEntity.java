...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (flag || flag1)
        {
            ...
            // TODO:CLIENT
            if(Envy.MODULE_MANAGER.getModules().get(0).isToggled() && ESP.playerESPStatus){
            		if(entitylivingbaseIn instanceof EntityPlayer){
            			this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_,
            		          ...
            		          //GL11.glColor3f(Colors.getRainbow(0L, 1.0F).hashCode(), Colors.getRainbow(0L, 1.0F).hashCode(), 0.0F);
            		          ...
            		          GL11.glColor4d(0.175D, 0.175D, 0.175D, 1.0D);
            ...
            if(Envy.MODULE_MANAGER.getModules().get(0).isToggled() && ESP.mobESPStatus){
