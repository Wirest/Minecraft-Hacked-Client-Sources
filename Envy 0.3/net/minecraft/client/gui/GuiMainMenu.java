...
import me.ihaq.iClient.gui.GuiWindows.altmanager.GuiAltManager;
import me.ihaq.iClient.paricals.ParticleSystem;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		this.buttonList
				.add(new GuiButton(101, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, "AltManager"));
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.mc.getTextureManager().bindTexture(new ResourceLocation("textures/gui/title/back1.png"));
		...
		String title = "E" + "\u00A7fnvy";
		Envy.FONT_MANAGER.mainMenu.drawStringWithShadow(title,
				(this.width / 2F) - (Envy.FONT_MANAGER.mainMenu.getStringWidth(title) / 2), this.height / 4F,
				Colors.getColor());
		...
		Envy.FONT_MANAGER.hud.drawStringWithShadow("\u00A7fWelcome To §rE\u00A7fnvy Client:", (10 + size), (10),
				Colors.getColor());
		Envy.FONT_MANAGER.hud.drawStringWithShadow(name, (10 + size), (25), -1);

		String s = "E\u00A7fnvy " + Envy.Client_Version;
		if (this.mc.isDemo()) {
			s = s + " Demo";
		}
		Envy.FONT_MANAGER.hud.drawStringWithShadow(s, 2, this.height - 10, Colors.getColor());
		String s1 = "\u00A7fDeveloped by - §riHaq";
		Envy.FONT_MANAGER.hud.drawStringWithShadow(s1, this.width - Envy.FONT_MANAGER.hud.getStringWidth(s1) - 2,
				this.height - 10, Colors.getColor());
