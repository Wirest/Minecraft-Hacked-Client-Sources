...
public class PasswordField extends Gui {
	...
	public void drawTextBox() {
		if (func_73778_q()) {
			...
			if (var4.length() > 0) {
				...
				var9 = Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.text.replaceAll("(?s).", "*"), var7,
						var8, var1);
			}
	...
	private void drawCursorVertical(int par1, int par2, int par3, int par4) {
		...
		WorldRenderer var6 = tessellator.getWorldRenderer();
		GL11.glColor4f(0.0F, 0.0F, 255.0F, 255.0F);
		GL11.glDisable(3553);
		GL11.glEnable(3058);
		GL11.glLogicOp(5387);
		var6.begin(1, DefaultVertexFormats.POSITION);
		var6.pos(par1, par4, 0.0D);
		var6.pos(par3, par4, 0.0D);
		var6.pos(par3, par2, 0.0D);
		var6.pos(par1, par2, 0.0D);
		tessellator.draw();
		GL11.glDisable(3058);
		GL11.glEnable(3553);
	}
